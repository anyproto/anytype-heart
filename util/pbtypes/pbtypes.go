	...
	return &types.Value{Kind: &types.Value_StructValue{
		StructValue: &types.Struct{
			Fields: map[string]*types.Value{
				"key":              String(rel.Key),
				"format":           Int64(int64(rel.Format)),
				"name":             String(rel.Name),
				"defaultValue":     rel.DefaultValue,
				"dataSource":       Int64(int64(rel.DataSource)),
				"hidden":           Bool(rel.Hidden),
				"readOnly":         Bool(rel.ReadOnly),
				"readOnlyRelation": Bool(rel.ReadOnlyRelation),
				"multi":            Bool(rel.Multi),
				"objectTypes":      StringList(rel.ObjectTypes),
				"maxCount":         Int64(int64(rel.MaxCount)),
				"description":      String(rel.Description),
				"scope":            Int64(int64(rel.Scope)),
				"creator":          String(rel.Creator),
			},
		},
	}}
}
...
func StructToRelation(s *types.Struct) *model.Relation {
	...
	return &model.Relation{
		Key:              GetString(s, "key"),
		Format:           model.RelationFormat(GetInt64(s, "format")),
		Name:             GetString(s, "name"),
		DefaultValue:     Get(s, "defaultValue"),
		DataSource:       model.RelationDataSource(GetInt64(s, "dataSource")),
		Hidden:           GetBool(s, "hidden"),
		ReadOnly:         GetBool(s, "readOnly"),
		ReadOnlyRelation: GetBool(s, "readOnlyRelation"),
		Multi:            GetBool(s, "multi"),
		ObjectTypes:      GetStringList(s, "objectTypes"),
		SelectDict:       nil,
		MaxCount:         int32(GetInt64(s, "maxCount")),
		Description:      GetString(s, "description"),
		Scope:            model.RelationScope(GetInt64(s, "scope")),
...
func StructToRelationOption(s *types.Struct) *model.RelationOption {
	...
	return &model.RelationOption{
		...
		Scope: model.RelationOptionScope(GetInt64(s, "scope")),
	}
}
