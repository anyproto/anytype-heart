...
// SpacePersistentStatus provides a mock function with given fields: ctx, spaceId
func (_m *MockService) SpacePersistentStatus(ctx context.Context, spaceId string) (spaceinfo.AccountStatus, error) {
	ret := _m.Called(ctx, spaceId)

	if len(ret) == 0 {
		panic("no return value specified for SpacePersistentStatus")
	}

	var r0 spaceinfo.AccountStatus
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (spaceinfo.AccountStatus, error)); ok {
		return rf(ctx, spaceId)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) spaceinfo.AccountStatus); ok {
		r0 = rf(ctx, spaceId)
	} else {
...
// MockService_SpacePersistentStatus_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SpacePersistentStatus'
type MockService_SpacePersistentStatus_Call struct {
	*mock.Call
}

// SpacePersistentStatus is a helper method to define mock.On call
//   - ctx context.Context
//   - spaceId string
func (_e *MockService_Expecter) SpacePersistentStatus(ctx interface{}, spaceId interface{}) *MockService_SpacePersistentStatus_Call {
	return &MockService_SpacePersistentStatus_Call{Call: _e.mock.On("SpacePersistentStatus", ctx, spaceId)}
}

func (_c *MockService_SpacePersistentStatus_Call) Run(run func(ctx context.Context, spaceId string)) *MockService_SpacePersistentStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockService_SpacePersistentStatus_Call) Return(_a0 spaceinfo.AccountStatus, _a1 error) *MockService_SpacePersistentStatus_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockService_SpacePersistentStatus_Call) RunAndReturn(run func(context.Context, string) (spaceinfo.AccountStatus, error)) *MockService_SpacePersistentStatus_Call {
	_c.Call.Return(run)
	return _c
}
