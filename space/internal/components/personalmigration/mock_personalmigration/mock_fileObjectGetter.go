...
func (_m *MockfileObjectGetter) Create(ctx context.Context, spaceId string, req filemodels.CreateRequest) (string, *types.Struct, error) {
...
func (_c *MockfileObjectGetter_Create_Call) Return(id string, object *types.Struct, err error) *MockfileObjectGetter_Create_Call {
	_c.Call.Return(id, object, err)
	return _c
}

func (_c *MockfileObjectGetter_Create_Call) RunAndReturn(run func(context.Context, string, filemodels.CreateRequest) (string, *types.Struct, error)) *MockfileObjectGetter_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockfileObjectGetter_GetFileIdFromObjectWaitLoad_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DoFileWaitLoad'
...
func (_e *MockfileObjectGetter_Expecter) GetFileIdFromObjectWaitLoad(ctx interface{}, objectId interface{}) *MockfileObjectGetter_GetFileIdFromObjectWaitLoad_Call {
	return &MockfileObjectGetter_GetFileIdFromObjectWaitLoad_Call{Call: _e.mock.On("DoFileWaitLoad", ctx, objectId)}
}
