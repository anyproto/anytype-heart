...
func buildParticipantDetails(
	...
	return &types.Struct{Fields: map[string]*types.Value{
		...
		bundle.RelationKeyLayout.String():                 pbtypes.Int64(int64(model.ObjectType_participant)),
		bundle.RelationKeyLayoutAlign.String():            pbtypes.Int64(int64(model.Block_AlignCenter)),
