...
// RegisterIdentity provides a mock function with given fields: ctx, space, accState
func (_m *MockParticipantWatcher) RegisterIdentity(ctx context.Context, space clientspace.Space, accState list.AccountState) error {
...
// MockParticipantWatcher_RegisterIdentity_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RegisterIdentity'
type MockParticipantWatcher_RegisterIdentity_Call struct {
	*mock.Call
}
...
func (_e *MockParticipantWatcher_Expecter) RegisterIdentity(ctx interface{}, space interface{}, accState interface{}) *MockParticipantWatcher_RegisterIdentity_Call {
	return &MockParticipantWatcher_RegisterIdentity_Call{Call: _e.mock.On("RegisterIdentity", ctx, space, accState)}
}

func (_c *MockParticipantWatcher_RegisterIdentity_Call) Run(run func(ctx context.Context, space clientspace.Space, accState list.AccountState)) *MockParticipantWatcher_RegisterIdentity_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockParticipantWatcher_RegisterIdentity_Call) Return(_a0 error) *MockParticipantWatcher_RegisterIdentity_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockParticipantWatcher_RegisterIdentity_Call) RunAndReturn(run func(context.Context, clientspace.Space, list.AccountState) error) *MockParticipantWatcher_RegisterIdentity_Call {
	_c.Call.Return(run)
	return _c
}
