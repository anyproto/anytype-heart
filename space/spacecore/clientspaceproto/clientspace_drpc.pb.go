...
type drpcEncoding_File_space_spacecore_clientspaceproto_protos_clientspace_proto struct{}

func (drpcEncoding_File_space_spacecore_clientspaceproto_protos_clientspace_proto) Marshal(msg drpc.Message) ([]byte, error) {
	return drpc1.Marshal(msg)
}

func (drpcEncoding_File_space_spacecore_clientspaceproto_protos_clientspace_proto) Unmarshal(buf []byte, msg drpc.Message) error {
	return drpc1.Unmarshal(buf, msg)
}

func (drpcEncoding_File_space_spacecore_clientspaceproto_protos_clientspace_proto) JSONMarshal(msg drpc.Message) ([]byte, error) {
	return drpc1.JSONMarshal(msg)
}

func (drpcEncoding_File_space_spacecore_clientspaceproto_protos_clientspace_proto) JSONUnmarshal(buf []byte, msg drpc.Message) error {
...
func (c *drpcClientSpaceClient) SpaceExchange(ctx context.Context, in *SpaceExchangeRequest) (*SpaceExchangeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/clientspace.ClientSpace/SpaceExchange", drpcEncoding_File_space_spacecore_clientspaceproto_protos_clientspace_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (DRPCClientSpaceDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/clientspace.ClientSpace/SpaceExchange", drpcEncoding_File_space_spacecore_clientspaceproto_protos_clientspace_proto{},
...
func (x *drpcClientSpace_SpaceExchangeStream) SendAndClose(m *SpaceExchangeResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_space_spacecore_clientspaceproto_protos_clientspace_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
}
