...
import (
	...
	storage "github.com/anyproto/anytype-heart/space/spacecore/storage"
)
...
// ListCorruptedBackups provides a mock function with given fields:
func (_m *MockClientStorage) ListCorruptedBackups() []storage.CorruptedBackup {
	ret := _m.Called()
	...
	var r0 []storage.CorruptedBackup
	if rf, ok := ret.Get(0).(func() []storage.CorruptedBackup); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]storage.CorruptedBackup)
		}
	}
...
func (_c *MockClientStorage_ListCorruptedBackups_Call) Return(_a0 []storage.CorruptedBackup) *MockClientStorage_ListCorruptedBackups_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClientStorage_ListCorruptedBackups_Call) RunAndReturn(run func() []storage.CorruptedBackup) *MockClientStorage_ListCorruptedBackups_Call {
	_c.Call.Return(run)
	return _c
}
