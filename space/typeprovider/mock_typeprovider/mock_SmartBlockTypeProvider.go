...
// Map provides a mock function with given fields: spaceId, ids
func (_m *MockSmartBlockTypeProvider) Map(spaceId string, ids []string) (map[smartblock.SmartBlockType][]string, error) {
...
// MockSmartBlockTypeProvider_Map_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Map'
type MockSmartBlockTypeProvider_Map_Call struct {
	*mock.Call
}
...
//   - spaceId string
//   - ids []string
func (_e *MockSmartBlockTypeProvider_Expecter) Map(spaceId interface{}, ids interface{}) *MockSmartBlockTypeProvider_Map_Call {
	return &MockSmartBlockTypeProvider_Map_Call{Call: _e.mock.On("Map", spaceId, ids)}
}

func (_c *MockSmartBlockTypeProvider_Map_Call) Run(run func(spaceId string, ids []string)) *MockSmartBlockTypeProvider_Map_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockSmartBlockTypeProvider_Map_Call) Return(_a0 map[smartblock.SmartBlockType][]string, _a1 error) *MockSmartBlockTypeProvider_Map_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSmartBlockTypeProvider_Map_Call) RunAndReturn(run func(string, []string) (map[smartblock.SmartBlockType][]string, error)) *MockSmartBlockTypeProvider_Map_Call {
	_c.Call.Return(run)
	return _c
}
