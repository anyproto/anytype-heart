...
// spaceViewStatus is the objectstore projection of one SpaceView. Unlike v1 it
// carries no mutex: per-space serialization lives on the registry entry work
// lock (§9.2), not on the snapshot.
