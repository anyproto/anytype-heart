...
// CanManageSpace provides a mock function with no fields
func (_m *MockSpace) CanManageSpace() bool {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for CanManageSpace")
	}
...
// MockSpace_CanManageSpace_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CanManageSpace'
type MockSpace_CanManageSpace_Call struct {
	*mock.Call
}

// CanManageSpace is a helper method to define mock.On call
func (_e *MockSpace_Expecter) CanManageSpace() *MockSpace_CanManageSpace_Call {
	return &MockSpace_CanManageSpace_Call{Call: _e.mock.On("CanManageSpace")}
}

func (_c *MockSpace_CanManageSpace_Call) Run(run func()) *MockSpace_CanManageSpace_Call {
...
func (_c *MockSpace_CanManageSpace_Call) Return(_a0 bool) *MockSpace_CanManageSpace_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSpace_CanManageSpace_Call) RunAndReturn(run func() bool) *MockSpace_CanManageSpace_Call {
	_c.Call.Return(run)
	return _c
}
...
// OnAclUpdated provides a mock function with no fields
func (_m *MockSpace) OnAclUpdated() {
	_m.Called()
}

// MockSpace_OnAclUpdated_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'OnAclUpdated'
type MockSpace_OnAclUpdated_Call struct {
	*mock.Call
}

// OnAclUpdated is a helper method to define mock.On call
func (_e *MockSpace_Expecter) OnAclUpdated() *MockSpace_OnAclUpdated_Call {
	return &MockSpace_OnAclUpdated_Call{Call: _e.mock.On("OnAclUpdated")}
}

func (_c *MockSpace_OnAclUpdated_Call) Run(run func()) *MockSpace_OnAclUpdated_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockSpace_OnAclUpdated_Call) Return() *MockSpace_OnAclUpdated_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockSpace_OnAclUpdated_Call) RunAndReturn(run func()) *MockSpace_OnAclUpdated_Call {
	_c.Run(run)
	return _c
}
