...
func (_m *MockTechSpace) Run(techCoreSpace *spacecore.AnySpace, objectCache objectcache.Cache) error {
	ret := _m.Called(techCoreSpace, objectCache)

	var r0 error
	if rf, ok := ret.Get(0).(func(*spacecore.AnySpace, objectcache.Cache) error); ok {
...
//   - techCoreSpace *spacecore.AnySpace
...
func (_c *MockTechSpace_Run_Call) Run(run func(techCoreSpace *spacecore.AnySpace, objectCache objectcache.Cache)) *MockTechSpace_Run_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*spacecore.AnySpace), args[1].(objectcache.Cache))
	})
	return _c
}
...
func (_c *MockTechSpace_Run_Call) RunAndReturn(run func(*spacecore.AnySpace, objectcache.Cache) error) *MockTechSpace_Run_Call {
	_c.Call.Return(run)
	return _c
}
