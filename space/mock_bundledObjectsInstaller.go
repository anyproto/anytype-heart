...
func (_m *MockbundledObjectsInstaller) InstallBundledObjects(ctx context.Context, spc Space, ids []string) ([]string, []*types.Struct, error) {
	...
	var r1 []*types.Struct
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, Space, []string) ([]string, []*types.Struct, error)); ok {
		return rf(ctx, spc, ids)
	}
	if rf, ok := ret.Get(0).(func(context.Context, Space, []string) []string); ok {
		r0 = rf(ctx, spc, ids)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]string)
	...
	if rf, ok := ret.Get(1).(func(context.Context, Space, []string) []*types.Struct); ok {
		r1 = rf(ctx, spc, ids)
	} else {
		if ret.Get(1) != nil {
	...
	if rf, ok := ret.Get(2).(func(context.Context, Space, []string) error); ok {
		r2 = rf(ctx, spc, ids)
	} else {
		r2 = ret.Error(2)
	}
...
func (_c *MockbundledObjectsInstaller_InstallBundledObjects_Call) Run(run func(ctx context.Context, spc Space, ids []string)) *MockbundledObjectsInstaller_InstallBundledObjects_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(Space), args[2].([]string))
	})
	return _c
}
...
func (_c *MockbundledObjectsInstaller_InstallBundledObjects_Call) RunAndReturn(run func(context.Context, Space, []string) ([]string, []*types.Struct, error)) *MockbundledObjectsInstaller_InstallBundledObjects_Call {
	_c.Call.Return(run)
	return _c
}
