...
func (w *participant) GetIDAndPayload(ctx context.Context, spaceID string, sn *types.Snapshot, _ time.Time, _ bool, _ objectorigin.ObjectOrigin) (string, treestorage.TreeStorageCreatePayload, error) {
