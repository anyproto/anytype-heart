...
func (t *treeObject) GetIDAndPayload(ctx context.Context, spaceID string, sn *types.Snapshot, _ time.Time, getExisting bool, _ objectorigin.ObjectOrigin) (string, treestorage.TreeStorageCreatePayload, error) {
