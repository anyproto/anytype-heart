...
func (_m *MockIDGetter) GetIDAndPayload(ctx context.Context, spaceID string, sn *common.Snapshot, createdTime time.Time, getExisting bool, origin *domain.ObjectOrigin) (string, treestorage.TreeStorageCreatePayload, error) {
