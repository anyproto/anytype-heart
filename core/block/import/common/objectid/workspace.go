...
func (w *workspace) GetIDAndPayload(ctx context.Context, spaceID string, _ *types.Snapshot, _ time.Time, _ bool, _ objectorigin.ObjectOrigin) (string, treestorage.TreeStorageCreatePayload, error) {
