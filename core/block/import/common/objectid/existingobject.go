...
func (e *existingObject) GetIDAndPayload(_ context.Context, spaceID string, sn *common.Snapshot, _ time.Time, getExisting bool) (string, treestorage.TreeStorageCreatePayload, error) {
