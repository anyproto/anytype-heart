...
func (c *TableStrategy) CreateObjects(path string, fileName string, csvTable [][]string, useFirstRowForHeader bool, progress process.Progress) (string, []*converter.Snapshot, error) {
