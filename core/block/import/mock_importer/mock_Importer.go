...
func (_m *MockImporter) ImportWeb(ctx context.Context, req *importer.ImportRequest) (string, *domain.Details, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *importer.ImportRequest) (string, *domain.Details, error)); ok {
		return rf(ctx, req)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context, *importer.ImportRequest) *domain.Details); ok {
		r1 = rf(ctx, req)
	} else {
		if ret.Get(1) != nil {
...
func (_c *MockImporter_ImportWeb_Call) Return(_a0 string, _a1 *domain.Details, _a2 error) *MockImporter_ImportWeb_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *MockImporter_ImportWeb_Call) RunAndReturn(run func(context.Context, *importer.ImportRequest) (string, *domain.Details, error)) *MockImporter_ImportWeb_Call {
	_c.Call.Return(run)
	return _c
}
