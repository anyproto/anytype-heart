...
func (c *CodeBlock) GetBlocks(req *NotionImportContext, pageID string) *MapResponse {
...
func (e *EquationBlock) GetBlocks(req *NotionImportContext, pageID string) *MapResponse {
