...
func (_m *MockConverter) GetSnapshots(ctx session.Context, req *pb.RpcObjectImportRequest, progress process.Progress) (*converter.Response, converter.ConvertError) {
	ret := _m.Called(ctx, req, progress)

	var r0 *converter.Response
	var r1 converter.ConvertError
	if rf, ok := ret.Get(0).(func(session.Context, *pb.RpcObjectImportRequest, process.Progress) (*converter.Response, converter.ConvertError)); ok {
		return rf(ctx, req, progress)
	}
	if rf, ok := ret.Get(0).(func(session.Context, *pb.RpcObjectImportRequest, process.Progress) *converter.Response); ok {
	...
	if rf, ok := ret.Get(1).(func(session.Context, *pb.RpcObjectImportRequest, process.Progress) converter.ConvertError); ok {
...
func (_c *MockConverter_GetSnapshots_Call) Run(run func(ctx session.Context, req *pb.RpcObjectImportRequest, progress process.Progress)) *MockConverter_GetSnapshots_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(session.Context), args[1].(*pb.RpcObjectImportRequest), args[2].(process.Progress))
	})
	return _c
}
...
func (_c *MockConverter_GetSnapshots_Call) RunAndReturn(run func(session.Context, *pb.RpcObjectImportRequest, process.Progress) (*converter.Response, converter.ConvertError)) *MockConverter_GetSnapshots_Call {
	_c.Call.Return(run)
	return _c
}
