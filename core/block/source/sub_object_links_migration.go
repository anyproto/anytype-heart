...
func newSubObjectsAndProfileLinksMigration(spaceID string, identityObjectID string, systemObjectService system_object.Service) *subObjectsAndProfileLinksMigration {
