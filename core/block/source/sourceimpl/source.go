...
func (s *service) newTreeSource(ctx context.Context, space source.Space, id string, buildOpts objecttreebuilder.BuildTreeOpts) (source.Source, error) {
	...
	if sbt == smartblock.SmartBlockTypeChatDerivedObject || sbt == smartblock.SmartBlockTypeDiscussionObject || sbt == smartblock.SmartBlockTypeAccountObject || sbt == smartblock.SmartBlockTypeTechSpaceObject {
