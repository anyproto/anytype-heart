...
// IDsListerBySmartblockType provides a mock function with given fields: idsStore, blockType
func (_m *MockService) IDsListerBySmartblockType(idsStore source.IDsStore, blockType smartblock.SmartBlockType) (source.IDsLister, error) {
	ret := _m.Called(idsStore, blockType)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(source.IDsStore, smartblock.SmartBlockType) (source.IDsLister, error)); ok {
		return rf(idsStore, blockType)
	}
	if rf, ok := ret.Get(0).(func(source.IDsStore, smartblock.SmartBlockType) source.IDsLister); ok {
		r0 = rf(idsStore, blockType)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(source.IDsStore, smartblock.SmartBlockType) error); ok {
		r1 = rf(idsStore, blockType)
	} else {
		r1 = ret.Error(1)
	}
...
//   - idsStore source.IDsStore
//   - blockType smartblock.SmartBlockType
func (_e *MockService_Expecter) IDsListerBySmartblockType(idsStore interface{}, blockType interface{}) *MockService_IDsListerBySmartblockType_Call {
	return &MockService_IDsListerBySmartblockType_Call{Call: _e.mock.On("IDsListerBySmartblockType", idsStore, blockType)}
}

func (_c *MockService_IDsListerBySmartblockType_Call) Run(run func(idsStore source.IDsStore, blockType smartblock.SmartBlockType)) *MockService_IDsListerBySmartblockType_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(source.IDsStore), args[1].(smartblock.SmartBlockType))
	})
	return _c
}
...
func (_c *MockService_IDsListerBySmartblockType_Call) RunAndReturn(run func(source.IDsStore, smartblock.SmartBlockType) (source.IDsLister, error)) *MockService_IDsListerBySmartblockType_Call {
	_c.Call.Return(run)
	return _c
}
