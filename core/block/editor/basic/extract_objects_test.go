...
func (t testExtractObjects) CreateSmartBlockFromState(ctx context.Context, spaceID string, _ []domain.TypeKey, details *types.Struct, createState *state.State) (id string, newDetails *types.Struct, err error) {
