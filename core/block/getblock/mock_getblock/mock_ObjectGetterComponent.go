...
func (_m *MockObjectGetterComponent) GetObject(ctx context.Context, id string) (smartblock.SmartBlock, error) {
...
//   - ctx context.Context
//   - id string
func (_e *MockObjectGetterComponent_Expecter) GetObject(ctx interface{}, id interface{}) *MockObjectGetterComponent_GetObject_Call {
	return &MockObjectGetterComponent_GetObject_Call{Call: _e.mock.On("GetObject", ctx, id)}
}

func (_c *MockObjectGetterComponent_GetObject_Call) Run(run func(ctx context.Context, id string)) *MockObjectGetterComponent_GetObject_Call {
