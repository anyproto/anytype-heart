...
func (_m *MockPicker) PickBlock(ctx session.Context, id string) (smartblock.SmartBlock, error) {
	ret := _m.Called(ctx, id)

	var r0 smartblock.SmartBlock
	var r1 error
	if rf, ok := ret.Get(0).(func(session.Context, string) (smartblock.SmartBlock, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(session.Context, string) smartblock.SmartBlock); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(session.Context, string) error); ok {
		r1 = rf(ctx, id)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockPicker_PickBlock_Call) Run(run func(ctx session.Context, id string)) *MockPicker_PickBlock_Call {
...
func (_c *MockPicker_PickBlock_Call) RunAndReturn(run func(session.Context, string) (smartblock.SmartBlock, error)) *MockPicker_PickBlock_Call {
	_c.Call.Return(run)
	return _c
}
