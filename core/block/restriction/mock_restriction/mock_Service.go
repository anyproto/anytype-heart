...
// CheckRestrictions provides a mock function with given fields: rh, cr
func (_m *MockService) CheckRestrictions(rh restriction.RestrictionHolder, cr ...model.RestrictionsObjectRestriction) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CheckRestrictions")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(restriction.RestrictionHolder, ...model.RestrictionsObjectRestriction) error); ok {
		r0 = rf(rh, cr...)
	} else {
		r0 = ret.Error(0)
	}
...
//   - rh restriction.RestrictionHolder
//   - cr ...model.RestrictionsObjectRestriction
func (_e *MockService_Expecter) CheckRestrictions(rh interface{}, cr ...interface{}) *MockService_CheckRestrictions_Call {
	return &MockService_CheckRestrictions_Call{Call: _e.mock.On("CheckRestrictions",
		append([]interface{}{rh}, cr...)...)}
}

func (_c *MockService_CheckRestrictions_Call) Run(run func(rh restriction.RestrictionHolder, cr ...model.RestrictionsObjectRestriction)) *MockService_CheckRestrictions_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(restriction.RestrictionHolder), variadicArgs...)
	})
	return _c
}
...
func (_c *MockService_CheckRestrictions_Call) RunAndReturn(run func(restriction.RestrictionHolder, ...model.RestrictionsObjectRestriction) error) *MockService_CheckRestrictions_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockService) GetRestrictions(_a0 restriction.RestrictionHolder) restriction.Restrictions {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetRestrictions")
	}
