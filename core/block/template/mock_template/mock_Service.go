...
// DeleteTemplatePlaceholders provides a mock function with given fields: ctx, templateId, relationKeys
func (_m *MockService) DeleteTemplatePlaceholders(ctx session.Context, templateId string, relationKeys []string) error {
	ret := _m.Called(ctx, templateId, relationKeys)

	if len(ret) == 0 {
		panic("no return value specified for DeleteTemplatePlaceholders")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(session.Context, string, []string) error); ok {
		r0 = rf(ctx, templateId, relationKeys)
	} else {
		r0 = ret.Error(0)
	}
...
// MockService_DeleteTemplatePlaceholders_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteTemplatePlaceholders'
type MockService_DeleteTemplatePlaceholders_Call struct {
	*mock.Call
}

// DeleteTemplatePlaceholders is a helper method to define mock.On call
//   - ctx session.Context
//   - templateId string
//   - relationKeys []string
func (_e *MockService_Expecter) DeleteTemplatePlaceholders(ctx interface{}, templateId interface{}, relationKeys interface{}) *MockService_DeleteTemplatePlaceholders_Call {
	return &MockService_DeleteTemplatePlaceholders_Call{Call: _e.mock.On("DeleteTemplatePlaceholders", ctx, templateId, relationKeys)}
}

func (_c *MockService_DeleteTemplatePlaceholders_Call) Run(run func(ctx session.Context, templateId string, relationKeys []string)) *MockService_DeleteTemplatePlaceholders_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockService_DeleteTemplatePlaceholders_Call) Return(_a0 error) *MockService_DeleteTemplatePlaceholders_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockService_DeleteTemplatePlaceholders_Call) RunAndReturn(run func(session.Context, string, []string) error) *MockService_DeleteTemplatePlaceholders_Call {
	_c.Call.Return(run)
	return _c
}
