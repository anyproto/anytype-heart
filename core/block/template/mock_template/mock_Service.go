...
// CreateTemplateStateFromSmartBlock provides a mock function with given fields: sb, details
func (_m *MockService) CreateTemplateStateFromSmartBlock(sb smartblock.SmartBlock, details *domain.Details) *state.State {
	ret := _m.Called(sb, details)
	...
	var r0 *state.State
	if rf, ok := ret.Get(0).(func(smartblock.SmartBlock, *domain.Details) *state.State); ok {
		r0 = rf(sb, details)
	} else {
		if ret.Get(0) != nil {
...
func (_e *MockService_Expecter) CreateTemplateStateFromSmartBlock(sb interface{}, details interface{}) *MockService_CreateTemplateStateFromSmartBlock_Call {
	return &MockService_CreateTemplateStateFromSmartBlock_Call{Call: _e.mock.On("CreateTemplateStateFromSmartBlock", sb, details)}
}

func (_c *MockService_CreateTemplateStateFromSmartBlock_Call) Run(run func(sb smartblock.SmartBlock, details *domain.Details)) *MockService_CreateTemplateStateFromSmartBlock_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(smartblock.SmartBlock), args[1].(*domain.Details))
	})
	return _c
}
...
func (_c *MockService_CreateTemplateStateFromSmartBlock_Call) RunAndReturn(run func(smartblock.SmartBlock, *domain.Details) *state.State) *MockService_CreateTemplateStateFromSmartBlock_Call {
	_c.Call.Return(run)
	return _c
}

// CreateTemplateStateWithDetails provides a mock function with given fields: templateId, details
func (_m *MockService) CreateTemplateStateWithDetails(templateId string, details *domain.Details) (*state.State, error) {
	ret := _m.Called(templateId, details)
	...
	var r0 *state.State
	var r1 error
	if rf, ok := ret.Get(0).(func(string, *domain.Details) (*state.State, error)); ok {
		return rf(templateId, details)
	}
	if rf, ok := ret.Get(0).(func(string, *domain.Details) *state.State); ok {
		r0 = rf(templateId, details)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*state.State)
		}
	...
	if rf, ok := ret.Get(1).(func(string, *domain.Details) error); ok {
		r1 = rf(templateId, details)
	} else {
		r1 = ret.Error(1)
	}
...
//   - templateId string
//   - details *domain.Details
func (_e *MockService_Expecter) CreateTemplateStateWithDetails(templateId interface{}, details interface{}) *MockService_CreateTemplateStateWithDetails_Call {
	return &MockService_CreateTemplateStateWithDetails_Call{Call: _e.mock.On("CreateTemplateStateWithDetails", templateId, details)}
}

func (_c *MockService_CreateTemplateStateWithDetails_Call) Run(run func(templateId string, details *domain.Details)) *MockService_CreateTemplateStateWithDetails_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockService_CreateTemplateStateWithDetails_Call) RunAndReturn(run func(string, *domain.Details) (*state.State, error)) *MockService_CreateTemplateStateWithDetails_Call {
	_c.Call.Return(run)
	return _c
}
