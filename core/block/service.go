...
type Service interface {
	...
	Undo(ctx *state.Context, req pb.RpcBlockUndoRequest) (pb.RpcBlockUndoCounters, error)
	Redo(ctx *state.Context, req pb.RpcBlockRedoRequest) (pb.RpcBlockUndoCounters, error)
...
func (s *service) Undo(ctx *state.Context, req pb.RpcBlockUndoRequest) (counters pb.RpcBlockUndoCounters, err error) {
...
func (s *service) Redo(ctx *state.Context, req pb.RpcBlockRedoRequest) (counters pb.RpcBlockUndoCounters, err error) {
	err = s.DoHistory(req.ContextId, func(b basic.IHistory) error {
