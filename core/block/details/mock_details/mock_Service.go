...
// SetDetails provides a mock function with given fields: ctx, objectId, _a2
func (_m *MockService) SetDetails(ctx session.Context, objectId string, _a2 []*model.Detail) error {
	ret := _m.Called(ctx, objectId, _a2)
...
//   - objectId string
//   - _a2 []*model.Detail
func (_e *MockService_Expecter) SetDetails(ctx interface{}, objectId interface{}, _a2 interface{}) *MockService_SetDetails_Call {
	return &MockService_SetDetails_Call{Call: _e.mock.On("SetDetails", ctx, objectId, _a2)}
}

func (_c *MockService_SetDetails_Call) Run(run func(ctx session.Context, objectId string, _a2 []*model.Detail)) *MockService_SetDetails_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// SetDetailsAndUpdateLastUsed provides a mock function with given fields: ctx, objectId, _a2
func (_m *MockService) SetDetailsAndUpdateLastUsed(ctx session.Context, objectId string, _a2 []*model.Detail) error {
	ret := _m.Called(ctx, objectId, _a2)
...
//   - objectId string
//   - _a2 []*model.Detail
func (_e *MockService_Expecter) SetDetailsAndUpdateLastUsed(ctx interface{}, objectId interface{}, _a2 interface{}) *MockService_SetDetailsAndUpdateLastUsed_Call {
	return &MockService_SetDetailsAndUpdateLastUsed_Call{Call: _e.mock.On("SetDetailsAndUpdateLastUsed", ctx, objectId, _a2)}
}

func (_c *MockService_SetDetailsAndUpdateLastUsed_Call) Run(run func(ctx session.Context, objectId string, _a2 []*model.Detail)) *MockService_SetDetailsAndUpdateLastUsed_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(session.Context), args[1].(string), args[2].([]*model.Detail))
	})
	return _c
...
// SetDetailsList provides a mock function with given fields: ctx, objectIds, _a2
func (_m *MockService) SetDetailsList(ctx session.Context, objectIds []string, _a2 []*model.Detail) error {
	ret := _m.Called(ctx, objectIds, _a2)
...
//   - objectIds []string
//   - _a2 []*model.Detail
func (_e *MockService_Expecter) SetDetailsList(ctx interface{}, objectIds interface{}, _a2 interface{}) *MockService_SetDetailsList_Call {
	return &MockService_SetDetailsList_Call{Call: _e.mock.On("SetDetailsList", ctx, objectIds, _a2)}
}

func (_c *MockService_SetDetailsList_Call) Run(run func(ctx session.Context, objectIds []string, _a2 []*model.Detail)) *MockService_SetDetailsList_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(session.Context), args[1].([]string), args[2].([]*model.Detail))
	})
	return _c
...
// SetSpaceInfo provides a mock function with given fields: spaceId, _a1
func (_m *MockService) SetSpaceInfo(spaceId string, _a1 *types.Struct) error {
	ret := _m.Called(spaceId, _a1)
...
//   - spaceId string
//   - _a1 *types.Struct
func (_e *MockService_Expecter) SetSpaceInfo(spaceId interface{}, _a1 interface{}) *MockService_SetSpaceInfo_Call {
	return &MockService_SetSpaceInfo_Call{Call: _e.mock.On("SetSpaceInfo", spaceId, _a1)}
}

func (_c *MockService_SetSpaceInfo_Call) Run(run func(spaceId string, _a1 *types.Struct)) *MockService_SetSpaceInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
