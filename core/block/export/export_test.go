...
type fixture struct {
	*export
	...
	// the native AnyBlock JSON format closes every object it loads
	// (EXPORTER_DESIGN §1.5/§1.6), so the narrower ObjectGetter no longer
	// satisfies it. Strictly richer — the legacy formats never call
