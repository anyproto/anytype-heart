...
func TestService_Search(t *testing.T) {
	...
	t.Run("collection: collection has 2 objects - return 2 objects in response", func(t *testing.T) {
		...
		assert.Equal(t, "1", resp.Records[0].GetStringOrDefault(bundle.RelationKeyName, ""))
		assert.Equal(t, "1", resp.Records[0].GetStringOrDefault(bundle.RelationKeyId, ""))
		assert.Equal(t, "2", resp.Records[1].GetStringOrDefault(bundle.RelationKeyName, ""))
		assert.Equal(t, "2", resp.Records[1].GetStringOrDefault(bundle.RelationKeyId, ""))
	})
	...
	t.Run("collection: collection has 3 objects, offset = 2 - return 1 object after offset", func(t *testing.T) {
		...
		assert.NotNil(t, resp)
		assert.Len(t, resp.Records, 1)
		assert.Equal(t, "3", resp.Records[0].GetStringOrDefault(bundle.RelationKeyName, ""))
		assert.Equal(t, "3", resp.Records[0].GetStringOrDefault(bundle.RelationKeyId, ""))
	})
	...
	t.Run("collection: collection has object with dependency - return objects with dependency", func(t *testing.T) {
		...
		assert.Equal(t, "1", resp.Records[0].GetStringOrDefault(bundle.RelationKeyName, ""))
		assert.Equal(t, "1", resp.Records[0].GetStringOrDefault(bundle.RelationKeyId, ""))
		assert.Equal(t, "2", resp.Dependencies[0].GetStringOrDefault(bundle.RelationKeyName, ""))
		assert.Equal(t, "2", resp.Dependencies[0].GetStringOrDefault(bundle.RelationKeyId, ""))
	})
