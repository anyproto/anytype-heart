...
func TestPatchObject(t *testing.T) {
	...
	t.Run("replaceBlock is gone and the hint names update_block", func(t *testing.T) {
		// folded into update_block pre-release (v0.3.5) — the unknown-op error
		...
		require.NotEmpty(t, apiErr.Issues)
		assert.Contains(t, apiErr.Issues[0].Hint, "replaceBlock was removed — use update_block {id, set}")
		assert.NotContains(t, apiErr.Issues[0].Hint, "allowed ops: set_properties, update_block, replaceBlock",
	...
	t.Run("sequential replace_text matches against the canonical inline form (M7)", func(t *testing.T) {
