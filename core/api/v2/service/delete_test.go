...
func TestDeleteObject(t *testing.T) {
	...
	t.Run("a nil provenance dependency refuses and never archives", func(t *testing.T) {
		fx := newV2Fixture(t)
		fx.Service = NewService(fx.mwMock, fx.readerMock, fx.creatorMock, fx.mutatorMock, nil, fx.widgetsMock, nil, nil, fx.objectStore, objectstore.TestTechSpaceId, testAccountId)
