...
// v2_list_read.go — the Phase-4 sets/collections read handlers (APIV2.md §2
...
//	@Failure		400			{object}	apimodel.V2Error								"Wrong-layout target or invalid params"
//	@Failure		404			{object}	apimodel.V2Error								"Space, set or view not found"
//	@Security		bearerauth
//	@Router			/v2/spaces/{space_id}/sets/{set_id}/objects [get]
func GetSetObjectsV2Handler(s *service.V2Service) gin.HandlerFunc {
...
//	@Param			offset		query		int											false	"Items to skip"		default(0)
//	@Param			limit		query		int											false	"Items to return"	default(25)
//	@Success		200			{object}	apimodel.V2ListResponse[json.RawMessage]	"§6.2 view objects"
//	@Failure		400			{object}	apimodel.V2Error							"Wrong-layout target"
//	@Failure		404			{object}	apimodel.V2Error							"Space or set not found"
//	@Security		bearerauth
//	@Router			/v2/spaces/{space_id}/sets/{set_id}/views [get]
func GetSetViewsV2Handler(s *service.V2Service) gin.HandlerFunc {
	return func(c *gin.Context) {
		offset := c.GetInt(pagination.QueryParamOffset)
		limit := c.GetInt(pagination.QueryParamLimit)
		...
		c.JSON(http.StatusOK, apimodel.NewV2ListResponse(views, total, offset, limit, hasMore,
...
//	@Success		200				{object}	apimodel.V2ListResponse[apimodel.V2ObjectRow]	"Minimal object rows"
//	@Failure		400				{object}	apimodel.V2Error								"Wrong-layout target or invalid params"
//	@Failure		404				{object}	apimodel.V2Error								"Space, collection or view not found"
//	@Security		bearerauth
//	@Router			/v2/spaces/{space_id}/collections/{collection_id}/objects [get]
func GetCollectionObjectsV2Handler(s *service.V2Service) gin.HandlerFunc {
	return func(c *gin.Context) {
		offset := c.GetInt(pagination.QueryParamOffset)
		limit := c.GetInt(pagination.QueryParamLimit)
...
//	@Success		200				{object}	apimodel.V2ListResponse[json.RawMessage]	"§6.2 view objects"
//	@Failure		400				{object}	apimodel.V2Error							"Wrong-layout target"
//	@Failure		404				{object}	apimodel.V2Error							"Space or collection not found"
//	@Security		bearerauth
//	@Router			/v2/spaces/{space_id}/collections/{collection_id}/views [get]
func GetCollectionViewsV2Handler(s *service.V2Service) gin.HandlerFunc {
	return func(c *gin.Context) {
		offset := c.GetInt(pagination.QueryParamOffset)
		limit := c.GetInt(pagination.QueryParamLimit)
