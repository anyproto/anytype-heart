...
//	@Accept			json
//	@Produce		json
//	@Success		200	{object}	apimodel.V2ValidateResponse	"Issue and warning lists (empty when valid)"
//	@Failure		401	{object}	apimodel.V2Error			"Unauthorized"
//	@Security		bearerauth
//	@Router			/v2/validate [post]
func ValidateV2Handler(s *service.V2Service) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if len(body) > maxValidateBodySize {
			RespondV2Error(c, apimodel.V2ValidationFailed("request body exceeds the 10 MiB validation limit"))
			return
		}
