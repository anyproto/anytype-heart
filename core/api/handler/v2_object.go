...
//	@Failure		400			{object}	apimodel.V2Error	"Illegal parameter combination (ambiguous_input)"
//	@Failure		404			{object}	apimodel.V2Error	"Object or space not found"
//	@Security		bearerauth
//	@Router			/v2/spaces/{space_id}/objects/{object_id} [get]
func GetObjectV2Handler(s *service.V2Service) gin.HandlerFunc {
	return func(c *gin.Context) {
		q := service.V2ObjectQuery{
...
func ListObjectsV2Handler(s *service.V2Service) gin.HandlerFunc {
	return func(c *gin.Context) {
