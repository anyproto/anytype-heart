...
type Filter struct {
	...
	Format      object.PropertyFormat `json:"format" example:"text" enums:"text,number,select,multi_select,date,files,checkbox,url,email,phone,objects"`                                                                               // The format of the property used for filtering
...
type Sort struct {
	...
	Format      object.PropertyFormat `json:"format" example:"text" enums:"text,number,select,multi_select,date,files,checkbox,url,email,phone,objects"` // The format of the property used for sorting
