...
type MatchedChunk struct {
	Title string  `json:"title" example:"Introduction"`                 // The header/section title of the matching chunk
	Text  string  `json:"text" example:"This section covers..."`       // The chunk text that matched semantically
	Score float32 `json:"score" example:"0.87"`                        // Vector similarity score (0-1)
}
...
type Object struct {
	...
	MatchedChunk *MatchedChunk       `json:"matched_chunk,omitempty" extensions:"nullable"`                                                                                                                                                                                                // Best-matching chunk from vector search, if available
}
