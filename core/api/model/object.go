...
const (
	...
	ObjectLayoutChat        ObjectLayout = "chat"
)
...
func (ol *ObjectLayout) UnmarshalJSON(data []byte) error {
	...
	case ObjectLayoutBasic, ObjectLayoutProfile, ObjectLayoutAction, ObjectLayoutNote, ObjectLayoutBookmark, ObjectLayoutSet, ObjectLayoutCollection, ObjectLayoutParticipant, ObjectLayoutChat:
		*ol = ObjectLayout(s)
		return nil
	default:
...
type Object struct {
	...
	DiscussionId string              `json:"discussion_id,omitempty" example:"bafyreictrp3obmnf6dwejy5o4p7bderaaia4bdg2psxbfzf44yya5uutge"`                                                                                                                                                // The id of the object's inline discussion (chat); absent if the object has no discussion. Use it as chat_id with the Chat endpoints to read and write discussion messages
}
