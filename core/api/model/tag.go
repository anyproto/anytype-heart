...
type CreateTagRequest struct {
	Key   string `json:"key" example:"in_progress"`                                                                               // The optional custom key for the tag
...
type UpdateTagRequest struct {
	Key   *string `json:"key" example:"in_progress"`                                                             // The key to set for the tag
...
type Tag struct {
	...
	UniqueKey string `json:"-"`                                                                                    // Internal unique key (not exposed in JSON)
}
