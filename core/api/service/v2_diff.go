...
// v2_diff.go computes the Phase-3 diffStats (APIV2.md §2 Phase 3): both
...
func diffEditDocs(beforeDoc, afterDoc []byte) (apimodel.V2DiffStats, error) {
	var stats apimodel.V2DiffStats
