...
// TmpPath provides a mock function with given fields:
func (_m *MockWallet) TmpPath() string {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for TmpPath")
	}
...
// MockWallet_TmpPath_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'TmpPath'
type MockWallet_TmpPath_Call struct {
	*mock.Call
}

// TmpPath is a helper method to define mock.On call
func (_e *MockWallet_Expecter) TmpPath() *MockWallet_TmpPath_Call {
	return &MockWallet_TmpPath_Call{Call: _e.mock.On("TmpPath")}
}

func (_c *MockWallet_TmpPath_Call) Run(run func()) *MockWallet_TmpPath_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockWallet_TmpPath_Call) Return(_a0 string) *MockWallet_TmpPath_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockWallet_TmpPath_Call) RunAndReturn(run func() string) *MockWallet_TmpPath_Call {
	_c.Call.Return(run)
	return _c
}
