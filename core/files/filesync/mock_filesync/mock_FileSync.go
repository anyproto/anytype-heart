...
// AddFile provides a mock function with given fields: fileObjectId, fileId, uploadedByUser, imported, prioritizeVariantId, score
func (_m *MockFileSync) AddFile(fileObjectId string, fileId domain.FullFileId, uploadedByUser bool, imported bool, prioritizeVariantId domain.FileId, score int) error {
	ret := _m.Called(fileObjectId, fileId, uploadedByUser, imported, prioritizeVariantId, score)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, domain.FullFileId, bool, bool, domain.FileId, int) error); ok {
		r0 = rf(fileObjectId, fileId, uploadedByUser, imported, prioritizeVariantId, score)
	} else {
		r0 = ret.Error(0)
	}
...
//   - score int
func (_e *MockFileSync_Expecter) AddFile(fileObjectId interface{}, fileId interface{}, uploadedByUser interface{}, imported interface{}, prioritizeVariantId interface{}, score interface{}) *MockFileSync_AddFile_Call {
	return &MockFileSync_AddFile_Call{Call: _e.mock.On("AddFile", fileObjectId, fileId, uploadedByUser, imported, prioritizeVariantId, score)}
}

func (_c *MockFileSync_AddFile_Call) Run(run func(fileObjectId string, fileId domain.FullFileId, uploadedByUser bool, imported bool, prioritizeVariantId domain.FileId, score int)) *MockFileSync_AddFile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(domain.FullFileId), args[2].(bool), args[3].(bool), args[4].(domain.FileId), args[5].(int))
	})
	return _c
}
