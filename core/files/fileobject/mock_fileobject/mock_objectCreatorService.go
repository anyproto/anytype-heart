...
func (_m *MockobjectCreatorService) CreateSmartBlockFromStateInSpace(ctx context.Context, space clientspace.Space, objectTypeKeys []domain.TypeKey, createState *state.State) (string, *domain.Details, error) {
...
func (_c *MockobjectCreatorService_CreateSmartBlockFromStateInSpace_Call) Return(id string, newDetails *domain.Details, err error) *MockobjectCreatorService_CreateSmartBlockFromStateInSpace_Call {
	_c.Call.Return(id, newDetails, err)
	return _c
}

func (_c *MockobjectCreatorService_CreateSmartBlockFromStateInSpace_Call) RunAndReturn(run func(context.Context, clientspace.Space, []domain.TypeKey, *state.State) (string, *domain.Details, error)) *MockobjectCreatorService_CreateSmartBlockFromStateInSpace_Call {
	_c.Call.Return(run)
	return _c
}
