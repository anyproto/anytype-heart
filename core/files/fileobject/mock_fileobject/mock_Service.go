...
func (_m *MockService) Create(ctx context.Context, spaceId string, req fileobject.CreateRequest) (string, *domain.Details, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, fileobject.CreateRequest) (string, *domain.Details, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, fileobject.CreateRequest) *domain.Details); ok {
...
func (_c *MockService_Create_Call) RunAndReturn(run func(context.Context, string, fileobject.CreateRequest) (string, *domain.Details, error)) *MockService_Create_Call {
	_c.Call.Return(run)
	return _c
}
