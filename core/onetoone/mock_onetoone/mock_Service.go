...
// SendOneToOneInvite provides a mock function with given fields: ctx, receiverIdentity, myProfile
func (_m *MockService) SendOneToOneInvite(ctx context.Context, receiverIdentity string, myProfile *model.IdentityProfileWithKey) error {
	ret := _m.Called(ctx, receiverIdentity, myProfile)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, *model.IdentityProfileWithKey) error); ok {
		r0 = rf(ctx, receiverIdentity, myProfile)
	} else {
		r0 = ret.Error(0)
	}
...
//   - myProfile *model.IdentityProfileWithKey
func (_e *MockService_Expecter) SendOneToOneInvite(ctx interface{}, receiverIdentity interface{}, myProfile interface{}) *MockService_SendOneToOneInvite_Call {
	return &MockService_SendOneToOneInvite_Call{Call: _e.mock.On("SendOneToOneInvite", ctx, receiverIdentity, myProfile)}
}

func (_c *MockService_SendOneToOneInvite_Call) Run(run func(ctx context.Context, receiverIdentity string, myProfile *model.IdentityProfileWithKey)) *MockService_SendOneToOneInvite_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*model.IdentityProfileWithKey))
	})
	return _c
}
...
func (_c *MockService_SendOneToOneInvite_Call) RunAndReturn(run func(context.Context, string, *model.IdentityProfileWithKey) error) *MockService_SendOneToOneInvite_Call {
	_c.Call.Return(run)
	return _c
}
