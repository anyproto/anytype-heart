...
func (_m *MockService) CacheSet(in *pb.RpcPaymentsSubscriptionGetStatusResponse, ExpireTime time.Time) error {
...
func (_e *MockService_Expecter) CacheSet(in interface{}, ExpireTime interface{}) *MockService_CacheSet_Call {
	return &MockService_CacheSet_Call{Call: _e.mock.On("CacheSet", in, ExpireTime)}
}

func (_c *MockService_CacheSet_Call) Run(run func(in *pb.RpcPaymentsSubscriptionGetStatusResponse, ExpireTime time.Time)) *MockService_CacheSet_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockService_CacheSet_Call) RunAndReturn(run func(*pb.RpcPaymentsSubscriptionGetStatusResponse, time.Time) error) *MockService_CacheSet_Call {
	_c.Call.Return(run)
	return _c
}

// CacheClear provides a mock function with given fields:
func (_m *MockService) CacheClear() error {
	ret := _m.Called()
...
// MockService_ClearCache_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CacheClear'
type MockService_ClearCache_Call struct {
	*mock.Call
}

// CacheClear is a helper method to define mock.On call
func (_e *MockService_Expecter) CacheClear() *MockService_ClearCache_Call {
	return &MockService_ClearCache_Call{Call: _e.mock.On("CacheClear")}
}
...
func (_m *MockService) CacheDisableForNextMinutes(minutes int) error {
...
// MockService_DisableCacheForNextMinutes_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CacheDisableForNextMinutes'
...
//   - minutes int
func (_e *MockService_Expecter) CacheDisableForNextMinutes(minutes interface{}) *MockService_DisableCacheForNextMinutes_Call {
	return &MockService_DisableCacheForNextMinutes_Call{Call: _e.mock.On("CacheDisableForNextMinutes", minutes)}
}
...
func (_m *MockService) CacheEnable() error {
	ret := _m.Called()
...
// MockService_EnableCache_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CacheEnable'
type MockService_EnableCache_Call struct {
	*mock.Call
}

// CacheEnable is a helper method to define mock.On call
func (_e *MockService_Expecter) CacheEnable() *MockService_EnableCache_Call {
	return &MockService_EnableCache_Call{Call: _e.mock.On("CacheEnable")}
}
...
func (_m *MockService) IsCacheEnabled() bool {
	ret := _m.Called()
...
// MockService_IsCacheEnabled_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsCacheEnabled'
type MockService_IsCacheEnabled_Call struct {
	*mock.Call
}

// IsCacheEnabled is a helper method to define mock.On call
func (_e *MockService_Expecter) IsCacheEnabled() *MockService_IsCacheEnabled_Call {
	return &MockService_IsCacheEnabled_Call{Call: _e.mock.On("IsCacheEnabled")}
}

func (_c *MockService_IsCacheEnabled_Call) Run(run func()) *MockService_IsCacheEnabled_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockService_IsCacheEnabled_Call) Return(enabled bool) *MockService_IsCacheEnabled_Call {
	_c.Call.Return(enabled)
	return _c
}

func (_c *MockService_IsCacheEnabled_Call) RunAndReturn(run func() bool) *MockService_IsCacheEnabled_Call {
	_c.Call.Return(run)
	return _c
}
