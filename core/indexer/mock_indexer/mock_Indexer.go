...
func (_m *MockIndexer) ReindexMarketplaceSpace(_a0 space.Space) error {
	ret := _m.Called(_a0)
...
//   - _a0 space.Space
func (_e *MockIndexer_Expecter) ReindexMarketplaceSpace(_a0 interface{}) *MockIndexer_ReindexMarketplaceSpace_Call {
	return &MockIndexer_ReindexMarketplaceSpace_Call{Call: _e.mock.On("ReindexMarketplaceSpace", _a0)}
}

func (_c *MockIndexer_ReindexMarketplaceSpace_Call) Run(run func(_a0 space.Space)) *MockIndexer_ReindexMarketplaceSpace_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockIndexer_ReindexMarketplaceSpace_Call) RunAndReturn(run func(space.Space) error) *MockIndexer_ReindexMarketplaceSpace_Call {
	_c.Call.Return(run)
	return _c
}

// ReindexSpace provides a mock function with given fields: _a0
func (_m *MockIndexer) ReindexSpace(_a0 space.Space) error {
	ret := _m.Called(_a0)
...
//   - _a0 space.Space
func (_e *MockIndexer_Expecter) ReindexSpace(_a0 interface{}) *MockIndexer_ReindexSpace_Call {
	return &MockIndexer_ReindexSpace_Call{Call: _e.mock.On("ReindexSpace", _a0)}
}

func (_c *MockIndexer_ReindexSpace_Call) Run(run func(_a0 space.Space)) *MockIndexer_ReindexSpace_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(space.Space))
	})
	return _c
...
func (_c *MockIndexer_ReindexSpace_Call) RunAndReturn(run func(space.Space) error) *MockIndexer_ReindexSpace_Call {
	_c.Call.Return(run)
	return _c
}
