...
// GetLastIndexTime provides a mock function with given fields: spaceId
func (_m *MockIndexer) GetLastIndexTime(spaceId string) time.Time {
	ret := _m.Called(spaceId)

	if len(ret) == 0 {
		panic("no return value specified for GetLastIndexTime")
	}
...
// MockIndexer_GetLastIndexTime_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetLastIndexTime'
type MockIndexer_GetLastIndexTime_Call struct {
	*mock.Call
}

// GetLastIndexTime is a helper method to define mock.On call
//   - spaceId string
func (_e *MockIndexer_Expecter) GetLastIndexTime(spaceId interface{}) *MockIndexer_GetLastIndexTime_Call {
	return &MockIndexer_GetLastIndexTime_Call{Call: _e.mock.On("GetLastIndexTime", spaceId)}
}

func (_c *MockIndexer_GetLastIndexTime_Call) Run(run func(spaceId string)) *MockIndexer_GetLastIndexTime_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockIndexer_GetLastIndexTime_Call) Return(_a0 time.Time) *MockIndexer_GetLastIndexTime_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockIndexer_GetLastIndexTime_Call) RunAndReturn(run func(string) time.Time) *MockIndexer_GetLastIndexTime_Call {
	_c.Call.Return(run)
	return _c
}
