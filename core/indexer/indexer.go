...
const (
	...
	ForceIdxRebuildCounter            int32 = 2 // erases localstore indexes and reindex all type of objects (no need to increase ForceThreadsObjectsReindexCounter & ForceFilesReindexCounter)
