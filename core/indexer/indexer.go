...
const (
	...
	ForceIdxRebuildCounter            int32 = 13 // erases localstore indexes and reindex all type of objects (no need to increase ForceThreadsObjectsReindexCounter & ForceFilesReindexCounter)
