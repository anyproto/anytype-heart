...
type EventSyncThreadStatus int32

const (
	EventSync_Unknown    EventSyncThreadStatus = 0
	EventSync_InProgress EventSyncThreadStatus = 1
	EventSync_Success    EventSyncThreadStatus = 2
	EventSync_Failure    EventSyncThreadStatus = 3
)

var EventSyncThreadStatus_name = map[int32]string{
	0: "Unknown",
	1: "InProgress",
	2: "Success",
	3: "Failure",
...
var EventSyncThreadStatus_value = map[string]int32{
	"Unknown":    0,
	"InProgress": 1,
	"Success":    2,
	"Failure":    3,
...
func (x EventSyncThreadStatus) String() string {
	return proto.EnumName(EventSyncThreadStatus_name, int32(x))
}

func (EventSyncThreadStatus) EnumDescriptor() ([]byte, []int) {
...
type EventMessageValueOfSyncStatus struct {
	SyncStatus *EventSync `protobuf:"bytes,110,opt,name=syncStatus,proto3,oneof" json:"syncStatus,omitempty"`
}
...
func (*EventMessageValueOfSyncStatus) IsEventMessageValue()              {}
...
func (m *EventMessage) GetSyncStatus() *EventSync {
	if x, ok := m.GetValue().(*EventMessageValueOfSyncStatus); ok {
		return x.SyncStatus
	}
	return nil
}
...
func (*EventMessage) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*EventMessageValueOfSyncStatus)(nil),
	}
}
...
type EventSync struct {
	Thread   EventSyncThreadStatus `protobuf:"varint,1,opt,name=thread,proto3,enum=anytype.EventSyncThreadStatus" json:"thread,omitempty"`
...
func (m *EventSync) GetThread() EventSyncThreadStatus {
	if m != nil {
		return m.Thread
	}
	return EventSync_Unknown
}

func (m *EventSync) GetLastPull() int64 {
	if m != nil {
		return m.LastPull
	}
	return 0
...
func init() {
	...
	proto.RegisterEnum("anytype.EventSyncThreadStatus", EventSyncThreadStatus_name, EventSyncThreadStatus_value)
	...
	proto.RegisterType((*EventSync)(nil), "anytype.Event.Sync")
...
var fileDescriptor_a966342d378ae5f5 = []byte{
	...
	,
}
...
func (m *EventMessageValueOfSyncStatus) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventMessageValueOfSyncStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SyncStatus != nil {
		{
...
func (m *EventSync) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventSync) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventSync) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Thread != 0 {
		i = encodeVarintEvents(dAtA, i, uint64(m.Thread))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *EventMessageValueOfSyncStatus) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventMessage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 110:
			...
			m.Value = &EventMessageValueOfSyncStatus{v}
			iNdEx = postIndex
		case 201:
			if wireType != 2 {
...
func (m *EventSync) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Thread |= EventSyncThreadStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
