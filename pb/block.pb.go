...
type BlockLayout_Style int32

const (
	BlockLayout_ROW    BlockLayout_Style = 0
	BlockLayout_COLUMN BlockLayout_Style = 1
)

var BlockLayout_Style_name = map[int32]string{
	0: "ROW",
	1: "COLUMN",
}

var BlockLayout_Style_value = map[string]int32{
	"ROW":    0,
	"COLUMN": 1,
}

func (x BlockLayout_Style) String() string {
	return proto.EnumName(BlockLayout_Style_name, int32(x))
}

func (BlockLayout_Style) EnumDescriptor() ([]byte, []int) {
...
type BlockLayout struct {
	Style BlockLayout_Style `protobuf:"varint,1,opt,name=style,proto3,enum=anytype.BlockLayout_Style" json:"style,omitempty"`
}
...
func (m *BlockLayout) GetStyle() BlockLayout_Style {
	if m != nil {
		return m.Style
	}
	return BlockLayout_ROW
}
...
func init() {
	...
	proto.RegisterEnum("anytype.BlockLayout_Style", BlockLayout_Style_name, BlockLayout_Style_value)
...
var fileDescriptor_8e550b1f5926e92d = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Style |= BlockLayout_Style(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
