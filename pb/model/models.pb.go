...
func (BlockPosition) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 0}
}
...
func (BlockAlign) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1}
}
...
func (BlockContentLayoutStyle) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 0, 0}
}
...
func (BlockContentLinkStyle) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 1, 0}
}
...
func (BlockContentDivStyle) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 2, 0}
}
...
func (BlockContentTextStyle) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 5, 0}
}
...
func (BlockContentTextMarkType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 5, 1, 0}
}
...
func (BlockContentFileType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 6, 0}
}
...
func (BlockContentFileState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 6, 1}
}

type BlockContentDataviewSortType int32

const (
	BlockContentDataview_Asc  BlockContentDataviewSortType = 0
	BlockContentDataview_Desc BlockContentDataviewSortType = 1
)
...
func (BlockContentDataviewSortType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 8, 0}
}

type BlockContentDataviewViewType int32

const (
	BlockContentDataview_Table   BlockContentDataviewViewType = 0
	BlockContentDataview_List    BlockContentDataviewViewType = 1
	BlockContentDataview_Gallery BlockContentDataviewViewType = 2
	BlockContentDataview_Kanban  BlockContentDataviewViewType = 3
)
...
func (BlockContentDataviewViewType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 8, 1}
}

type BlockContentDataviewFilterTypeOperator int32

const (
	BlockContentDataview_And BlockContentDataviewFilterTypeOperator = 0
	BlockContentDataview_Or  BlockContentDataviewFilterTypeOperator = 1
)

var BlockContentDataviewFilterTypeOperator_name = map[int32]string{
	0: "And",
	1: "Or",
}

var BlockContentDataviewFilterTypeOperator_value = map[string]int32{
	"And": 0,
	"Or":  1,
}

func (x BlockContentDataviewFilterTypeOperator) String() string {
	return proto.EnumName(BlockContentDataviewFilterTypeOperator_name, int32(x))
}

func (BlockContentDataviewFilterTypeOperator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 8, 2}
}

type BlockContentDataviewFilterTypeCondition int32

const (
	BlockContentDataview_Equal    BlockContentDataviewFilterTypeCondition = 0
	BlockContentDataview_NotEqual BlockContentDataviewFilterTypeCondition = 1
	BlockContentDataview_Greater  BlockContentDataviewFilterTypeCondition = 2
	BlockContentDataview_Less     BlockContentDataviewFilterTypeCondition = 3
	BlockContentDataview_Like     BlockContentDataviewFilterTypeCondition = 4
	BlockContentDataview_NotLike  BlockContentDataviewFilterTypeCondition = 5
	BlockContentDataview_In       BlockContentDataviewFilterTypeCondition = 6
	BlockContentDataview_NotIn    BlockContentDataviewFilterTypeCondition = 7
)

var BlockContentDataviewFilterTypeCondition_name = map[int32]string{
	0: "Equal",
	1: "NotEqual",
	2: "Greater",
	3: "Less",
...
var BlockContentDataviewFilterTypeCondition_value = map[string]int32{
	"Equal":    0,
	"NotEqual": 1,
	"Greater":  2,
	"Less":     3,
...
func (x BlockContentDataviewFilterTypeCondition) String() string {
	return proto.EnumName(BlockContentDataviewFilterTypeCondition_name, int32(x))
}

func (BlockContentDataviewFilterTypeCondition) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 8, 3}
}
...
func (*BlockContentLayout) Descriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 0}
}
...
func (*BlockContentLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 1}
}
...
func (*BlockContentDiv) Descriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 2}
}
...
func (*BlockContentBookmark) Descriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 3}
}
...
func (*BlockContentIcon) Descriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 4}
}
...
func (*BlockContentText) Descriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 5}
}
...
func (*BlockContentTextMark) Descriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 5, 1}
}
...
func (*BlockContentFile) Descriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 6}
}
...
func (*BlockContentSmartblock) Descriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 7}
}
...
func (*BlockContentDataview) Descriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 8}
}
...
type BlockContentDataviewView struct {
	Type    BlockContentDataviewViewType `protobuf:"varint,1,opt,name=type,proto3,enum=anytype.model.BlockContentDataviewViewType" json:"type,omitempty"`
	Name    string                       `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Sort    *BlockContentDataviewSorts   `protobuf:"bytes,3,opt,name=sort,proto3" json:"sort,omitempty"`
	Filters *BlockContentDataviewFilters `protobuf:"bytes,4,opt,name=filters,proto3" json:"filters,omitempty"`
}
...
func (m *BlockContentDataviewView) GetType() BlockContentDataviewViewType {
	...
	return BlockContentDataview_Table
}
...
func (m *BlockContentDataviewView) GetSort() *BlockContentDataviewSorts {
	if m != nil {
		return m.Sort
	}
	return nil
...
func (m *BlockContentDataviewView) GetFilters() *BlockContentDataviewFilters {
	if m != nil {
		return m.Filters
	}
	return nil
...
func (m *BlockContentDataviewSort) GetColumn() string {
	if m != nil {
		return m.Column
	}
	return ""
...
func (m *BlockContentDataviewSort) GetType() BlockContentDataviewSortType {
	...
	return BlockContentDataview_Asc
}

type BlockContentDataviewSorts struct {
	Sorts []*BlockContentDataviewSort `protobuf:"bytes,1,rep,name=sorts,proto3" json:"sorts,omitempty"`
}

func (m *BlockContentDataviewSorts) Reset()         { *m = BlockContentDataviewSorts{} }
func (m *BlockContentDataviewSorts) String() string { return proto.CompactTextString(m) }
func (*BlockContentDataviewSorts) ProtoMessage()    {}
func (*BlockContentDataviewSorts) Descriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 8, 2}
}
func (m *BlockContentDataviewSorts) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BlockContentDataviewSorts) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BlockContentDataviewSorts.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BlockContentDataviewSorts) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BlockContentDataviewSorts.Merge(m, src)
}
func (m *BlockContentDataviewSorts) XXX_Size() int {
	return m.Size()
}
func (m *BlockContentDataviewSorts) XXX_DiscardUnknown() {
	xxx_messageInfo_BlockContentDataviewSorts.DiscardUnknown(m)
}

var xxx_messageInfo_BlockContentDataviewSorts proto.InternalMessageInfo

func (m *BlockContentDataviewSorts) GetSorts() []*BlockContentDataviewSort {
	if m != nil {
		return m.Sorts
	}
	return nil
...
type BlockContentDataviewFilter struct {
	Column    string                                  `protobuf:"bytes,1,opt,name=column,proto3" json:"column,omitempty"`
	Condition BlockContentDataviewFilterTypeCondition `protobuf:"varint,2,opt,name=condition,proto3,enum=anytype.model.BlockContentDataviewFilterTypeCondition" json:"condition,omitempty"`
...
func (m *BlockContentDataviewFilter) GetColumn() string {
	if m != nil {
		return m.Column
	}
	return ""
...
func (m *BlockContentDataviewFilter) GetCondition() BlockContentDataviewFilterTypeCondition {
	if m != nil {
		return m.Condition
	}
	return BlockContentDataview_Equal
}
...
type BlockContentDataviewFilters struct {
	Filters  []*BlockContentDataviewFilter          `protobuf:"bytes,1,rep,name=filters,proto3" json:"filters,omitempty"`
	Operator BlockContentDataviewFilterTypeOperator `protobuf:"varint,2,opt,name=operator,proto3,enum=anytype.model.BlockContentDataviewFilterTypeOperator" json:"operator,omitempty"`
}

func (m *BlockContentDataviewFilters) Reset()         { *m = BlockContentDataviewFilters{} }
func (m *BlockContentDataviewFilters) String() string { return proto.CompactTextString(m) }
func (*BlockContentDataviewFilters) ProtoMessage()    {}
func (*BlockContentDataviewFilters) Descriptor() ([]byte, []int) {
	return fileDescriptor_47d1277a02da26d7, []int{1, 1, 8, 4}
}
func (m *BlockContentDataviewFilters) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BlockContentDataviewFilters) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BlockContentDataviewFilters.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BlockContentDataviewFilters) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BlockContentDataviewFilters.Merge(m, src)
}
func (m *BlockContentDataviewFilters) XXX_Size() int {
	return m.Size()
}
func (m *BlockContentDataviewFilters) XXX_DiscardUnknown() {
	xxx_messageInfo_BlockContentDataviewFilters.DiscardUnknown(m)
}

var xxx_messageInfo_BlockContentDataviewFilters proto.InternalMessageInfo

func (m *BlockContentDataviewFilters) GetFilters() []*BlockContentDataviewFilter {
	if m != nil {
		return m.Filters
	}
	return nil
...
func (m *BlockContentDataviewFilters) GetOperator() BlockContentDataviewFilterTypeOperator {
	if m != nil {
		return m.Operator
	}
	return BlockContentDataview_And
}
...
func init() {
	...
	proto.RegisterEnum("anytype.model.BlockContentDataviewFilterTypeOperator", BlockContentDataviewFilterTypeOperator_name, BlockContentDataviewFilterTypeOperator_value)
	proto.RegisterEnum("anytype.model.BlockContentDataviewFilterTypeCondition", BlockContentDataviewFilterTypeCondition_name, BlockContentDataviewFilterTypeCondition_value)
	...
	proto.RegisterType((*BlockContentDataviewSorts)(nil), "anytype.model.Block.Content.Dataview.Sorts")
	proto.RegisterType((*BlockContentDataviewFilter)(nil), "anytype.model.Block.Content.Dataview.Filter")
	proto.RegisterType((*BlockContentDataviewFilters)(nil), "anytype.model.Block.Content.Dataview.Filters")
...
var fileDescriptor_47d1277a02da26d7 = []byte{
	...
	,
}
...
func (m *BlockContentDataviewSort) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Column) > 0 {
		...
		i = encodeVarintModels(dAtA, i, uint64(len(m.Column)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *BlockContentDataviewSorts) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BlockContentDataviewSorts) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BlockContentDataviewSorts) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BlockContentDataviewFilters) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BlockContentDataviewFilters) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BlockContentDataviewFilters) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BlockContentDataviewSorts) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BlockContentDataviewFilters) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BlockContentDataviewView) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Sort == nil {
				m.Sort = &BlockContentDataviewSorts{}
			}
		...
		case 4:
			...
			if m.Filters == nil {
				m.Filters = &BlockContentDataviewFilters{}
			}
...
func (m *BlockContentDataviewSorts) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Sorts: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Sorts: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Condition |= BlockContentDataviewFilterTypeCondition(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *BlockContentDataviewFilters) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Operator |= BlockContentDataviewFilterTypeOperator(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
