...
type ClientCommandsClient interface {
	...
	ChatReadReaction(ctx context.Context, in *pb.RpcChatReadReactionRequest, opts ...grpc.CallOption) (*pb.RpcChatReadReactionResponse, error)
...
func (c *clientCommandsClient) ChatReadReaction(ctx context.Context, in *pb.RpcChatReadReactionRequest, opts ...grpc.CallOption) (*pb.RpcChatReadReactionResponse, error) {
	out := new(pb.RpcChatReadReactionResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ChatReadReaction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ChatReadReaction(ctx context.Context, req *pb.RpcChatReadReactionRequest) *pb.RpcChatReadReactionResponse {
	return nil
}
...
func _ClientCommands_ChatReadReaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcChatReadReactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ChatReadReaction(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ChatReadReaction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ChatReadReaction(ctx, req.(*pb.RpcChatReadReactionRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChatReadReaction",
			Handler:    _ClientCommands_ChatReadReaction_Handler,
		},
		{
