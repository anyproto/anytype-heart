...
type ClientCommandsClient interface {
	...
	AIWebsiteProcess(ctx context.Context, in *pb.RpcAIWebsiteProcessRequest, opts ...grpc.CallOption) (*pb.RpcAIWebsiteProcessResponse, error)
}
...
func (c *clientCommandsClient) AIWebsiteProcess(ctx context.Context, in *pb.RpcAIWebsiteProcessRequest, opts ...grpc.CallOption) (*pb.RpcAIWebsiteProcessResponse, error) {
	out := new(pb.RpcAIWebsiteProcessResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/AIWebsiteProcess", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) AIWebsiteProcess(ctx context.Context, req *pb.RpcAIWebsiteProcessRequest) *pb.RpcAIWebsiteProcessResponse {
	return nil
}
...
func _ClientCommands_AIWebsiteProcess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcAIWebsiteProcessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).AIWebsiteProcess(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/AIWebsiteProcess",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).AIWebsiteProcess(ctx, req.(*pb.RpcAIWebsiteProcessRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AIWebsiteProcess",
			Handler:    _ClientCommands_AIWebsiteProcess_Handler,
		},
	},
