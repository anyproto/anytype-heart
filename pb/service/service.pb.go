...
type ClientCommandsClient interface {
	...
	BlockDataviewCreateWithObject(ctx context.Context, in *pb.RpcBlockDataviewCreateWithObjectRequest, opts ...grpc.CallOption) (*pb.RpcBlockDataviewCreateWithObjectResponse, error)
...
func (c *clientCommandsClient) BlockDataviewCreateWithObject(ctx context.Context, in *pb.RpcBlockDataviewCreateWithObjectRequest, opts ...grpc.CallOption) (*pb.RpcBlockDataviewCreateWithObjectResponse, error) {
	out := new(pb.RpcBlockDataviewCreateWithObjectResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/BlockDataviewCreateWithObject", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) BlockDataviewCreateWithObject(ctx context.Context, req *pb.RpcBlockDataviewCreateWithObjectRequest) *pb.RpcBlockDataviewCreateWithObjectResponse {
	return nil
}
...
func _ClientCommands_BlockDataviewCreateWithObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcBlockDataviewCreateWithObjectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).BlockDataviewCreateWithObject(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/BlockDataviewCreateWithObject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).BlockDataviewCreateWithObject(ctx, req.(*pb.RpcBlockDataviewCreateWithObjectRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BlockDataviewCreateWithObject",
			Handler:    _ClientCommands_BlockDataviewCreateWithObject_Handler,
		},
		{
