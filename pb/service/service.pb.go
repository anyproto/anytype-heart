...
type ClientCommandsClient interface {
	...
	BlockRelationUpdate(ctx context.Context, in *pb.RpcBlockRelationUpdateRequest, opts ...grpc.CallOption) (*pb.RpcBlockRelationUpdateResponse, error)
	BlockRelationRemove(ctx context.Context, in *pb.RpcBlockRelationRemoveRequest, opts ...grpc.CallOption) (*pb.RpcBlockRelationRemoveResponse, error)
...
func (c *clientCommandsClient) BlockRelationUpdate(ctx context.Context, in *pb.RpcBlockRelationUpdateRequest, opts ...grpc.CallOption) (*pb.RpcBlockRelationUpdateResponse, error) {
	out := new(pb.RpcBlockRelationUpdateResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/BlockRelationUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientCommandsClient) BlockRelationRemove(ctx context.Context, in *pb.RpcBlockRelationRemoveRequest, opts ...grpc.CallOption) (*pb.RpcBlockRelationRemoveResponse, error) {
	out := new(pb.RpcBlockRelationRemoveResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/BlockRelationRemove", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) BlockRelationUpdate(req *pb.RpcBlockRelationUpdateRequest) *pb.RpcBlockRelationUpdateResponse {
	return nil
}
func (*UnimplementedClientCommandsServer) BlockRelationRemove(req *pb.RpcBlockRelationRemoveRequest) *pb.RpcBlockRelationRemoveResponse {
	return nil
}
...
func _ClientCommands_BlockRelationUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcBlockRelationUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).BlockRelationUpdate(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/BlockRelationUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).BlockRelationUpdate(req.(*pb.RpcBlockRelationUpdateRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}

func _ClientCommands_BlockRelationRemove_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcBlockRelationRemoveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).BlockRelationRemove(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/BlockRelationRemove",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).BlockRelationRemove(req.(*pb.RpcBlockRelationRemoveRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BlockRelationUpdate",
			Handler:    _ClientCommands_BlockRelationUpdate_Handler,
		},
		{
			MethodName: "BlockRelationRemove",
			Handler:    _ClientCommands_BlockRelationRemove_Handler,
		},
		{
