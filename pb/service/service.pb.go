...
type ClientCommandsClient interface {
	...
	ObjectTypeRecommendedLayoutSet(ctx context.Context, in *pb.RpcObjectTypeRecommendedLayoutSetRequest, opts ...grpc.CallOption) (*pb.RpcObjectTypeRecommendedLayoutSetResponse, error)
...
func (c *clientCommandsClient) ObjectTypeRecommendedLayoutSet(ctx context.Context, in *pb.RpcObjectTypeRecommendedLayoutSetRequest, opts ...grpc.CallOption) (*pb.RpcObjectTypeRecommendedLayoutSetResponse, error) {
	out := new(pb.RpcObjectTypeRecommendedLayoutSetResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ObjectTypeRecommendedLayoutSet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ObjectTypeRecommendedLayoutSet(ctx context.Context, req *pb.RpcObjectTypeRecommendedLayoutSetRequest) *pb.RpcObjectTypeRecommendedLayoutSetResponse {
	return nil
}
...
func _ClientCommands_ObjectTypeRecommendedLayoutSet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcObjectTypeRecommendedLayoutSetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ObjectTypeRecommendedLayoutSet(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ObjectTypeRecommendedLayoutSet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ObjectTypeRecommendedLayoutSet(ctx, req.(*pb.RpcObjectTypeRecommendedLayoutSetRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ObjectTypeRecommendedLayoutSet",
			Handler:    _ClientCommands_ObjectTypeRecommendedLayoutSet_Handler,
		},
		{
