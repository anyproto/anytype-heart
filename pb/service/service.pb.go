...
type ClientCommandsClient interface {
	...
	AccountRecoverFromLegacyBackup(ctx context.Context, in *pb.RpcAccountRecoverFromLegacyBackupRequest, opts ...grpc.CallOption) (*pb.RpcAccountRecoverFromLegacyBackupResponse, error)
	// Object
	// ***
...
func (c *clientCommandsClient) AccountRecoverFromLegacyBackup(ctx context.Context, in *pb.RpcAccountRecoverFromLegacyBackupRequest, opts ...grpc.CallOption) (*pb.RpcAccountRecoverFromLegacyBackupResponse, error) {
	out := new(pb.RpcAccountRecoverFromLegacyBackupResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/AccountRecoverFromLegacyBackup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) AccountRecoverFromLegacyBackup(ctx context.Context, req *pb.RpcAccountRecoverFromLegacyBackupRequest) *pb.RpcAccountRecoverFromLegacyBackupResponse {
	return nil
}
...
func _ClientCommands_AccountRecoverFromLegacyBackup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcAccountRecoverFromLegacyBackupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).AccountRecoverFromLegacyBackup(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/AccountRecoverFromLegacyBackup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).AccountRecoverFromLegacyBackup(ctx, req.(*pb.RpcAccountRecoverFromLegacyBackupRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AccountRecoverFromLegacyBackup",
			Handler:    _ClientCommands_AccountRecoverFromLegacyBackup_Handler,
		},
		{
