...
type ClientCommandsClient interface {
	...
	WalletExportBot(ctx context.Context, in *pb.RpcWalletExportBotRequest, opts ...grpc.CallOption) (*pb.RpcWalletExportBotResponse, error)
	// Workspace
	// ***
...
func (c *clientCommandsClient) WalletExportBot(ctx context.Context, in *pb.RpcWalletExportBotRequest, opts ...grpc.CallOption) (*pb.RpcWalletExportBotResponse, error) {
	out := new(pb.RpcWalletExportBotResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/WalletExportBot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) WalletExportBot(ctx context.Context, req *pb.RpcWalletExportBotRequest) *pb.RpcWalletExportBotResponse {
	return nil
}
...
func _ClientCommands_WalletExportBot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcWalletExportBotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).WalletExportBot(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/WalletExportBot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).WalletExportBot(ctx, req.(*pb.RpcWalletExportBotRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WalletExportBot",
			Handler:    _ClientCommands_WalletExportBot_Handler,
		},
		{
