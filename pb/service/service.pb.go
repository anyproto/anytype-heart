...
type ClientCommandsClient interface {
	...
	// Migration
	UserDataImport(ctx context.Context, in *pb.RpcUserDataImportRequest, opts ...grpc.CallOption) (*pb.RpcUserDataImportResponse, error)
}
...
func (c *clientCommandsClient) UserDataImport(ctx context.Context, in *pb.RpcUserDataImportRequest, opts ...grpc.CallOption) (*pb.RpcUserDataImportResponse, error) {
	out := new(pb.RpcUserDataImportResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/UserDataImport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) UserDataImport(ctx context.Context, req *pb.RpcUserDataImportRequest) *pb.RpcUserDataImportResponse {
	return nil
}
...
func _ClientCommands_UserDataImport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcUserDataImportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).UserDataImport(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/UserDataImport",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).UserDataImport(ctx, req.(*pb.RpcUserDataImportRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UserDataImport",
			Handler:    _ClientCommands_UserDataImport_Handler,
		},
	},
