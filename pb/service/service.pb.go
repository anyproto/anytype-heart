...
type ClientCommandsClient interface {
	...
	SetDeviceState(ctx context.Context, in *pb.RpcDeviceStateRequest, opts ...grpc.CallOption) (*pb.RpcDeviceStateResponse, error)
	...
	BlockListSetLinkAppearance(ctx context.Context, in *pb.RpcBlockListSetLinkAppearanceRequest, opts ...grpc.CallOption) (*pb.RpcBlockListSetLinkAppearanceResponse, error)
...
func (c *clientCommandsClient) SetDeviceState(ctx context.Context, in *pb.RpcDeviceStateRequest, opts ...grpc.CallOption) (*pb.RpcDeviceStateResponse, error) {
	out := new(pb.RpcDeviceStateResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/SetDeviceState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientCommandsClient) BlockListSetLinkAppearance(ctx context.Context, in *pb.RpcBlockListSetLinkAppearanceRequest, opts ...grpc.CallOption) (*pb.RpcBlockListSetLinkAppearanceResponse, error) {
	out := new(pb.RpcBlockListSetLinkAppearanceResponse)
...
func (*UnimplementedClientCommandsServer) SetDeviceState(req *pb.RpcDeviceStateRequest) *pb.RpcDeviceStateResponse {
	return nil
}
...
func (*UnimplementedClientCommandsServer) BlockListSetLinkAppearance(req *pb.RpcBlockListSetLinkAppearanceRequest) *pb.RpcBlockListSetLinkAppearanceResponse {
	return nil
}
...
func _ClientCommands_SetDeviceState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcDeviceStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).SetDeviceState(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/SetDeviceState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).SetDeviceState(req.(*pb.RpcDeviceStateRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ClientCommands_BlockListSetLinkAppearance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).BlockListSetLinkAppearance(req.(*pb.RpcBlockListSetLinkAppearanceRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ClientCommands_SetDeviceState_Handler,
		},
		{
