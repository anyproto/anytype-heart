...
func (c *clientCommandsClient) ListenSessionEvents(ctx context.Context, in *pb.StreamRequest, opts ...grpc.CallOption) (ClientCommands_ListenSessionEventsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ClientCommands_serviceDesc.Streams[1], "/anytype.ClientCommands/ListenSessionEvents", opts...)
	if err != nil {
		return nil, err
	}
...
func (*UnimplementedClientCommandsServer) WalletCreateSession(req *pb.RpcWalletCreateSessionRequest) *pb.RpcWalletCreateSessionResponse {
	return nil
}
...
func _ClientCommands_WalletCreateSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(ClientCommandsServer).WalletCreateSession(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).WalletCreateSession(req.(*pb.RpcWalletCreateSessionRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
