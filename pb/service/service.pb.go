...
type ClientCommandsClient interface {
	...
	MembershipV2WebAuth(ctx context.Context, in *pb.RpcMembershipV2WebAuthRequest, opts ...grpc.CallOption) (*pb.RpcMembershipV2WebAuthResponse, error)
...
func (c *clientCommandsClient) MembershipV2WebAuth(ctx context.Context, in *pb.RpcMembershipV2WebAuthRequest, opts ...grpc.CallOption) (*pb.RpcMembershipV2WebAuthResponse, error) {
	out := new(pb.RpcMembershipV2WebAuthResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/MembershipV2WebAuth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) MembershipV2WebAuth(ctx context.Context, req *pb.RpcMembershipV2WebAuthRequest) *pb.RpcMembershipV2WebAuthResponse {
	return nil
}
...
func _ClientCommands_MembershipV2WebAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcMembershipV2WebAuthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).MembershipV2WebAuth(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/MembershipV2WebAuth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).MembershipV2WebAuth(ctx, req.(*pb.RpcMembershipV2WebAuthRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MembershipV2WebAuth",
			Handler:    _ClientCommands_MembershipV2WebAuth_Handler,
		},
		{
