...
type ClientCommandsClient interface {
	...
	BlockTableRowMove(ctx context.Context, in *pb.RpcBlockTableRowMoveRequest, opts ...grpc.CallOption) (*pb.RpcBlockTableRowMoveResponse, error)
...
func (c *clientCommandsClient) BlockTableRowMove(ctx context.Context, in *pb.RpcBlockTableRowMoveRequest, opts ...grpc.CallOption) (*pb.RpcBlockTableRowMoveResponse, error) {
	out := new(pb.RpcBlockTableRowMoveResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/BlockTableRowMove", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) BlockTableRowMove(req *pb.RpcBlockTableRowMoveRequest) *pb.RpcBlockTableRowMoveResponse {
	return nil
}
...
func _ClientCommands_BlockTableRowMove_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcBlockTableRowMoveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).BlockTableRowMove(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/BlockTableRowMove",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).BlockTableRowMove(req.(*pb.RpcBlockTableRowMoveRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BlockTableRowMove",
			Handler:    _ClientCommands_BlockTableRowMove_Handler,
		},
		{
