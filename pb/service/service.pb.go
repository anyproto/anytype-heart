...
type ClientCommandsClient interface {
	...
	AccountRestart(ctx context.Context, in *pb.RpcAccountRestartRequest, opts ...grpc.CallOption) (*pb.RpcAccountRestartResponse, error)
	// Space
	// ***
...
func (c *clientCommandsClient) AccountRestart(ctx context.Context, in *pb.RpcAccountRestartRequest, opts ...grpc.CallOption) (*pb.RpcAccountRestartResponse, error) {
	out := new(pb.RpcAccountRestartResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/AccountRestart", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) AccountRestart(ctx context.Context, req *pb.RpcAccountRestartRequest) *pb.RpcAccountRestartResponse {
	return nil
}
...
func _ClientCommands_AccountRestart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcAccountRestartRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).AccountRestart(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/AccountRestart",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).AccountRestart(ctx, req.(*pb.RpcAccountRestartRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AccountRestart",
			Handler:    _ClientCommands_AccountRestart_Handler,
		},
		{
