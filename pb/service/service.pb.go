...
type ClientCommandsClient interface {
	...
	BlockTableCellSetVerticalAlign(ctx context.Context, in *pb.RpcBlockTableCellSetVerticalAlignRequest, opts ...grpc.CallOption) (*pb.RpcBlockTableCellSetVerticalAlignResponse, error)
...
func (c *clientCommandsClient) BlockTableCellSetVerticalAlign(ctx context.Context, in *pb.RpcBlockTableCellSetVerticalAlignRequest, opts ...grpc.CallOption) (*pb.RpcBlockTableCellSetVerticalAlignResponse, error) {
	out := new(pb.RpcBlockTableCellSetVerticalAlignResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/BlockTableCellSetVerticalAlign", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) BlockTableCellSetVerticalAlign(req *pb.RpcBlockTableCellSetVerticalAlignRequest) *pb.RpcBlockTableCellSetVerticalAlignResponse {
	return nil
}
...
func _ClientCommands_BlockTableCellSetVerticalAlign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcBlockTableCellSetVerticalAlignRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).BlockTableCellSetVerticalAlign(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/BlockTableCellSetVerticalAlign",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).BlockTableCellSetVerticalAlign(req.(*pb.RpcBlockTableCellSetVerticalAlignRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BlockTableCellSetVerticalAlign",
			Handler:    _ClientCommands_BlockTableCellSetVerticalAlign_Handler,
		},
		{
