...
type ClientCommandsClient interface {
	...
	ExtensionBroadcast(ctx context.Context, in *pb.RpcExtensionBroadcastRequest, opts ...grpc.CallOption) (*pb.RpcExtensionBroadcastResponse, error)
}
...
func (c *clientCommandsClient) ExtensionBroadcast(ctx context.Context, in *pb.RpcExtensionBroadcastRequest, opts ...grpc.CallOption) (*pb.RpcExtensionBroadcastResponse, error) {
	out := new(pb.RpcExtensionBroadcastResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ExtensionBroadcast", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ExtensionBroadcast(ctx context.Context, req *pb.RpcExtensionBroadcastRequest) *pb.RpcExtensionBroadcastResponse {
	return nil
}
...
func _ClientCommands_ExtensionBroadcast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcExtensionBroadcastRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ExtensionBroadcast(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ExtensionBroadcast",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ExtensionBroadcast(ctx, req.(*pb.RpcExtensionBroadcastRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ExtensionBroadcast",
			Handler:    _ClientCommands_ExtensionBroadcast_Handler,
		},
	},
