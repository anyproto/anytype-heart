...
type ClientCommandsClient interface {
	...
	BlockCanvasNodeCreateWithObject(ctx context.Context, in *pb.RpcBlockCanvasNodeCreateWithObjectRequest, opts ...grpc.CallOption) (*pb.RpcBlockCanvasNodeCreateWithObjectResponse, error)
...
func (c *clientCommandsClient) BlockCanvasNodeCreateWithObject(ctx context.Context, in *pb.RpcBlockCanvasNodeCreateWithObjectRequest, opts ...grpc.CallOption) (*pb.RpcBlockCanvasNodeCreateWithObjectResponse, error) {
	out := new(pb.RpcBlockCanvasNodeCreateWithObjectResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/BlockCanvasNodeCreateWithObject", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) BlockCanvasNodeCreateWithObject(ctx context.Context, req *pb.RpcBlockCanvasNodeCreateWithObjectRequest) *pb.RpcBlockCanvasNodeCreateWithObjectResponse {
	return nil
}
...
func _ClientCommands_BlockCanvasNodeCreateWithObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcBlockCanvasNodeCreateWithObjectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).BlockCanvasNodeCreateWithObject(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/BlockCanvasNodeCreateWithObject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).BlockCanvasNodeCreateWithObject(ctx, req.(*pb.RpcBlockCanvasNodeCreateWithObjectRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BlockCanvasNodeCreateWithObject",
			Handler:    _ClientCommands_BlockCanvasNodeCreateWithObject_Handler,
		},
		{
