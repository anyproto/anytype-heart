...
type ClientCommandsClient interface {
	...
	ObjectPublish(ctx context.Context, in *pb.RpcObjectPublishRequest, opts ...grpc.CallOption) (*pb.RpcObjectPublishResponse, error)
...
func (c *clientCommandsClient) ObjectPublish(ctx context.Context, in *pb.RpcObjectPublishRequest, opts ...grpc.CallOption) (*pb.RpcObjectPublishResponse, error) {
	out := new(pb.RpcObjectPublishResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ObjectPublish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ObjectPublish(ctx context.Context, req *pb.RpcObjectPublishRequest) *pb.RpcObjectPublishResponse {
	return nil
}
...
func _ClientCommands_ObjectPublish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcObjectPublishRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ObjectPublish(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ObjectPublish",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ObjectPublish(ctx, req.(*pb.RpcObjectPublishRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ObjectPublish",
			Handler:    _ClientCommands_ObjectPublish_Handler,
		},
		{
