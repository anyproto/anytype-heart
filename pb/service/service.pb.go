...
type ClientCommandsClient interface {
	...
	FileListOffloadAll(ctx context.Context, in *pb.RpcFileListOffloadRequest, opts ...grpc.CallOption) (*pb.RpcFileListOffloadResponse, error)
...
func (c *clientCommandsClient) FileListOffloadAll(ctx context.Context, in *pb.RpcFileListOffloadRequest, opts ...grpc.CallOption) (*pb.RpcFileListOffloadResponse, error) {
	out := new(pb.RpcFileListOffloadResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/FileListOffloadAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) FileListOffloadAll(req *pb.RpcFileListOffloadRequest) *pb.RpcFileListOffloadResponse {
	return nil
}
...
func _ClientCommands_FileListOffloadAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcFileListOffloadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).FileListOffloadAll(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/FileListOffloadAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).FileListOffloadAll(req.(*pb.RpcFileListOffloadRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FileListOffloadAll",
			Handler:    _ClientCommands_FileListOffloadAll_Handler,
		},
		{
