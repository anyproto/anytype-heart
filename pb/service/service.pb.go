...
type ClientCommandsClient interface {
	...
	AccountEventSubscriptionReady(ctx context.Context, in *pb.RpcAccountEventSubscriptionReadyRequest, opts ...grpc.CallOption) (*pb.RpcAccountEventSubscriptionReadyResponse, error)
	// Space
	// ***
...
func (c *clientCommandsClient) AccountEventSubscriptionReady(ctx context.Context, in *pb.RpcAccountEventSubscriptionReadyRequest, opts ...grpc.CallOption) (*pb.RpcAccountEventSubscriptionReadyResponse, error) {
	out := new(pb.RpcAccountEventSubscriptionReadyResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/AccountEventSubscriptionReady", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) AccountEventSubscriptionReady(ctx context.Context, req *pb.RpcAccountEventSubscriptionReadyRequest) *pb.RpcAccountEventSubscriptionReadyResponse {
	return nil
}
...
func _ClientCommands_AccountEventSubscriptionReady_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcAccountEventSubscriptionReadyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).AccountEventSubscriptionReady(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/AccountEventSubscriptionReady",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).AccountEventSubscriptionReady(ctx, req.(*pb.RpcAccountEventSubscriptionReadyRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AccountEventSubscriptionReady",
			Handler:    _ClientCommands_AccountEventSubscriptionReady_Handler,
		},
		{
