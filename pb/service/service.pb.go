...
type ClientCommandsClient interface {
	...
	BlockDataviewObjectsOrderUpdate(ctx context.Context, in *pb.RpcBlockDataviewObjectsOrderUpdateRequest, opts ...grpc.CallOption) (*pb.RpcBlockDataviewObjectsOrderUpdateResponse, error)
...
func (c *clientCommandsClient) BlockDataviewObjectsOrderUpdate(ctx context.Context, in *pb.RpcBlockDataviewObjectsOrderUpdateRequest, opts ...grpc.CallOption) (*pb.RpcBlockDataviewObjectsOrderUpdateResponse, error) {
	out := new(pb.RpcBlockDataviewObjectsOrderUpdateResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/BlockDataviewObjectsOrderUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) BlockDataviewObjectsOrderUpdate(req *pb.RpcBlockDataviewObjectsOrderUpdateRequest) *pb.RpcBlockDataviewObjectsOrderUpdateResponse {
	return nil
}
...
func _ClientCommands_BlockDataviewObjectsOrderUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcBlockDataviewObjectsOrderUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).BlockDataviewObjectsOrderUpdate(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/BlockDataviewObjectsOrderUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).BlockDataviewObjectsOrderUpdate(req.(*pb.RpcBlockDataviewObjectsOrderUpdateRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BlockDataviewObjectsOrderUpdate",
			Handler:    _ClientCommands_BlockDataviewObjectsOrderUpdate_Handler,
		},
		{
