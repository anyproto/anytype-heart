...
type ClientCommandsClient interface {
	...
	DebugSystem(ctx context.Context, in *pb.RpcDebugSystemRequest, opts ...grpc.CallOption) (*pb.RpcDebugSystemResponse, error)
...
func (c *clientCommandsClient) DebugSystem(ctx context.Context, in *pb.RpcDebugSystemRequest, opts ...grpc.CallOption) (*pb.RpcDebugSystemResponse, error) {
	out := new(pb.RpcDebugSystemResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/DebugSystem", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) DebugSystem(ctx context.Context, req *pb.RpcDebugSystemRequest) *pb.RpcDebugSystemResponse {
	return nil
}
...
func _ClientCommands_DebugSystem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcDebugSystemRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).DebugSystem(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/DebugSystem",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).DebugSystem(ctx, req.(*pb.RpcDebugSystemRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DebugSystem",
			Handler:    _ClientCommands_DebugSystem_Handler,
		},
		{
