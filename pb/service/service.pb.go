...
type ClientCommandsClient interface {
	...
	FileOffload(ctx context.Context, in *pb.RpcIpfsFileOffloadRequest, opts ...grpc.CallOption) (*pb.RpcIpfsFileOffloadResponse, error)
	FilesOffloadAll(ctx context.Context, in *pb.RpcIpfsFileOffloadAllRequest, opts ...grpc.CallOption) (*pb.RpcIpfsFileOffloadAllResponse, error)
...
func (c *clientCommandsClient) FileOffload(ctx context.Context, in *pb.RpcIpfsFileOffloadRequest, opts ...grpc.CallOption) (*pb.RpcIpfsFileOffloadResponse, error) {
	out := new(pb.RpcIpfsFileOffloadResponse)
...
func (c *clientCommandsClient) FilesOffloadAll(ctx context.Context, in *pb.RpcIpfsFileOffloadAllRequest, opts ...grpc.CallOption) (*pb.RpcIpfsFileOffloadAllResponse, error) {
	out := new(pb.RpcIpfsFileOffloadAllResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/FilesOffloadAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) FileOffload(req *pb.RpcIpfsFileOffloadRequest) *pb.RpcIpfsFileOffloadResponse {
	return nil
}
func (*UnimplementedClientCommandsServer) FilesOffloadAll(req *pb.RpcIpfsFileOffloadAllRequest) *pb.RpcIpfsFileOffloadAllResponse {
	return nil
}
...
func _ClientCommands_FileOffload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).FileOffload(req.(*pb.RpcIpfsFileOffloadRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}

func _ClientCommands_FilesOffloadAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcIpfsFileOffloadAllRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).FilesOffloadAll(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/FilesOffloadAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).FilesOffloadAll(req.(*pb.RpcIpfsFileOffloadAllRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FilesOffloadAll",
			Handler:    _ClientCommands_FilesOffloadAll_Handler,
		},
		{
