...
type ClientCommandsClient interface {
	...
	ValidateNotionToken(ctx context.Context, in *pb.RpcObjectImportNotionTokenValidateRequest, opts ...grpc.CallOption) (*pb.RpcObjectImportNotionTokenValidateResponse, error)
	// Relations
	// ***
...
func (c *clientCommandsClient) ValidateNotionToken(ctx context.Context, in *pb.RpcObjectImportNotionTokenValidateRequest, opts ...grpc.CallOption) (*pb.RpcObjectImportNotionTokenValidateResponse, error) {
	out := new(pb.RpcObjectImportNotionTokenValidateResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ValidateNotionToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ValidateNotionToken(ctx context.Context, req *pb.RpcObjectImportNotionTokenValidateRequest) *pb.RpcObjectImportNotionTokenValidateResponse {
	return nil
}
...
func _ClientCommands_ValidateNotionToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcObjectImportNotionTokenValidateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ValidateNotionToken(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ValidateNotionToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ValidateNotionToken(ctx, req.(*pb.RpcObjectImportNotionTokenValidateRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ValidateNotionToken",
			Handler:    _ClientCommands_ValidateNotionToken_Handler,
		},
		{
