...
type ClientCommandsClient interface {
	...
	BlockDataviewFilterUpdate(ctx context.Context, in *pb.RpcBlockDataviewFilterUpdateRequest, opts ...grpc.CallOption) (*pb.RpcBlockDataviewFilterUpdateResponse, error)
...
func (c *clientCommandsClient) BlockDataviewFilterUpdate(ctx context.Context, in *pb.RpcBlockDataviewFilterUpdateRequest, opts ...grpc.CallOption) (*pb.RpcBlockDataviewFilterUpdateResponse, error) {
	out := new(pb.RpcBlockDataviewFilterUpdateResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/BlockDataviewFilterUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) BlockDataviewFilterUpdate(ctx context.Context, req *pb.RpcBlockDataviewFilterUpdateRequest) *pb.RpcBlockDataviewFilterUpdateResponse {
	return nil
}
...
func _ClientCommands_BlockDataviewFilterUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcBlockDataviewFilterUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).BlockDataviewFilterUpdate(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/BlockDataviewFilterUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).BlockDataviewFilterUpdate(ctx, req.(*pb.RpcBlockDataviewFilterUpdateRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BlockDataviewFilterUpdate",
			Handler:    _ClientCommands_BlockDataviewFilterUpdate_Handler,
		},
		{
