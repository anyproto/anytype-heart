...
type ClientCommandsClient interface {
	...
	ObjectChatCreate(ctx context.Context, in *pb.RpcObjectChatCreateRequest, opts ...grpc.CallOption) (*pb.RpcObjectChatCreateResponse, error)
...
func (c *clientCommandsClient) ObjectChatCreate(ctx context.Context, in *pb.RpcObjectChatCreateRequest, opts ...grpc.CallOption) (*pb.RpcObjectChatCreateResponse, error) {
	out := new(pb.RpcObjectChatCreateResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ObjectChatCreate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ObjectChatCreate(ctx context.Context, req *pb.RpcObjectChatCreateRequest) *pb.RpcObjectChatCreateResponse {
	return nil
}
...
func _ClientCommands_ObjectChatCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcObjectChatCreateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ObjectChatCreate(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ObjectChatCreate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ObjectChatCreate(ctx, req.(*pb.RpcObjectChatCreateRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ObjectChatCreate",
			Handler:    _ClientCommands_ObjectChatCreate_Handler,
		},
		{
