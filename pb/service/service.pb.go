...
type ClientCommandsClient interface {
	...
	RelationOptionUnsetOrder(ctx context.Context, in *pb.RpcRelationOptionUnsetOrderRequest, opts ...grpc.CallOption) (*pb.RpcRelationOptionUnsetOrderResponse, error)
...
func (c *clientCommandsClient) RelationOptionUnsetOrder(ctx context.Context, in *pb.RpcRelationOptionUnsetOrderRequest, opts ...grpc.CallOption) (*pb.RpcRelationOptionUnsetOrderResponse, error) {
	out := new(pb.RpcRelationOptionUnsetOrderResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/RelationOptionUnsetOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) RelationOptionUnsetOrder(ctx context.Context, req *pb.RpcRelationOptionUnsetOrderRequest) *pb.RpcRelationOptionUnsetOrderResponse {
	return nil
}
...
func _ClientCommands_RelationOptionUnsetOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcRelationOptionUnsetOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).RelationOptionUnsetOrder(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/RelationOptionUnsetOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).RelationOptionUnsetOrder(ctx, req.(*pb.RpcRelationOptionUnsetOrderRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RelationOptionUnsetOrder",
			Handler:    _ClientCommands_RelationOptionUnsetOrder_Handler,
		},
		{
