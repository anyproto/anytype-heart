...
type ClientCommandsClient interface {
	...
	ChatReadMessages(ctx context.Context, in *pb.RpcChatReadRequest, opts ...grpc.CallOption) (*pb.RpcChatReadResponse, error)
...
func (c *clientCommandsClient) ChatReadMessages(ctx context.Context, in *pb.RpcChatReadRequest, opts ...grpc.CallOption) (*pb.RpcChatReadResponse, error) {
	out := new(pb.RpcChatReadResponse)
...
func (*UnimplementedClientCommandsServer) ChatReadMessages(ctx context.Context, req *pb.RpcChatReadRequest) *pb.RpcChatReadResponse {
	return nil
}
...
func _ClientCommands_ChatReadMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ChatReadMessages(ctx, req.(*pb.RpcChatReadRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
