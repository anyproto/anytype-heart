...
type ClientCommandsClient interface {
	...
	FileGetSpaceQuota(ctx context.Context, in *pb.RpcFileGetSpaceQuotaRequest, opts ...grpc.CallOption) (*pb.RpcFileGetSpaceQuotaResponse, error)
...
func (c *clientCommandsClient) FileGetSpaceQuota(ctx context.Context, in *pb.RpcFileGetSpaceQuotaRequest, opts ...grpc.CallOption) (*pb.RpcFileGetSpaceQuotaResponse, error) {
	out := new(pb.RpcFileGetSpaceQuotaResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/FileGetSpaceQuota", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) FileGetSpaceQuota(ctx context.Context, req *pb.RpcFileGetSpaceQuotaRequest) *pb.RpcFileGetSpaceQuotaResponse {
	return nil
}
...
func _ClientCommands_FileGetSpaceQuota_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcFileGetSpaceQuotaRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).FileGetSpaceQuota(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/FileGetSpaceQuota",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).FileGetSpaceQuota(ctx, req.(*pb.RpcFileGetSpaceQuotaRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FileGetSpaceQuota",
			Handler:    _ClientCommands_FileGetSpaceQuota_Handler,
		},
		{
