...
type ClientCommandsClient interface {
	...
	ChatEditMessage(ctx context.Context, in *pb.RpcChatEditMessageRequest, opts ...grpc.CallOption) (*pb.RpcChatEditMessageResponse, error)
...
func (c *clientCommandsClient) ChatEditMessage(ctx context.Context, in *pb.RpcChatEditMessageRequest, opts ...grpc.CallOption) (*pb.RpcChatEditMessageResponse, error) {
	out := new(pb.RpcChatEditMessageResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ChatEditMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ChatEditMessage(ctx context.Context, req *pb.RpcChatEditMessageRequest) *pb.RpcChatEditMessageResponse {
	return nil
}
...
func _ClientCommands_ChatEditMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcChatEditMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ChatEditMessage(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ChatEditMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ChatEditMessage(ctx, req.(*pb.RpcChatEditMessageRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChatEditMessage",
			Handler:    _ClientCommands_ChatEditMessage_Handler,
		},
		{
