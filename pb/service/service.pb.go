...
type ClientCommandsClient interface {
	...
	ChatGetMessage(ctx context.Context, in *pb.RpcChatGetMessageRequest, opts ...grpc.CallOption) (*pb.RpcChatGetMessageResponse, error)
...
func (c *clientCommandsClient) ChatGetMessage(ctx context.Context, in *pb.RpcChatGetMessageRequest, opts ...grpc.CallOption) (*pb.RpcChatGetMessageResponse, error) {
	out := new(pb.RpcChatGetMessageResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ChatGetMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ChatGetMessage(ctx context.Context, req *pb.RpcChatGetMessageRequest) *pb.RpcChatGetMessageResponse {
	return nil
}
...
func _ClientCommands_ChatGetMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcChatGetMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ChatGetMessage(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ChatGetMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ChatGetMessage(ctx, req.(*pb.RpcChatGetMessageRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChatGetMessage",
			Handler:    _ClientCommands_ChatGetMessage_Handler,
		},
		{
