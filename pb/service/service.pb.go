...
type ClientCommandsClient interface {
	...
	WorkspaceSetTitleObject(ctx context.Context, in *pb.RpcWorkspaceSetTitleObjectRequest, opts ...grpc.CallOption) (*pb.RpcWorkspaceSetTitleObjectResponse, error)
...
func (c *clientCommandsClient) WorkspaceSetTitleObject(ctx context.Context, in *pb.RpcWorkspaceSetTitleObjectRequest, opts ...grpc.CallOption) (*pb.RpcWorkspaceSetTitleObjectResponse, error) {
	out := new(pb.RpcWorkspaceSetTitleObjectResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/WorkspaceSetTitleObject", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) WorkspaceSetTitleObject(req *pb.RpcWorkspaceSetTitleObjectRequest) *pb.RpcWorkspaceSetTitleObjectResponse {
	return nil
}
...
func _ClientCommands_WorkspaceSetTitleObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcWorkspaceSetTitleObjectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).WorkspaceSetTitleObject(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/WorkspaceSetTitleObject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).WorkspaceSetTitleObject(req.(*pb.RpcWorkspaceSetTitleObjectRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WorkspaceSetTitleObject",
			Handler:    _ClientCommands_WorkspaceSetTitleObject_Handler,
		},
		{
