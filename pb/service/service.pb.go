...
type ClientCommandsClient interface {
	...
	RelationList(ctx context.Context, in *pb.RpcRelationListRequest, opts ...grpc.CallOption) (*pb.RpcRelationListResponse, error)
	RelationAdd(ctx context.Context, in *pb.RpcRelationAddRequest, opts ...grpc.CallOption) (*pb.RpcRelationAddResponse, error)
...
func (c *clientCommandsClient) RelationList(ctx context.Context, in *pb.RpcRelationListRequest, opts ...grpc.CallOption) (*pb.RpcRelationListResponse, error) {
	out := new(pb.RpcRelationListResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/RelationList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientCommandsClient) RelationAdd(ctx context.Context, in *pb.RpcRelationAddRequest, opts ...grpc.CallOption) (*pb.RpcRelationAddResponse, error) {
	out := new(pb.RpcRelationAddResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/RelationAdd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) RelationList(req *pb.RpcRelationListRequest) *pb.RpcRelationListResponse {
	return nil
}
func (*UnimplementedClientCommandsServer) RelationAdd(req *pb.RpcRelationAddRequest) *pb.RpcRelationAddResponse {
	return nil
}
...
func _ClientCommands_RelationList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcRelationListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).RelationList(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/RelationList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).RelationList(req.(*pb.RpcRelationListRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}

func _ClientCommands_RelationAdd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcRelationAddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).RelationAdd(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/RelationAdd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).RelationAdd(req.(*pb.RpcRelationAddRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RelationList",
			Handler:    _ClientCommands_RelationList_Handler,
		},
		{
			MethodName: "RelationAdd",
			Handler:    _ClientCommands_RelationAdd_Handler,
		},
		{
			MethodName: "Ping",
