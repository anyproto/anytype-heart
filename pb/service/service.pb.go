...
type ClientCommandsClient interface {
	...
	DebugNetwork(ctx context.Context, in *pb.RpcDebugNetworkRequest, opts ...grpc.CallOption) (*pb.RpcDebugNetworkResponse, error)
...
func (c *clientCommandsClient) DebugNetwork(ctx context.Context, in *pb.RpcDebugNetworkRequest, opts ...grpc.CallOption) (*pb.RpcDebugNetworkResponse, error) {
	out := new(pb.RpcDebugNetworkResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/DebugNetwork", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) DebugNetwork(ctx context.Context, req *pb.RpcDebugNetworkRequest) *pb.RpcDebugNetworkResponse {
	return nil
}
...
func _ClientCommands_DebugNetwork_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcDebugNetworkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).DebugNetwork(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/DebugNetwork",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).DebugNetwork(ctx, req.(*pb.RpcDebugNetworkRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DebugNetwork",
			Handler:    _ClientCommands_DebugNetwork_Handler,
		},
		{
