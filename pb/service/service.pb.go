...
type ClientCommandsClient interface {
	...
	// Relations
	// ***
	RelationCreate(ctx context.Context, in *pb.RpcRelationCreateRequest, opts ...grpc.CallOption) (*pb.RpcRelationCreateResponse, error)
	RelationCreateOption(ctx context.Context, in *pb.RpcRelationCreateOptionRequest, opts ...grpc.CallOption) (*pb.RpcRelationCreateOptionResponse, error)
...
func (c *clientCommandsClient) RelationCreate(ctx context.Context, in *pb.RpcRelationCreateRequest, opts ...grpc.CallOption) (*pb.RpcRelationCreateResponse, error) {
	out := new(pb.RpcRelationCreateResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/RelationCreate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientCommandsClient) RelationCreateOption(ctx context.Context, in *pb.RpcRelationCreateOptionRequest, opts ...grpc.CallOption) (*pb.RpcRelationCreateOptionResponse, error) {
	out := new(pb.RpcRelationCreateOptionResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/RelationCreateOption", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ClientCommands_RelationCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
func _ClientCommands_RelationCreateOption_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ClientCommands_RelationCreate_Handler,
		},
		{
			MethodName: "RelationCreateOption",
			Handler:    _ClientCommands_RelationCreateOption_Handler,
		},
		{
