...
type ClientCommandsClient interface {
	...
	DebugLoginTrace(ctx context.Context, in *pb.RpcDebugLoginTraceRequest, opts ...grpc.CallOption) (*pb.RpcDebugLoginTraceResponse, error)
...
func (c *clientCommandsClient) DebugLoginTrace(ctx context.Context, in *pb.RpcDebugLoginTraceRequest, opts ...grpc.CallOption) (*pb.RpcDebugLoginTraceResponse, error) {
	out := new(pb.RpcDebugLoginTraceResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/DebugLoginTrace", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) DebugLoginTrace(ctx context.Context, req *pb.RpcDebugLoginTraceRequest) *pb.RpcDebugLoginTraceResponse {
	return nil
}
...
func _ClientCommands_DebugLoginTrace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcDebugLoginTraceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).DebugLoginTrace(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/DebugLoginTrace",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).DebugLoginTrace(ctx, req.(*pb.RpcDebugLoginTraceRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DebugLoginTrace",
			Handler:    _ClientCommands_DebugLoginTrace_Handler,
		},
		{
