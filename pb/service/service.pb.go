...
type ClientCommandsClient interface {
	...
	StoreCartCheckout(ctx context.Context, in *pb.RpcStoreCartCheckoutRequest, opts ...grpc.CallOption) (*pb.RpcStoreCartCheckoutResponse, error)
	// MembershipV2
...
func (c *clientCommandsClient) StoreCartCheckout(ctx context.Context, in *pb.RpcStoreCartCheckoutRequest, opts ...grpc.CallOption) (*pb.RpcStoreCartCheckoutResponse, error) {
	out := new(pb.RpcStoreCartCheckoutResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/StoreCartCheckout", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) StoreCartCheckout(ctx context.Context, req *pb.RpcStoreCartCheckoutRequest) *pb.RpcStoreCartCheckoutResponse {
	return nil
}
...
func _ClientCommands_StoreCartCheckout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcStoreCartCheckoutRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).StoreCartCheckout(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/StoreCartCheckout",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).StoreCartCheckout(ctx, req.(*pb.RpcStoreCartCheckoutRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "StoreCartCheckout",
			Handler:    _ClientCommands_StoreCartCheckout_Handler,
		},
		{
