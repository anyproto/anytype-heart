...
type ClientCommandsClient interface {
	...
	SpaceOffload(ctx context.Context, in *pb.RpcSpaceOffloadRequest, opts ...grpc.CallOption) (*pb.RpcSpaceOffloadResponse, error)
	SpaceDownload(ctx context.Context, in *pb.RpcSpaceDownloadRequest, opts ...grpc.CallOption) (*pb.RpcSpaceDownloadResponse, error)
	// Object
	// ***
...
func (c *clientCommandsClient) SpaceOffload(ctx context.Context, in *pb.RpcSpaceOffloadRequest, opts ...grpc.CallOption) (*pb.RpcSpaceOffloadResponse, error) {
	out := new(pb.RpcSpaceOffloadResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/SpaceOffload", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientCommandsClient) SpaceDownload(ctx context.Context, in *pb.RpcSpaceDownloadRequest, opts ...grpc.CallOption) (*pb.RpcSpaceDownloadResponse, error) {
	out := new(pb.RpcSpaceDownloadResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/SpaceDownload", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) SpaceOffload(ctx context.Context, req *pb.RpcSpaceOffloadRequest) *pb.RpcSpaceOffloadResponse {
	return nil
}
func (*UnimplementedClientCommandsServer) SpaceDownload(ctx context.Context, req *pb.RpcSpaceDownloadRequest) *pb.RpcSpaceDownloadResponse {
	return nil
}
...
func _ClientCommands_SpaceOffload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcSpaceOffloadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).SpaceOffload(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/SpaceOffload",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).SpaceOffload(ctx, req.(*pb.RpcSpaceOffloadRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}

func _ClientCommands_SpaceDownload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcSpaceDownloadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).SpaceDownload(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/SpaceDownload",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).SpaceDownload(ctx, req.(*pb.RpcSpaceDownloadRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SpaceOffload",
			Handler:    _ClientCommands_SpaceOffload_Handler,
		},
		{
			MethodName: "SpaceDownload",
			Handler:    _ClientCommands_SpaceDownload_Handler,
		},
		{
