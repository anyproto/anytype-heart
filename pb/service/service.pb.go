...
type ClientCommandsClient interface {
	...
	SpaceMakeShared(ctx context.Context, in *pb.RpcSpaceMakeSharedRequest, opts ...grpc.CallOption) (*pb.RpcSpaceMakeSharedResponse, error)
...
func (c *clientCommandsClient) SpaceMakeShared(ctx context.Context, in *pb.RpcSpaceMakeSharedRequest, opts ...grpc.CallOption) (*pb.RpcSpaceMakeSharedResponse, error) {
	out := new(pb.RpcSpaceMakeSharedResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/SpaceMakeShared", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) SpaceMakeShared(ctx context.Context, req *pb.RpcSpaceMakeSharedRequest) *pb.RpcSpaceMakeSharedResponse {
	return nil
}
...
func _ClientCommands_SpaceMakeShared_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcSpaceMakeSharedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).SpaceMakeShared(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/SpaceMakeShared",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).SpaceMakeShared(ctx, req.(*pb.RpcSpaceMakeSharedRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SpaceMakeShared",
			Handler:    _ClientCommands_SpaceMakeShared_Handler,
		},
		{
