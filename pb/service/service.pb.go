...
type ClientCommandsClient interface {
	...
	DebugObjectsEvents(ctx context.Context, in *pb.RpcDebugObjectsEventRequest, opts ...grpc.CallOption) (*pb.RpcDebugObjectsEventResponse, error)
...
func (c *clientCommandsClient) DebugObjectsEvents(ctx context.Context, in *pb.RpcDebugObjectsEventRequest, opts ...grpc.CallOption) (*pb.RpcDebugObjectsEventResponse, error) {
	out := new(pb.RpcDebugObjectsEventResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/DebugObjectsEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) DebugObjectsEvents(ctx context.Context, req *pb.RpcDebugObjectsEventRequest) *pb.RpcDebugObjectsEventResponse {
	return nil
}
...
func _ClientCommands_DebugObjectsEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcDebugObjectsEventRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).DebugObjectsEvents(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/DebugObjectsEvents",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).DebugObjectsEvents(ctx, req.(*pb.RpcDebugObjectsEventRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DebugObjectsEvents",
			Handler:    _ClientCommands_DebugObjectsEvents_Handler,
		},
		{
