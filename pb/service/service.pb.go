...
type ClientCommandsClient interface {
	...
	DebugChatChanges(ctx context.Context, in *pb.RpcDebugChatChangesRequest, opts ...grpc.CallOption) (*pb.RpcDebugChatChangesResponse, error)
...
func (c *clientCommandsClient) DebugChatChanges(ctx context.Context, in *pb.RpcDebugChatChangesRequest, opts ...grpc.CallOption) (*pb.RpcDebugChatChangesResponse, error) {
	out := new(pb.RpcDebugChatChangesResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/DebugChatChanges", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) DebugChatChanges(ctx context.Context, req *pb.RpcDebugChatChangesRequest) *pb.RpcDebugChatChangesResponse {
	return nil
}
...
func _ClientCommands_DebugChatChanges_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcDebugChatChangesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).DebugChatChanges(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/DebugChatChanges",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).DebugChatChanges(ctx, req.(*pb.RpcDebugChatChangesRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DebugChatChanges",
			Handler:    _ClientCommands_DebugChatChanges_Handler,
		},
		{
