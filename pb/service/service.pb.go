...
type ClientCommandsClient interface {
	...
	BlockListSetLayout(ctx context.Context, in *pb.RpcBlockListSetLayoutRequest, opts ...grpc.CallOption) (*pb.RpcBlockListSetLayoutResponse, error)
...
func (c *clientCommandsClient) BlockListSetLayout(ctx context.Context, in *pb.RpcBlockListSetLayoutRequest, opts ...grpc.CallOption) (*pb.RpcBlockListSetLayoutResponse, error) {
	out := new(pb.RpcBlockListSetLayoutResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/BlockListSetLayout", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) BlockListSetLayout(req *pb.RpcBlockListSetLayoutRequest) *pb.RpcBlockListSetLayoutResponse {
	return nil
}
...
func _ClientCommands_BlockListSetLayout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcBlockListSetLayoutRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).BlockListSetLayout(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/BlockListSetLayout",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).BlockListSetLayout(req.(*pb.RpcBlockListSetLayoutRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BlockListSetLayout",
			Handler:    _ClientCommands_BlockListSetLayout_Handler,
		},
		{
