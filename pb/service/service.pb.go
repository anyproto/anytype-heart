...
type ClientCommandsClient interface {
	...
	SpaceRequestJoin(ctx context.Context, in *pb.RpcSpaceRequestJoinRequest, opts ...grpc.CallOption) (*pb.RpcSpaceRequestJoinResponse, error)
...
func (c *clientCommandsClient) SpaceRequestJoin(ctx context.Context, in *pb.RpcSpaceRequestJoinRequest, opts ...grpc.CallOption) (*pb.RpcSpaceRequestJoinResponse, error) {
	out := new(pb.RpcSpaceRequestJoinResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/SpaceRequestJoin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) SpaceRequestJoin(ctx context.Context, req *pb.RpcSpaceRequestJoinRequest) *pb.RpcSpaceRequestJoinResponse {
	return nil
}
...
func _ClientCommands_SpaceRequestJoin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcSpaceRequestJoinRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).SpaceRequestJoin(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/SpaceRequestJoin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).SpaceRequestJoin(ctx, req.(*pb.RpcSpaceRequestJoinRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SpaceRequestJoin",
			Handler:    _ClientCommands_SpaceRequestJoin_Handler,
		},
		{
