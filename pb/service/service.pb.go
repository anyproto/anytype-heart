...
type ClientCommandsClient interface {
	...
	SpaceInitChat(ctx context.Context, in *pb.RpcSpaceInitChatRequest, opts ...grpc.CallOption) (*pb.RpcSpaceInitChatResponse, error)
...
func (c *clientCommandsClient) SpaceInitChat(ctx context.Context, in *pb.RpcSpaceInitChatRequest, opts ...grpc.CallOption) (*pb.RpcSpaceInitChatResponse, error) {
	out := new(pb.RpcSpaceInitChatResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/SpaceInitChat", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) SpaceInitChat(ctx context.Context, req *pb.RpcSpaceInitChatRequest) *pb.RpcSpaceInitChatResponse {
	return nil
}
...
func _ClientCommands_SpaceInitChat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcSpaceInitChatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).SpaceInitChat(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/SpaceInitChat",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).SpaceInitChat(ctx, req.(*pb.RpcSpaceInitChatRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SpaceInitChat",
			Handler:    _ClientCommands_SpaceInitChat_Handler,
		},
		{
