...
type ClientCommandsClient interface {
	...
	ObjectSetDashboard(ctx context.Context, in *pb.RpcObjectSetDashboardRequest, opts ...grpc.CallOption) (*pb.RpcObjectSetDashboardResponse, error)
...
func (c *clientCommandsClient) ObjectSetDashboard(ctx context.Context, in *pb.RpcObjectSetDashboardRequest, opts ...grpc.CallOption) (*pb.RpcObjectSetDashboardResponse, error) {
	out := new(pb.RpcObjectSetDashboardResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ObjectSetDashboard", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ObjectSetDashboard(ctx context.Context, req *pb.RpcObjectSetDashboardRequest) *pb.RpcObjectSetDashboardResponse {
	return nil
}
...
func _ClientCommands_ObjectSetDashboard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcObjectSetDashboardRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ObjectSetDashboard(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ObjectSetDashboard",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ObjectSetDashboard(ctx, req.(*pb.RpcObjectSetDashboardRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ObjectSetDashboard",
			Handler:    _ClientCommands_ObjectSetDashboard_Handler,
		},
		{
