...
type ClientCommandsClient interface {
	...
	ContactCreate(ctx context.Context, in *pb.RpcContactCreateRequest, opts ...grpc.CallOption) (*pb.RpcContactCreateResponse, error)
	ContactDelete(ctx context.Context, in *pb.RpcContactDeleteRequest, opts ...grpc.CallOption) (*pb.RpcContactDeleteResponse, error)
}
...
func (c *clientCommandsClient) ContactCreate(ctx context.Context, in *pb.RpcContactCreateRequest, opts ...grpc.CallOption) (*pb.RpcContactCreateResponse, error) {
	out := new(pb.RpcContactCreateResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ContactCreate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientCommandsClient) ContactDelete(ctx context.Context, in *pb.RpcContactDeleteRequest, opts ...grpc.CallOption) (*pb.RpcContactDeleteResponse, error) {
	out := new(pb.RpcContactDeleteResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ContactDelete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ContactCreate(ctx context.Context, req *pb.RpcContactCreateRequest) *pb.RpcContactCreateResponse {
	return nil
}
func (*UnimplementedClientCommandsServer) ContactDelete(ctx context.Context, req *pb.RpcContactDeleteRequest) *pb.RpcContactDeleteResponse {
	return nil
}
...
func _ClientCommands_ContactCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcContactCreateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ContactCreate(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ContactCreate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ContactCreate(ctx, req.(*pb.RpcContactCreateRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}

func _ClientCommands_ContactDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcContactDeleteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ContactDelete(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ContactDelete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ContactDelete(ctx, req.(*pb.RpcContactDeleteRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ClientCommands_ContactCreate_Handler,
		},
		{
			MethodName: "ContactDelete",
			Handler:    _ClientCommands_ContactDelete_Handler,
		},
	},
