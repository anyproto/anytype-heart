...
type ClientCommandsClient interface {
	...
	// API
	// ***
	ApiStartServer(ctx context.Context, in *pb.RpcApiStartServerRequest, opts ...grpc.CallOption) (*pb.RpcApiStartServerResponse, error)
	ApiStopServer(ctx context.Context, in *pb.RpcApiStopServerRequest, opts ...grpc.CallOption) (*pb.RpcApiStopServerResponse, error)
}
...
func (c *clientCommandsClient) ApiStartServer(ctx context.Context, in *pb.RpcApiStartServerRequest, opts ...grpc.CallOption) (*pb.RpcApiStartServerResponse, error) {
	out := new(pb.RpcApiStartServerResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ApiStartServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientCommandsClient) ApiStopServer(ctx context.Context, in *pb.RpcApiStopServerRequest, opts ...grpc.CallOption) (*pb.RpcApiStopServerResponse, error) {
	out := new(pb.RpcApiStopServerResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ApiStopServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ApiStartServer(ctx context.Context, req *pb.RpcApiStartServerRequest) *pb.RpcApiStartServerResponse {
	return nil
}
func (*UnimplementedClientCommandsServer) ApiStopServer(ctx context.Context, req *pb.RpcApiStopServerRequest) *pb.RpcApiStopServerResponse {
	return nil
}
...
func _ClientCommands_ApiStartServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcApiStartServerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ApiStartServer(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ApiStartServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ApiStartServer(ctx, req.(*pb.RpcApiStartServerRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}

func _ClientCommands_ApiStopServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcApiStopServerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ApiStopServer(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ApiStopServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ApiStopServer(ctx, req.(*pb.RpcApiStopServerRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ApiStartServer",
			Handler:    _ClientCommands_ApiStartServer_Handler,
		},
		{
			MethodName: "ApiStopServer",
			Handler:    _ClientCommands_ApiStopServer_Handler,
		},
	},
