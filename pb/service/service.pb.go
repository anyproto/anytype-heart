...
type ClientCommandsClient interface {
	...
	NotificationReply(ctx context.Context, in *pb.RpcNotificationReplyResponse, opts ...grpc.CallOption) (*pb.RpcNotificationReplyResponse, error)
}
...
func (c *clientCommandsClient) NotificationReply(ctx context.Context, in *pb.RpcNotificationReplyResponse, opts ...grpc.CallOption) (*pb.RpcNotificationReplyResponse, error) {
...
func (*UnimplementedClientCommandsServer) NotificationReply(ctx context.Context, req *pb.RpcNotificationReplyResponse) *pb.RpcNotificationReplyResponse {
	return nil
}
...
func _ClientCommands_NotificationReply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).NotificationReply(ctx, req.(*pb.RpcNotificationReplyResponse)), nil
	}
	return interceptor(ctx, in, info, handler)
}
