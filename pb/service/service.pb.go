...
type ClientCommandsClient interface {
	...
	ObjectTypeSetStrictInheritance(ctx context.Context, in *pb.RpcObjectTypeSetStrictInheritanceRequest, opts ...grpc.CallOption) (*pb.RpcObjectTypeSetStrictInheritanceResponse, error)
...
func (c *clientCommandsClient) ObjectTypeSetStrictInheritance(ctx context.Context, in *pb.RpcObjectTypeSetStrictInheritanceRequest, opts ...grpc.CallOption) (*pb.RpcObjectTypeSetStrictInheritanceResponse, error) {
	out := new(pb.RpcObjectTypeSetStrictInheritanceResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ObjectTypeSetStrictInheritance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ObjectTypeSetStrictInheritance(ctx context.Context, req *pb.RpcObjectTypeSetStrictInheritanceRequest) *pb.RpcObjectTypeSetStrictInheritanceResponse {
	return nil
}
...
func _ClientCommands_ObjectTypeSetStrictInheritance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcObjectTypeSetStrictInheritanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ObjectTypeSetStrictInheritance(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ObjectTypeSetStrictInheritance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ObjectTypeSetStrictInheritance(ctx, req.(*pb.RpcObjectTypeSetStrictInheritanceRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ObjectTypeSetStrictInheritance",
			Handler:    _ClientCommands_ObjectTypeSetStrictInheritance_Handler,
		},
		{
