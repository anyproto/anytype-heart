...
type ClientCommandsClient interface {
	...
	WorkspaceReinit(ctx context.Context, in *pb.RpcWorkspaceReinitRequest, opts ...grpc.CallOption) (*pb.RpcWorkspaceReinitResponse, error)
	// Account
	// ***
...
func (c *clientCommandsClient) WorkspaceReinit(ctx context.Context, in *pb.RpcWorkspaceReinitRequest, opts ...grpc.CallOption) (*pb.RpcWorkspaceReinitResponse, error) {
	out := new(pb.RpcWorkspaceReinitResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/WorkspaceReinit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) WorkspaceReinit(ctx context.Context, req *pb.RpcWorkspaceReinitRequest) *pb.RpcWorkspaceReinitResponse {
	return nil
}
...
func _ClientCommands_WorkspaceReinit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcWorkspaceReinitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).WorkspaceReinit(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/WorkspaceReinit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).WorkspaceReinit(ctx, req.(*pb.RpcWorkspaceReinitRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WorkspaceReinit",
			Handler:    _ClientCommands_WorkspaceReinit_Handler,
		},
		{
