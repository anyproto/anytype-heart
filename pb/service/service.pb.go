...
type ClientCommandsClient interface {
	...
	ChatPinMessages(ctx context.Context, in *pb.RpcChatPinMessagesRequest, opts ...grpc.CallOption) (*pb.RpcChatPinMessagesResponse, error)
	ChatUnpinMessages(ctx context.Context, in *pb.RpcChatUnpinMessagesRequest, opts ...grpc.CallOption) (*pb.RpcChatUnpinMessagesResponse, error)
...
func (c *clientCommandsClient) ChatPinMessages(ctx context.Context, in *pb.RpcChatPinMessagesRequest, opts ...grpc.CallOption) (*pb.RpcChatPinMessagesResponse, error) {
	out := new(pb.RpcChatPinMessagesResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ChatPinMessages", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientCommandsClient) ChatUnpinMessages(ctx context.Context, in *pb.RpcChatUnpinMessagesRequest, opts ...grpc.CallOption) (*pb.RpcChatUnpinMessagesResponse, error) {
	out := new(pb.RpcChatUnpinMessagesResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ChatUnpinMessages", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ChatPinMessages(ctx context.Context, req *pb.RpcChatPinMessagesRequest) *pb.RpcChatPinMessagesResponse {
	return nil
}
func (*UnimplementedClientCommandsServer) ChatUnpinMessages(ctx context.Context, req *pb.RpcChatUnpinMessagesRequest) *pb.RpcChatUnpinMessagesResponse {
	return nil
}
...
func _ClientCommands_ChatPinMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcChatPinMessagesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ChatPinMessages(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ChatPinMessages",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ChatPinMessages(ctx, req.(*pb.RpcChatPinMessagesRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}

func _ClientCommands_ChatUnpinMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcChatUnpinMessagesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ChatUnpinMessages(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ChatUnpinMessages",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ChatUnpinMessages(ctx, req.(*pb.RpcChatUnpinMessagesRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChatPinMessages",
			Handler:    _ClientCommands_ChatPinMessages_Handler,
		},
		{
			MethodName: "ChatUnpinMessages",
			Handler:    _ClientCommands_ChatUnpinMessages_Handler,
		},
		{
