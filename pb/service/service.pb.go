...
type ClientCommandsClient interface {
	...
	AccountExport(ctx context.Context, in *pb.RpcAccountExportRequest, opts ...grpc.CallOption) (*pb.RpcAccountExportResponse, error)
	// Object
	// ***
...
func (c *clientCommandsClient) AccountExport(ctx context.Context, in *pb.RpcAccountExportRequest, opts ...grpc.CallOption) (*pb.RpcAccountExportResponse, error) {
	out := new(pb.RpcAccountExportResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/AccountExport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) AccountExport(ctx context.Context, req *pb.RpcAccountExportRequest) *pb.RpcAccountExportResponse {
	return nil
}
...
func _ClientCommands_AccountExport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcAccountExportRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).AccountExport(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/AccountExport",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).AccountExport(ctx, req.(*pb.RpcAccountExportRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AccountExport",
			Handler:    _ClientCommands_AccountExport_Handler,
		},
		{
