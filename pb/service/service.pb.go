...
type ClientCommandsClient interface {
	...
	NameServiceReverseResolveName(ctx context.Context, in *pb.RpcNameServiceReverseResolveNameRequest, opts ...grpc.CallOption) (*pb.RpcNameServiceReverseResolveNameResponse, error)
...
func (c *clientCommandsClient) NameServiceReverseResolveName(ctx context.Context, in *pb.RpcNameServiceReverseResolveNameRequest, opts ...grpc.CallOption) (*pb.RpcNameServiceReverseResolveNameResponse, error) {
	out := new(pb.RpcNameServiceReverseResolveNameResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/NameServiceReverseResolveName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) NameServiceReverseResolveName(ctx context.Context, req *pb.RpcNameServiceReverseResolveNameRequest) *pb.RpcNameServiceReverseResolveNameResponse {
	return nil
}
...
func _ClientCommands_NameServiceReverseResolveName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcNameServiceReverseResolveNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).NameServiceReverseResolveName(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/NameServiceReverseResolveName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).NameServiceReverseResolveName(ctx, req.(*pb.RpcNameServiceReverseResolveNameRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NameServiceReverseResolveName",
			Handler:    _ClientCommands_NameServiceReverseResolveName_Handler,
		},
		{
