...
type ClientCommandsClient interface {
	...
	SnapshotOpen(ctx context.Context, in *pb.RpcSnapshotOpenRequest, opts ...grpc.CallOption) (*pb.RpcSnapshotOpenResponse, error)
}
...
func (c *clientCommandsClient) SnapshotOpen(ctx context.Context, in *pb.RpcSnapshotOpenRequest, opts ...grpc.CallOption) (*pb.RpcSnapshotOpenResponse, error) {
	out := new(pb.RpcSnapshotOpenResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/SnapshotOpen", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) SnapshotOpen(ctx context.Context, req *pb.RpcSnapshotOpenRequest) *pb.RpcSnapshotOpenResponse {
	return nil
}
...
func _ClientCommands_SnapshotOpen_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcSnapshotOpenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).SnapshotOpen(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/SnapshotOpen",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).SnapshotOpen(ctx, req.(*pb.RpcSnapshotOpenRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SnapshotOpen",
			Handler:    _ClientCommands_SnapshotOpen_Handler,
		},
	},
