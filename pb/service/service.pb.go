...
type ClientCommandsClient interface {
	...
	MembershipWebAuth(ctx context.Context, in *pb.RpcMembershipWebAuthRequest, opts ...grpc.CallOption) (*pb.RpcMembershipWebAuthResponse, error)
	// Name Service:
	// ***
	// hello.any -> data
...
func (c *clientCommandsClient) MembershipWebAuth(ctx context.Context, in *pb.RpcMembershipWebAuthRequest, opts ...grpc.CallOption) (*pb.RpcMembershipWebAuthResponse, error) {
	out := new(pb.RpcMembershipWebAuthResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/MembershipWebAuth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) MembershipWebAuth(ctx context.Context, req *pb.RpcMembershipWebAuthRequest) *pb.RpcMembershipWebAuthResponse {
	return nil
}
...
func _ClientCommands_MembershipWebAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcMembershipWebAuthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).MembershipWebAuth(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/MembershipWebAuth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).MembershipWebAuth(ctx, req.(*pb.RpcMembershipWebAuthRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MembershipWebAuth",
			Handler:    _ClientCommands_MembershipWebAuth_Handler,
		},
		{
