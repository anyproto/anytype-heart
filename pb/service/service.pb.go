...
type ClientCommandsClient interface {
	DeeplinkOpen(ctx context.Context, in *pb.RpcDeeplinkOpenRequest, opts ...grpc.CallOption) (*pb.RpcDeeplinkOpenResponse, error)
	DeeplinkCreateFromBlock(ctx context.Context, in *pb.RpcDeeplinkCreateFromBlockRequest, opts ...grpc.CallOption) (*pb.RpcDeeplinkCreateFromBlockResponse, error)
...
func (c *clientCommandsClient) DeeplinkOpen(ctx context.Context, in *pb.RpcDeeplinkOpenRequest, opts ...grpc.CallOption) (*pb.RpcDeeplinkOpenResponse, error) {
	out := new(pb.RpcDeeplinkOpenResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/DeeplinkOpen", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientCommandsClient) DeeplinkCreateFromBlock(ctx context.Context, in *pb.RpcDeeplinkCreateFromBlockRequest, opts ...grpc.CallOption) (*pb.RpcDeeplinkCreateFromBlockResponse, error) {
	out := new(pb.RpcDeeplinkCreateFromBlockResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/DeeplinkCreateFromBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) DeeplinkOpen(req *pb.RpcDeeplinkOpenRequest) *pb.RpcDeeplinkOpenResponse {
	return nil
}
func (*UnimplementedClientCommandsServer) DeeplinkCreateFromBlock(req *pb.RpcDeeplinkCreateFromBlockRequest) *pb.RpcDeeplinkCreateFromBlockResponse {
	return nil
}
...
func _ClientCommands_DeeplinkOpen_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcDeeplinkOpenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).DeeplinkOpen(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/DeeplinkOpen",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).DeeplinkOpen(req.(*pb.RpcDeeplinkOpenRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}

func _ClientCommands_DeeplinkCreateFromBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcDeeplinkCreateFromBlockRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).DeeplinkCreateFromBlock(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/DeeplinkCreateFromBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).DeeplinkCreateFromBlock(req.(*pb.RpcDeeplinkCreateFromBlockRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DeeplinkOpen",
			Handler:    _ClientCommands_DeeplinkOpen_Handler,
		},
		{
			MethodName: "DeeplinkCreateFromBlock",
			Handler:    _ClientCommands_DeeplinkCreateFromBlock_Handler,
		},
		{
