...
type ClientCommandsClient interface {
	...
	MembershipSelectVersion(ctx context.Context, in *pb.RpcMembershipSelectVersionRequest, opts ...grpc.CallOption) (*pb.RpcMembershipSelectVersionResponse, error)
	// Name Service:
	// ***
	// hello.any -> data
...
func (c *clientCommandsClient) MembershipSelectVersion(ctx context.Context, in *pb.RpcMembershipSelectVersionRequest, opts ...grpc.CallOption) (*pb.RpcMembershipSelectVersionResponse, error) {
	out := new(pb.RpcMembershipSelectVersionResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/MembershipSelectVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) MembershipSelectVersion(ctx context.Context, req *pb.RpcMembershipSelectVersionRequest) *pb.RpcMembershipSelectVersionResponse {
	return nil
}
...
func _ClientCommands_MembershipSelectVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcMembershipSelectVersionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).MembershipSelectVersion(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/MembershipSelectVersion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).MembershipSelectVersion(ctx, req.(*pb.RpcMembershipSelectVersionRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MembershipSelectVersion",
			Handler:    _ClientCommands_MembershipSelectVersion_Handler,
		},
		{
