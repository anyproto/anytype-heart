...
type ClientCommandsClient interface {
	...
	PaymentSubscriptionGetPortalLinkURL(ctx context.Context, in *pb.RpcPaymentsSubscriptionGetPortalLinkURLRequest, opts ...grpc.CallOption) (*pb.RpcPaymentsSubscriptionGetPortalLinkURLResponse, error)
	// hello.any -> data
...
func (c *clientCommandsClient) PaymentSubscriptionGetPortalLinkURL(ctx context.Context, in *pb.RpcPaymentsSubscriptionGetPortalLinkURLRequest, opts ...grpc.CallOption) (*pb.RpcPaymentsSubscriptionGetPortalLinkURLResponse, error) {
	out := new(pb.RpcPaymentsSubscriptionGetPortalLinkURLResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/PaymentSubscriptionGetPortalLinkURL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) PaymentSubscriptionGetPortalLinkURL(ctx context.Context, req *pb.RpcPaymentsSubscriptionGetPortalLinkURLRequest) *pb.RpcPaymentsSubscriptionGetPortalLinkURLResponse {
	return nil
}
...
func _ClientCommands_PaymentSubscriptionGetPortalLinkURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcPaymentsSubscriptionGetPortalLinkURLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).PaymentSubscriptionGetPortalLinkURL(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/PaymentSubscriptionGetPortalLinkURL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).PaymentSubscriptionGetPortalLinkURL(ctx, req.(*pb.RpcPaymentsSubscriptionGetPortalLinkURLRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PaymentSubscriptionGetPortalLinkURL",
			Handler:    _ClientCommands_PaymentSubscriptionGetPortalLinkURL_Handler,
		},
		{
