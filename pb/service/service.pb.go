...
type ClientCommandsClient interface {
	...
	WalletSetSessionSpaceID(ctx context.Context, in *pb.RpcWalletSetSessionSpaceIDRequest, opts ...grpc.CallOption) (*pb.RpcWalletSetSessionSpaceIDResponse, error)
...
func (c *clientCommandsClient) WalletSetSessionSpaceID(ctx context.Context, in *pb.RpcWalletSetSessionSpaceIDRequest, opts ...grpc.CallOption) (*pb.RpcWalletSetSessionSpaceIDResponse, error) {
	out := new(pb.RpcWalletSetSessionSpaceIDResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/WalletSetSessionSpaceID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) WalletSetSessionSpaceID(ctx context.Context, req *pb.RpcWalletSetSessionSpaceIDRequest) *pb.RpcWalletSetSessionSpaceIDResponse {
	return nil
}
...
func _ClientCommands_WalletSetSessionSpaceID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcWalletSetSessionSpaceIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).WalletSetSessionSpaceID(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/WalletSetSessionSpaceID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).WalletSetSessionSpaceID(ctx, req.(*pb.RpcWalletSetSessionSpaceIDRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "WalletSetSessionSpaceID",
			Handler:    _ClientCommands_WalletSetSessionSpaceID_Handler,
		},
		{
