...
type ClientCommandsClient interface {
	...
	PaymentsGetTiers(ctx context.Context, in *pb.RpcPaymentsTiersGetRequest, opts ...grpc.CallOption) (*pb.RpcPaymentsTiersGetResponse, error)
	// Name Service:
	// ***
	// hello.any -> data
...
func (c *clientCommandsClient) PaymentsGetTiers(ctx context.Context, in *pb.RpcPaymentsTiersGetRequest, opts ...grpc.CallOption) (*pb.RpcPaymentsTiersGetResponse, error) {
	out := new(pb.RpcPaymentsTiersGetResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/PaymentsGetTiers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) PaymentsGetTiers(ctx context.Context, req *pb.RpcPaymentsTiersGetRequest) *pb.RpcPaymentsTiersGetResponse {
	return nil
}
...
func _ClientCommands_PaymentsGetTiers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcPaymentsTiersGetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).PaymentsGetTiers(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/PaymentsGetTiers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).PaymentsGetTiers(ctx, req.(*pb.RpcPaymentsTiersGetRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PaymentsGetTiers",
			Handler:    _ClientCommands_PaymentsGetTiers_Handler,
		},
		{
