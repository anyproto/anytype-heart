...
type ClientCommandsClient interface {
	...
	ObjectTypeSetDefaultTemplate(ctx context.Context, in *pb.RpcObjectTypeSetDefaultTemplateRequest, opts ...grpc.CallOption) (*pb.RpcObjectTypeSetDefaultTemplateResponse, error)
...
func (c *clientCommandsClient) ObjectTypeSetDefaultTemplate(ctx context.Context, in *pb.RpcObjectTypeSetDefaultTemplateRequest, opts ...grpc.CallOption) (*pb.RpcObjectTypeSetDefaultTemplateResponse, error) {
	out := new(pb.RpcObjectTypeSetDefaultTemplateResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ObjectTypeSetDefaultTemplate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ObjectTypeSetDefaultTemplate(ctx context.Context, req *pb.RpcObjectTypeSetDefaultTemplateRequest) *pb.RpcObjectTypeSetDefaultTemplateResponse {
	return nil
}
...
func _ClientCommands_ObjectTypeSetDefaultTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcObjectTypeSetDefaultTemplateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ObjectTypeSetDefaultTemplate(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ObjectTypeSetDefaultTemplate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ObjectTypeSetDefaultTemplate(ctx, req.(*pb.RpcObjectTypeSetDefaultTemplateRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ObjectTypeSetDefaultTemplate",
			Handler:    _ClientCommands_ObjectTypeSetDefaultTemplate_Handler,
		},
		{
