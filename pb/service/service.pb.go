...
type ClientCommandsClient interface {
	...
	ObjectSetTemplatePlaceholders(ctx context.Context, in *pb.RpcObjectSetTemplatePlaceholdersRequest, opts ...grpc.CallOption) (*pb.RpcObjectSetTemplatePlaceholdersResponse, error)
...
func (c *clientCommandsClient) ObjectSetTemplatePlaceholders(ctx context.Context, in *pb.RpcObjectSetTemplatePlaceholdersRequest, opts ...grpc.CallOption) (*pb.RpcObjectSetTemplatePlaceholdersResponse, error) {
	out := new(pb.RpcObjectSetTemplatePlaceholdersResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/ObjectSetTemplatePlaceholders", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) ObjectSetTemplatePlaceholders(ctx context.Context, req *pb.RpcObjectSetTemplatePlaceholdersRequest) *pb.RpcObjectSetTemplatePlaceholdersResponse {
	return nil
}
...
func _ClientCommands_ObjectSetTemplatePlaceholders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcObjectSetTemplatePlaceholdersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).ObjectSetTemplatePlaceholders(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/ObjectSetTemplatePlaceholders",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).ObjectSetTemplatePlaceholders(ctx, req.(*pb.RpcObjectSetTemplatePlaceholdersRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ObjectSetTemplatePlaceholders",
			Handler:    _ClientCommands_ObjectSetTemplatePlaceholders_Handler,
		},
		{
