...
type ClientCommandsClient interface {
	...
	DownloadGalleryIndex(ctx context.Context, in *pb.RpcDownloadGalleryIndexRequest, opts ...grpc.CallOption) (*pb.RpcDownloadGalleryIndexResponse, error)
...
func (c *clientCommandsClient) DownloadGalleryIndex(ctx context.Context, in *pb.RpcDownloadGalleryIndexRequest, opts ...grpc.CallOption) (*pb.RpcDownloadGalleryIndexResponse, error) {
	out := new(pb.RpcDownloadGalleryIndexResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/DownloadGalleryIndex", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) DownloadGalleryIndex(ctx context.Context, req *pb.RpcDownloadGalleryIndexRequest) *pb.RpcDownloadGalleryIndexResponse {
	return nil
}
...
func _ClientCommands_DownloadGalleryIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcDownloadGalleryIndexRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).DownloadGalleryIndex(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/DownloadGalleryIndex",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).DownloadGalleryIndex(ctx, req.(*pb.RpcDownloadGalleryIndexRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DownloadGalleryIndex",
			Handler:    _ClientCommands_DownloadGalleryIndex_Handler,
		},
		{
