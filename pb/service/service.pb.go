...
type ClientCommandsClient interface {
	...
	SpaceGuestAdd(ctx context.Context, in *pb.RpcSpaceGuestAddRequest, opts ...grpc.CallOption) (*pb.RpcSpaceGuestAddResponse, error)
	SpacePublicAdd(ctx context.Context, in *pb.RpcSpacePublicAddRequest, opts ...grpc.CallOption) (*pb.RpcSpacePublicAddResponse, error)
	SpacePublish(ctx context.Context, in *pb.RpcSpacePublishRequest, opts ...grpc.CallOption) (*pb.RpcSpacePublishResponse, error)
...
func (c *clientCommandsClient) SpaceGuestAdd(ctx context.Context, in *pb.RpcSpaceGuestAddRequest, opts ...grpc.CallOption) (*pb.RpcSpaceGuestAddResponse, error) {
	out := new(pb.RpcSpaceGuestAddResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/SpaceGuestAdd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientCommandsClient) SpacePublicAdd(ctx context.Context, in *pb.RpcSpacePublicAddRequest, opts ...grpc.CallOption) (*pb.RpcSpacePublicAddResponse, error) {
	out := new(pb.RpcSpacePublicAddResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/SpacePublicAdd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientCommandsClient) SpacePublish(ctx context.Context, in *pb.RpcSpacePublishRequest, opts ...grpc.CallOption) (*pb.RpcSpacePublishResponse, error) {
	out := new(pb.RpcSpacePublishResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/SpacePublish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) SpaceGuestAdd(ctx context.Context, req *pb.RpcSpaceGuestAddRequest) *pb.RpcSpaceGuestAddResponse {
	return nil
}
func (*UnimplementedClientCommandsServer) SpacePublicAdd(ctx context.Context, req *pb.RpcSpacePublicAddRequest) *pb.RpcSpacePublicAddResponse {
	return nil
}
func (*UnimplementedClientCommandsServer) SpacePublish(ctx context.Context, req *pb.RpcSpacePublishRequest) *pb.RpcSpacePublishResponse {
	return nil
}
...
func _ClientCommands_SpaceGuestAdd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcSpaceGuestAddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).SpaceGuestAdd(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/SpaceGuestAdd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).SpaceGuestAdd(ctx, req.(*pb.RpcSpaceGuestAddRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}

func _ClientCommands_SpacePublicAdd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcSpacePublicAddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).SpacePublicAdd(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/SpacePublicAdd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).SpacePublicAdd(ctx, req.(*pb.RpcSpacePublicAddRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}

func _ClientCommands_SpacePublish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcSpacePublishRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).SpacePublish(ctx, in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/SpacePublish",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).SpacePublish(ctx, req.(*pb.RpcSpacePublishRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SpaceGuestAdd",
			Handler:    _ClientCommands_SpaceGuestAdd_Handler,
		},
		{
			MethodName: "SpacePublicAdd",
			Handler:    _ClientCommands_SpacePublicAdd_Handler,
		},
		{
			MethodName: "SpacePublish",
			Handler:    _ClientCommands_SpacePublish_Handler,
		},
		{
