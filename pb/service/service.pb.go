...
type ClientCommandsClient interface {
	...
	BlockSetFileStyle(ctx context.Context, in *pb.RpcBlockSetFileStyleRequest, opts ...grpc.CallOption) (*pb.RpcBlockSetFileStyleResponse, error)
...
func (c *clientCommandsClient) BlockSetFileStyle(ctx context.Context, in *pb.RpcBlockSetFileStyleRequest, opts ...grpc.CallOption) (*pb.RpcBlockSetFileStyleResponse, error) {
	out := new(pb.RpcBlockSetFileStyleResponse)
	err := c.cc.Invoke(ctx, "/anytype.ClientCommands/BlockSetFileStyle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedClientCommandsServer) BlockSetFileStyle(req *pb.RpcBlockSetFileStyleRequest) *pb.RpcBlockSetFileStyleResponse {
	return nil
}
...
func _ClientCommands_BlockSetFileStyle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.RpcBlockSetFileStyleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ClientCommandsServer).BlockSetFileStyle(in), nil
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anytype.ClientCommands/BlockSetFileStyle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientCommandsServer).BlockSetFileStyle(req.(*pb.RpcBlockSetFileStyleRequest)), nil
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ClientCommands_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BlockSetFileStyle",
			Handler:    _ClientCommands_BlockSetFileStyle_Handler,
		},
		{
