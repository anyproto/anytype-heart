...
type ChangeBlockContentTextChangeOfMarkerType struct {
	MarkerType model.BlockContentTextMarkerType `protobuf:"varint,5,opt,name=markerType,proto3,enum=anytype.model.BlockContentTextMarkerType,oneof" json:"markerType,omitempty"`
}
...
func (m *ChangeBlockContentText) GetMarkerType() model.BlockContentTextMarkerType {
...
var fileDescriptor_2b02bba284ea1e46 = []byte{
	...
	,
}
...
func (m *ChangeBlockContentText) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			var v model.BlockContentTextMarkerType
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowChanges
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= model.BlockContentTextMarkerType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
