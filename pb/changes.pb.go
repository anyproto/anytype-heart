...
type ChangeNotificationUpdate struct {
	...
	//	*ChangeNotificationUpdateUpdateOfStatus
	Update IsChangeNotificationUpdateUpdate `protobuf_oneof:"update"`
}
...
type IsChangeNotificationUpdateUpdate interface {
	IsChangeNotificationUpdateUpdate()
	MarshalTo([]byte) (int, error)
	Size() int
}

type ChangeNotificationUpdateUpdateOfStatus struct {
	Status model.NotificationStatus `protobuf:"varint,2,opt,name=status,proto3,enum=anytype.model.NotificationStatus,oneof" json:"status,omitempty"`
}

func (*ChangeNotificationUpdateUpdateOfStatus) IsChangeNotificationUpdateUpdate() {}

func (m *ChangeNotificationUpdate) GetUpdate() IsChangeNotificationUpdateUpdate {
	if m != nil {
		return m.Update
	}
	return nil
...
func (m *ChangeNotificationUpdate) GetStatus() model.NotificationStatus {
	if x, ok := m.GetUpdate().(*ChangeNotificationUpdateUpdateOfStatus); ok {
		return x.Status
	}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*ChangeNotificationUpdate) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ChangeNotificationUpdateUpdateOfStatus)(nil),
	}
}
...
var fileDescriptor_2b02bba284ea1e46 = []byte{
	...
	,
}
...
func (m *ChangeNotificationUpdateUpdateOfStatus) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ChangeNotificationUpdateUpdateOfStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *ChangeNotificationUpdateUpdateOfStatus) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ChangeNotificationUpdate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			var v model.NotificationStatus
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowChanges
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= model.NotificationStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
			m.Update = &ChangeNotificationUpdateUpdateOfStatus{v}
		default:
			iNdEx = preIndex
			skippy, err := skipChanges(dAtA[iNdEx:])
			if err != nil {
