...
type Change struct {
	...
	// integrationName is the RAW app name of the paired API key that
	// authored this change — exactly as the app link recorded it, never
	// normalized (normalization is many-to-one and lossy; the DELETE
	// ownership rule compares this value exactly). Stamped by heart from
	// the authenticated session — never accepted from a request. Bounded
	// at key issuance (domain.MaxIntegrationNameLen). Empty for changes
	// not authored through an API key.
	IntegrationName string `protobuf:"bytes,10,opt,name=integrationName,proto3" json:"integrationName,omitempty"`
}
...
func (m *Change) GetIntegrationName() string {
	if m != nil {
...
type ChangeNoSnapshot struct {
	...
	// business-level type of change applied to object
	ChangeType uint32 `protobuf:"varint,9,opt,name=changeType,proto3" json:"changeType,omitempty"`
	// integrationName mirrors Change.integrationName (the two messages share
...
func (m *ChangeNoSnapshot) GetIntegrationName() string {
	if m != nil {
		return m.IntegrationName
	}
	return ""
...
var fileDescriptor_2b02bba284ea1e46 = []byte{
	...
	,
}
...
func (m *Change) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IntegrationName) > 0 {
		...
		i = encodeVarintChanges(dAtA, i, uint64(len(m.IntegrationName)))
		i--
		dAtA[i] = 0x52
	}
	if m.ChangeType != 0 {
