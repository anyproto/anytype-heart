...
type ChangeBlockFields struct {
	Fields *ModelStruct `protobuf:"bytes,1,opt,name=fields,proto3" json:"fields,omitempty"`
}
...
func (m *ChangeBlockFields) GetFields() *ModelStruct {
	if m != nil {
		return m.Fields
	}
	return nil
...
type ChangeBlockContentTextChangeOfMarker struct {
	Marker ModelBlockContentTextMarker `protobuf:"varint,5,opt,name=marker,proto3,enum=anytype.ModelBlockContentTextMarker,oneof" json:"marker,omitempty"`
}
...
func (m *ChangeBlockContentText) GetMarker() ModelBlockContentTextMarker {
...
var fileDescriptor_b16a38c6509bd894 = []byte{
	...
	,
}
...
func (m *ChangeBlockContentText) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			var v ModelBlockContentTextMarker
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowChanges
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= ModelBlockContentTextMarker(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
