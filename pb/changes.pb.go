...
type ChangeSingleBlocksList struct {
	...
	//	*ChangeSingleBlocksListChangeOfChildren
...
type ChangeSingleBlocksListChangeOfChildren struct {
	Children *ChangeBlockChildren `protobuf:"bytes,5,opt,name=children,proto3,oneof" json:"children,omitempty"`
}
...
func (*ChangeSingleBlocksListChangeOfChildren) isChangeSingleBlocksListChange()    {}
...
func (m *ChangeSingleBlocksList) GetChildren() *ChangeBlockChildren {
	if x, ok := m.GetChange().(*ChangeSingleBlocksListChangeOfChildren); ok {
		return x.Children
	}
	return nil
}
...
func (*ChangeSingleBlocksList) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*ChangeSingleBlocksListChangeOfChildren)(nil),
...
var fileDescriptor_b16a38c6509bd894 = []byte{
	...
	,
}
...
func (m *ChangeSingleBlocksListChangeOfChildren) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ChangeSingleBlocksListChangeOfChildren) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Children != nil {
		{
...
func (m *ChangeSingleBlocksListChangeOfChildren) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ChangeSingleBlocksList) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.Change = &ChangeSingleBlocksListChangeOfChildren{v}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
