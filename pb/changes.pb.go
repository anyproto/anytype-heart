...
func (m *ChangeRelationUpdate) GetFormat() relation.RelationFormat {
	...
	return relation.RelationFormat_longtext
}
...
type ChangeRelationUpdateDict struct {
	Dict []*relation.RelationOption `protobuf:"bytes,2,rep,name=dict,proto3" json:"dict,omitempty"`
}
...
func (m *ChangeRelationUpdateDict) GetDict() []*relation.RelationOption {
	if m != nil {
		return m.Dict
	}
	return nil
...
var fileDescriptor_2b02bba284ea1e46 = []byte{
	...
	,
}
...
func (m *ChangeRelationUpdateDict) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Dict = append(m.Dict, &relation.RelationOption{})
