...
type Change struct {
	...
	// integrationKey identifies the integration (a normalized slug of the
	// paired app's name) whose API key authored this change. Stamped by
	// heart from the authenticated session — never accepted from a request.
	// Empty for changes not authored through an API key.
	IntegrationKey string `protobuf:"bytes,10,opt,name=integrationKey,proto3" json:"integrationKey,omitempty"`
}
...
func (m *Change) GetIntegrationKey() string {
	if m != nil {
...
type ChangeNoSnapshot struct {
	...
	// business-level type of change applied to object
	ChangeType uint32 `protobuf:"varint,9,opt,name=changeType,proto3" json:"changeType,omitempty"`
	// integrationKey mirrors Change.integrationKey (the two messages share
	// wire numbers by design; 1/2/5 are historical — do not reuse).
	IntegrationKey string `protobuf:"bytes,10,opt,name=integrationKey,proto3" json:"integrationKey,omitempty"`
}
...
func (m *ChangeNoSnapshot) GetIntegrationKey() string {
	if m != nil {
		return m.IntegrationKey
	}
	return ""
...
var fileDescriptor_2b02bba284ea1e46 = []byte{
	...
	,
}
...
func (m *Change) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.IntegrationKey) > 0 {
		i -= len(m.IntegrationKey)
		copy(dAtA[i:], m.IntegrationKey)
		i = encodeVarintChanges(dAtA, i, uint64(len(m.IntegrationKey)))
		i--
		dAtA[i] = 0x52
	}
	if m.ChangeType != 0 {
...
func (m *Change) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IntegrationKey", wireType)
			}
			...
			m.IntegrationKey = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
