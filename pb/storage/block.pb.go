...
type BlockWithMeta struct {
	...
	FileByHash map[string]*FileIndex   `protobuf:"bytes,3,rep,name=fileByHash,proto3" json:"fileByHash,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *BlockWithMeta) GetFileByHash() map[string]*FileIndex {
	if m != nil {
		return m.FileByHash
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]*FileIndex)(nil), "anytype.storage.BlockWithMeta.FileByHashEntry")
}
...
var fileDescriptor_922fa7b2983033eb = []byte{
	...
	,
}
...
func (m *BlockWithMeta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.FileByHash) > 0 {
		for k := range m.FileByHash {
			v := m.FileByHash[k]
			baseI := i
			if v != nil {
				{
...
func (m *BlockWithMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FileByHash", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.FileByHash == nil {
				m.FileByHash = make(map[string]*FileIndex)
			}
			var mapkey string
			var mapvalue *FileIndex
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
