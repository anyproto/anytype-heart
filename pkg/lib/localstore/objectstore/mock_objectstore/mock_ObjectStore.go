...
func (_m *MockObjectStore) GetObjectByUniqueKey(spaceId string, uniqueKey uniquekey.UniqueKey) (*model.ObjectDetails, error) {
...
func (_c *MockObjectStore_GetObjectByUniqueKey_Call) Run(run func(spaceId string, uniqueKey uniquekey.UniqueKey)) *MockObjectStore_GetObjectByUniqueKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockObjectStore_GetObjectByUniqueKey_Call) RunAndReturn(run func(string, uniquekey.UniqueKey) (*model.ObjectDetails, error)) *MockObjectStore_GetObjectByUniqueKey_Call {
	_c.Call.Return(run)
	return _c
}
