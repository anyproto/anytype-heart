...
// QueryAndProcess provides a mock function with given fields: q, proc
func (_m *MockObjectStore) QueryAndProcess(q database.Query, proc func(*types.Struct)) error {
	ret := _m.Called(q, proc)

	if len(ret) == 0 {
		panic("no return value specified for QueryAndProcess")
	}
...
// MockObjectStore_QueryAndProcess_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'QueryAndProcess'
type MockObjectStore_QueryAndProcess_Call struct {
	*mock.Call
}

// QueryAndProcess is a helper method to define mock.On call
//   - q database.Query
//   - proc func(*types.Struct)
func (_e *MockObjectStore_Expecter) QueryAndProcess(q interface{}, proc interface{}) *MockObjectStore_QueryAndProcess_Call {
	return &MockObjectStore_QueryAndProcess_Call{Call: _e.mock.On("QueryAndProcess", q, proc)}
}

func (_c *MockObjectStore_QueryAndProcess_Call) Run(run func(q database.Query, proc func(*types.Struct))) *MockObjectStore_QueryAndProcess_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockObjectStore_QueryAndProcess_Call) Return(_a0 error) *MockObjectStore_QueryAndProcess_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockObjectStore_QueryAndProcess_Call) RunAndReturn(run func(database.Query, func(*types.Struct)) error) *MockObjectStore_QueryAndProcess_Call {
	_c.Call.Return(run)
	return _c
}
