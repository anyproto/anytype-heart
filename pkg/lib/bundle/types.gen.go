...
const TypeChecksum = "80518c10ff7d4097acc170f0649d2b2c07c4b9bb857f2ecdff102d5fd995a457"
const (
	TypePrefix = "_ot"
)
const (
...
var (
	types = map[domain.TypeKey]*model.ObjectType{
		...
		TypeKeyChatDerived: {
			...
			RelationLinks: []*model.RelationLink{MustGetRelationLink(RelationKeyTag)},
			Revision:      3,
			SingleName:    "Chat Derived Objects",
