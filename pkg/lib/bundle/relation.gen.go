...
const RelationChecksum = "191355e94f3b3f16d58cd8ab77ead0b2c4143c6dfd42ec07206f7bd961ad19cc"
const (
	...
	RelationKeySpacePushNotificationsTopics        domain.RelationKey = "spacePushNotificationsTopics"
	RelationKeySpacePushNotificationsKey           domain.RelationKey = "spacePushNotificationsKey"
	RelationKeySpacePushNotificationsEncryptionKey domain.RelationKey = "spacePushNotificationsEncryptionKey"
)
...
var (
	relations = map[domain.RelationKey]*model.Relation{
		...
		RelationKeySpacePushNotificationsEncryptionKey: {

			DataSource:       model.Relation_local,
			Description:      "Push notifications encryption key (base64)",
			Format:           model.RelationFormat_longtext,
			Hidden:           true,
			Id:               "_brspacePushNotificationsEncryptionKey",
			Key:              "spacePushNotificationsEncryptionKey",
			MaxCount:         1,
		...
		RelationKeySpacePushNotificationsKey: {

			DataSource:       model.Relation_details,
			Description:      "Push notifications space key (base64)",
			Format:           model.RelationFormat_longtext,
			Hidden:           true,
			Id:               "_brspacePushNotificationsKey",
			Key:              "spacePushNotificationsKey",
			MaxCount:         1,
		...
		RelationKeySpacePushNotificationsTopics: {

			DataSource:       model.Relation_details,
			Description:      "Push notification topics (see model.PushNotificationTopics)",
			Format:           model.RelationFormat_number,
			Hidden:           true,
			Id:               "_brspacePushNotificationsTopics",
			Key:              "spacePushNotificationsTopics",
			MaxCount:         1,
			Name:             "Push topics",
			ReadOnly:         false,
			ReadOnlyRelation: true,
