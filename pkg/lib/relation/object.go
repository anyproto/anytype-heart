...
var (
	BundledObjectTypes = map[string]*relation.ObjectType{
		...
		"file": {
			Url:  bundledObjectTypeURLPrefix + "file",
			Name: "File",
			Relations: []*relation.Relation{
				MustGetBundledRelationByKey("id"),
				MustGetBundledRelationByKey("name"),
				MustGetBundledRelationByKey("addedDate"),
				MustGetBundledRelationByKey("fileMimeType"),
				MustGetBundledRelationByKey("sizeInBytes"),
			},
			Layout:    relation.ObjectType_file,
			IconEmoji: "🗂️",
		},
		"image": {
			Url:  bundledObjectTypeURLPrefix + "image",
			Name: "Image",
			Relations: []*relation.Relation{
				MustGetBundledRelationByKey("id"),
				MustGetBundledRelationByKey("name"),
				...
				MustGetBundledRelationByKey("addedDate"),
				MustGetBundledRelationByKey("fileMimeType"),
				MustGetBundledRelationByKey("widthInPixels"),
				MustGetBundledRelationByKey("heightInPixels"),
				MustGetBundledRelationByKey("camera"),
				MustGetBundledRelationByKey("exposureTime"),
				MustGetBundledRelationByKey("focalRatio"),
				MustGetBundledRelationByKey("latitude"),
				MustGetBundledRelationByKey("longitude"),
			},
			Layout:    relation.ObjectType_file,
			IconEmoji: "🌅",
		},
		"video": {
			Url:  bundledObjectTypeURLPrefix + "video",
			Name: "video",
			Relations: []*relation.Relation{
				MustGetBundledRelationByKey("id"),
				MustGetBundledRelationByKey("name"),
				...
				MustGetBundledRelationByKey("heightInPixels"),
				MustGetBundledRelationByKey("sizeInBytes"),
				MustGetBundledRelationByKey("thumbnailImage"),
				MustGetBundledRelationByKey("fileMimeType"),
			},
			Layout:    relation.ObjectType_file,
			IconEmoji: "🎞",
		...
		"audio": {
			Url:  bundledObjectTypeURLPrefix + "audio",
			Name: "audio",
			Relations: []*relation.Relation{
				MustGetBundledRelationByKey("id"),
				MustGetBundledRelationByKey("name"),
				...
				MustGetBundledRelationByKey("addedDate"),
				MustGetBundledRelationByKey("fileMimeType"),
				MustGetBundledRelationByKey("audioAlbum"),
				MustGetBundledRelationByKey("releasedYear"),
				MustGetBundledRelationByKey("composer"),
				MustGetBundledRelationByKey("audioGenre"),
				MustGetBundledRelationByKey("trackNumber"),
				MustGetBundledRelationByKey("thumbnailImage"),
			},
			Layout:    relation.ObjectType_file,
			IconEmoji: "🎵",
