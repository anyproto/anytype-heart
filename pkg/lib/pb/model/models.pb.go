...
type BlockContentTableCellAlign int32

const (
	BlockContentTableCell_Top    BlockContentTableCellAlign = 0
	BlockContentTableCell_Middle BlockContentTableCellAlign = 1
	BlockContentTableCell_Bottom BlockContentTableCellAlign = 2
)

var BlockContentTableCellAlign_name = map[int32]string{
	0: "Top",
	1: "Middle",
	2: "Bottom",
}

var BlockContentTableCellAlign_value = map[string]int32{
	"Top":    0,
	"Middle": 1,
	"Bottom": 2,
}

func (x BlockContentTableCellAlign) String() string {
	return proto.EnumName(BlockContentTableCellAlign_name, int32(x))
}

func (BlockContentTableCellAlign) EnumDescriptor() ([]byte, []int) {
...
type BlockContentOfTableCell struct {
	TableCell *BlockContentTableCell `protobuf:"bytes,29,opt,name=tableCell,proto3,oneof" json:"tableCell,omitempty"`
}
...
func (*BlockContentOfTableCell) IsBlockContent()         {}
...
func (m *Block) GetTableCell() *BlockContentTableCell {
	if x, ok := m.GetContent().(*BlockContentOfTableCell); ok {
		return x.TableCell
	}
	return nil
}
...
type BlockContentTableCell struct {
	Color         string                     `protobuf:"bytes,1,opt,name=color,proto3" json:"color,omitempty"`
	Style         BlockContentTextStyle      `protobuf:"varint,2,opt,name=style,proto3,enum=anytype.model.BlockContentTextStyle" json:"style,omitempty"`
	VerticalAlign BlockContentTableCellAlign `protobuf:"varint,3,opt,name=verticalAlign,proto3,enum=anytype.model.BlockContentTableCellAlign" json:"verticalAlign,omitempty"`
}

func (m *BlockContentTableCell) Reset()         { *m = BlockContentTableCell{} }
func (m *BlockContentTableCell) String() string { return proto.CompactTextString(m) }
func (*BlockContentTableCell) ProtoMessage()    {}
func (*BlockContentTableCell) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{1, 1, 16}
}
func (m *BlockContentTableCell) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BlockContentTableCell) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BlockContentTableCell.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BlockContentTableCell) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BlockContentTableCell.Merge(m, src)
}
func (m *BlockContentTableCell) XXX_Size() int {
	return m.Size()
}
func (m *BlockContentTableCell) XXX_DiscardUnknown() {
	xxx_messageInfo_BlockContentTableCell.DiscardUnknown(m)
}

var xxx_messageInfo_BlockContentTableCell proto.InternalMessageInfo

func (m *BlockContentTableCell) GetColor() string {
	if m != nil {
		return m.Color
	}
	return ""
...
func (m *BlockContentTableCell) GetStyle() BlockContentTextStyle {
	if m != nil {
		return m.Style
	}
	return BlockContentText_Paragraph
...
func (m *BlockContentTableCell) GetVerticalAlign() BlockContentTableCellAlign {
	if m != nil {
		return m.VerticalAlign
	}
	return BlockContentTableCell_Top
}
...
func init() {
	...
	proto.RegisterEnum("anytype.model.BlockContentTableCellAlign", BlockContentTableCellAlign_name, BlockContentTableCellAlign_value)
	...
	proto.RegisterType((*BlockContentTableCell)(nil), "anytype.model.Block.Content.TableCell")
...
var fileDescriptor_98a910b73321e591 = []byte{
	...
	,
}
...
func (m *BlockContentOfTableCell) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BlockContentOfTableCell) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.TableCell != nil {
		{
			size, err := m.TableCell.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *BlockContentTableCell) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BlockContentTableCell) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BlockContentTableCell) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Restrictions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Object) > 0 {
		dAtA35 := make([]byte, len(m.Object)*10)
		var j34 int
...
func (m *RestrictionsDataviewRestrictions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Restrictions) > 0 {
		dAtA37 := make([]byte, len(m.Restrictions)*10)
		var j36 int
		...
		i = encodeVarintModels(dAtA, i, uint64(j36))
		i--
		dAtA[i] = 0x12
	}
	if len(m.BlockId) > 0 {
...
func (m *ObjectType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Types) > 0 {
		dAtA39 := make([]byte, len(m.Types)*10)
		var j38 int
...
func (m *BlockContentOfTableCell) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BlockContentTableCell) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Block) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TableCell", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &BlockContentTableCell{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Content = &BlockContentOfTableCell{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipModels(dAtA[iNdEx:])
...
func (m *BlockContentTableCell) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.VerticalAlign |= BlockContentTableCellAlign(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
