...
type SubscriptionTierDataPeriodType int32

const (
	SubscriptionTierData_PeriodTypeUnknown   SubscriptionTierDataPeriodType = 0
	SubscriptionTierData_PeriodTypeUnlimited SubscriptionTierDataPeriodType = 1
	SubscriptionTierData_PeriodTypeDays      SubscriptionTierDataPeriodType = 2
	SubscriptionTierData_PeriodTypeWeeks     SubscriptionTierDataPeriodType = 3
	SubscriptionTierData_PeriodTypeMonths    SubscriptionTierDataPeriodType = 4
	SubscriptionTierData_PeriodTypeYears     SubscriptionTierDataPeriodType = 5
)

var SubscriptionTierDataPeriodType_name = map[int32]string{
	0: "PeriodTypeUnknown",
...
var SubscriptionTierDataPeriodType_value = map[string]int32{
	"PeriodTypeUnknown":   0,
...
func (x SubscriptionTierDataPeriodType) String() string {
	return proto.EnumName(SubscriptionTierDataPeriodType_name, int32(x))
}

func (SubscriptionTierDataPeriodType) EnumDescriptor() ([]byte, []int) {
...
type SubscriptionTierData struct {
	...
	PeriodType SubscriptionTierDataPeriodType `protobuf:"varint,7,opt,name=periodType,proto3,enum=anytype.model.SubscriptionTierDataPeriodType" json:"periodType,omitempty"`
	...
	// "spaces-public" -> {10, ""}
	// ...
	Features map[string]*SubscriptionTierDataFeature `protobuf:"bytes,12,rep,name=features,proto3" json:"features,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (m *SubscriptionTierData) Reset()         { *m = SubscriptionTierData{} }
func (m *SubscriptionTierData) String() string { return proto.CompactTextString(m) }
func (*SubscriptionTierData) ProtoMessage()    {}
func (*SubscriptionTierData) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{29}
}
func (m *SubscriptionTierData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SubscriptionTierData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SubscriptionTierData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SubscriptionTierData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SubscriptionTierData.Merge(m, src)
}
func (m *SubscriptionTierData) XXX_Size() int {
	return m.Size()
}
func (m *SubscriptionTierData) XXX_DiscardUnknown() {
	xxx_messageInfo_SubscriptionTierData.DiscardUnknown(m)
}

var xxx_messageInfo_SubscriptionTierData proto.InternalMessageInfo

func (m *SubscriptionTierData) GetId() uint32 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *SubscriptionTierData) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *SubscriptionTierData) GetDescription() string {
	if m != nil {
		return m.Description
	}
	return ""
...
func (m *SubscriptionTierData) GetIsActive() bool {
	if m != nil {
		return m.IsActive
	}
	return false
...
func (m *SubscriptionTierData) GetIsTest() bool {
	if m != nil {
		return m.IsTest
	}
	return false
...
func (m *SubscriptionTierData) GetIsHiddenTier() bool {
	if m != nil {
...
func (m *SubscriptionTierData) GetPeriodType() SubscriptionTierDataPeriodType {
	if m != nil {
		return m.PeriodType
	}
	return SubscriptionTierData_PeriodTypeUnknown
}

func (m *SubscriptionTierData) GetPeriodValue() uint32 {
	if m != nil {
...
func (m *SubscriptionTierData) GetPriceStripeUsdCents() uint32 {
	if m != nil {
...
func (m *SubscriptionTierData) GetAnyNamesCountIncluded() uint32 {
	if m != nil {
...
func (m *SubscriptionTierData) GetAnyNameMinLength() uint32 {
	if m != nil {
...
func (m *SubscriptionTierData) GetFeatures() map[string]*SubscriptionTierDataFeature {
	if m != nil {
		return m.Features
	}
	return nil
...
type SubscriptionTierDataFeature struct {
...
func (m *SubscriptionTierDataFeature) Reset()         { *m = SubscriptionTierDataFeature{} }
func (m *SubscriptionTierDataFeature) String() string { return proto.CompactTextString(m) }
func (*SubscriptionTierDataFeature) ProtoMessage()    {}
func (*SubscriptionTierDataFeature) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{29, 0}
}
func (m *SubscriptionTierDataFeature) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SubscriptionTierDataFeature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SubscriptionTierDataFeature.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SubscriptionTierDataFeature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SubscriptionTierDataFeature.Merge(m, src)
}
func (m *SubscriptionTierDataFeature) XXX_Size() int {
	return m.Size()
}
func (m *SubscriptionTierDataFeature) XXX_DiscardUnknown() {
	xxx_messageInfo_SubscriptionTierDataFeature.DiscardUnknown(m)
}

var xxx_messageInfo_SubscriptionTierDataFeature proto.InternalMessageInfo

func (m *SubscriptionTierDataFeature) GetValueUint() uint32 {
	if m != nil {
		return m.ValueUint
	}
	return 0
...
func (m *SubscriptionTierDataFeature) GetValueStr() string {
	if m != nil {
		return m.ValueStr
	}
	return ""
...
func init() {
	...
	proto.RegisterEnum("anytype.model.SubscriptionTierDataPeriodType", SubscriptionTierDataPeriodType_name, SubscriptionTierDataPeriodType_value)
	...
	proto.RegisterType((*SubscriptionTierData)(nil), "anytype.model.SubscriptionTierData")
	proto.RegisterMapType((map[string]*SubscriptionTierDataFeature)(nil), "anytype.model.SubscriptionTierData.FeaturesEntry")
	proto.RegisterType((*SubscriptionTierDataFeature)(nil), "anytype.model.SubscriptionTierData.Feature")
}
...
var fileDescriptor_98a910b73321e591 = []byte{
	...
	,
}
...
func (m *SubscriptionTierData) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SubscriptionTierData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SubscriptionTierData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SubscriptionTierDataFeature) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SubscriptionTierDataFeature) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SubscriptionTierDataFeature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SubscriptionTierData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SubscriptionTierDataFeature) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SubscriptionTierData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SubscriptionTierData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SubscriptionTierData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PeriodType |= SubscriptionTierDataPeriodType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 12:
			...
			if m.Features == nil {
				m.Features = make(map[string]*SubscriptionTierDataFeature)
			}
			var mapkey string
			var mapvalue *SubscriptionTierDataFeature
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &SubscriptionTierDataFeature{}
...
func (m *SubscriptionTierDataFeature) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
