...
func (MembershipV2ProductStatusStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{35, 3, 0}
}

type MembershipV2InvoiceStatus int32

const (
	MembershipV2Invoice_Unpaid MembershipV2InvoiceStatus = 0
	MembershipV2Invoice_Paid   MembershipV2InvoiceStatus = 1
)

var MembershipV2InvoiceStatus_name = map[int32]string{
	0: "Unpaid",
	1: "Paid",
}

var MembershipV2InvoiceStatus_value = map[string]int32{
	"Unpaid": 0,
	"Paid":   1,
}

func (x MembershipV2InvoiceStatus) String() string {
	return proto.EnumName(MembershipV2InvoiceStatus_name, int32(x))
}

func (MembershipV2InvoiceStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{35, 6, 0}
}
...
func (m *MembershipV2Amount) GetAmountCents() uint32 {
	if m != nil {
...
type MembershipV2Product struct {
	// this is a unique Payment Node ID of the product
	...
	Name        string                       `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty"`
	Description string                       `protobuf:"bytes,5,opt,name=description,proto3" json:"description,omitempty"`
	PeriodType  MembershipTierDataPeriodType `protobuf:"varint,6,opt,name=periodType,proto3,enum=anytype.model.MembershipTierDataPeriodType" json:"periodType,omitempty"`
	// i.e. "5 days" or "3 years"
...
func (*MembershipV2Product) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{35, 1}
}
...
func (m *MembershipV2Product) GetPeriodType() MembershipTierDataPeriodType {
	if m != nil {
		return m.PeriodType
	}
	return MembershipTierData_PeriodTypeUnknown
...
func (m *MembershipV2Product) GetPeriodValue() uint32 {
	if m != nil {
		return m.PeriodValue
	}
	return 0
...
type MembershipV2PurchaseInfo struct {
	...
	PaymentMethod MembershipPaymentMethod `protobuf:"varint,4,opt,name=paymentMethod,proto3,enum=anytype.model.MembershipPaymentMethod" json:"paymentMethod,omitempty"`
}
...
func (*MembershipV2PurchaseInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{35, 2}
}
...
func (m *MembershipV2PurchaseInfo) GetPaymentMethod() MembershipPaymentMethod {
	if m != nil {
		return m.PaymentMethod
	}
	return Membership_MethodNone
...
func (*MembershipV2ProductStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{35, 3}
}
...
func (*MembershipV2PurchasedProduct) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{35, 4}
}
...
type MembershipV2StoreProduct struct {
	Product *MembershipV2Product `protobuf:"bytes,1,opt,name=product,proto3" json:"product,omitempty"`
	Price   *MembershipV2Amount  `protobuf:"bytes,2,opt,name=price,proto3" json:"price,omitempty"`
}

func (m *MembershipV2StoreProduct) Reset()         { *m = MembershipV2StoreProduct{} }
func (m *MembershipV2StoreProduct) String() string { return proto.CompactTextString(m) }
func (*MembershipV2StoreProduct) ProtoMessage()    {}
func (*MembershipV2StoreProduct) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{35, 5}
}
func (m *MembershipV2StoreProduct) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MembershipV2StoreProduct) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MembershipV2StoreProduct.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MembershipV2StoreProduct) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MembershipV2StoreProduct.Merge(m, src)
}
func (m *MembershipV2StoreProduct) XXX_Size() int {
	return m.Size()
}
func (m *MembershipV2StoreProduct) XXX_DiscardUnknown() {
	xxx_messageInfo_MembershipV2StoreProduct.DiscardUnknown(m)
}

var xxx_messageInfo_MembershipV2StoreProduct proto.InternalMessageInfo

func (m *MembershipV2StoreProduct) GetProduct() *MembershipV2Product {
	if m != nil {
		return m.Product
	}
	return nil
...
func (m *MembershipV2StoreProduct) GetPrice() *MembershipV2Amount {
	if m != nil {
		return m.Price
	}
	return nil
...
type MembershipV2Invoice struct {
	...
	Total  *MembershipV2Amount       `protobuf:"bytes,3,opt,name=total,proto3" json:"total,omitempty"`
	Status MembershipV2InvoiceStatus `protobuf:"varint,4,opt,name=status,proto3,enum=anytype.model.MembershipV2InvoiceStatus" json:"status,omitempty"`
}
...
func (*MembershipV2Invoice) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{35, 6}
}
...
func (m *MembershipV2Invoice) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *MembershipV2Invoice) GetStatus() MembershipV2InvoiceStatus {
	if m != nil {
		return m.Status
	}
	return MembershipV2Invoice_Unpaid
}

type MembershipV2Cart struct {
	...
	Products []*MembershipV2Product `protobuf:"bytes,1,rep,name=products,proto3" json:"products,omitempty"`
	...
	// otherwise - it will be equal to total!
	TotalNextInvoice *MembershipV2Amount `protobuf:"bytes,3,opt,name=totalNextInvoice,proto3" json:"totalNextInvoice,omitempty"`
	NextInvoiceDate  uint64              `protobuf:"varint,4,opt,name=nextInvoiceDate,proto3" json:"nextInvoiceDate,omitempty"`
}

func (m *MembershipV2Cart) Reset()         { *m = MembershipV2Cart{} }
func (m *MembershipV2Cart) String() string { return proto.CompactTextString(m) }
func (*MembershipV2Cart) ProtoMessage()    {}
func (*MembershipV2Cart) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{35, 7}
}
func (m *MembershipV2Cart) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MembershipV2Cart) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MembershipV2Cart.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MembershipV2Cart) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MembershipV2Cart.Merge(m, src)
}
func (m *MembershipV2Cart) XXX_Size() int {
	return m.Size()
}
func (m *MembershipV2Cart) XXX_DiscardUnknown() {
	xxx_messageInfo_MembershipV2Cart.DiscardUnknown(m)
}

var xxx_messageInfo_MembershipV2Cart proto.InternalMessageInfo

func (m *MembershipV2Cart) GetProducts() []*MembershipV2Product {
	if m != nil {
		return m.Products
	}
	return nil
...
func (m *MembershipV2Cart) GetTotal() *MembershipV2Amount {
	if m != nil {
		return m.Total
	}
	return nil
...
func (m *MembershipV2Cart) GetTotalNextInvoice() *MembershipV2Amount {
	if m != nil {
...
func (m *MembershipV2Cart) GetNextInvoiceDate() uint64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterEnum("anytype.model.MembershipV2InvoiceStatus", MembershipV2InvoiceStatus_name, MembershipV2InvoiceStatus_value)
	...
	proto.RegisterType((*MembershipV2StoreProduct)(nil), "anytype.model.MembershipV2.StoreProduct")
	proto.RegisterType((*MembershipV2Invoice)(nil), "anytype.model.MembershipV2.Invoice")
	proto.RegisterType((*MembershipV2Cart)(nil), "anytype.model.MembershipV2.Cart")
}
...
var fileDescriptor_98a910b73321e591 = []byte{
	// 9038 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *MembershipV2StoreProduct) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MembershipV2StoreProduct) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MembershipV2StoreProduct) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MembershipV2Cart) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MembershipV2Cart) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MembershipV2Cart) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.NextInvoiceDate != 0 {
		i = encodeVarintModels(dAtA, i, uint64(m.NextInvoiceDate))
		i--
		dAtA[i] = 0x20
	}
...
func (m *MembershipV2StoreProduct) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MembershipV2Cart) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.NextInvoiceDate != 0 {
		n += 1 + sovModels(uint64(m.NextInvoiceDate))
	}
	return n
}
...
func (m *MembershipV2StoreProduct) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Status |= MembershipV2InvoiceStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *MembershipV2Cart) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			m.Products = append(m.Products, &MembershipV2Product{})
		...
		case 3:
			...
			if m.TotalNextInvoice == nil {
				m.TotalNextInvoice = &MembershipV2Amount{}
			}
