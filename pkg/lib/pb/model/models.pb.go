...
type ChatMessageMessageContentMessageStyle int32

const (
	ChatMessageMessageContent_PARAGRAPH ChatMessageMessageContentMessageStyle = 0
	ChatMessageMessageContent_QUOTE     ChatMessageMessageContentMessageStyle = 5
	ChatMessageMessageContent_CODE      ChatMessageMessageContentMessageStyle = 6
	ChatMessageMessageContent_MARKED    ChatMessageMessageContentMessageStyle = 9
	ChatMessageMessageContent_NUMBERED  ChatMessageMessageContentMessageStyle = 10
	ChatMessageMessageContent_CALLOUT   ChatMessageMessageContentMessageStyle = 13
)

var ChatMessageMessageContentMessageStyle_name = map[int32]string{
	0:  "PARAGRAPH",
	5:  "QUOTE",
	6:  "CODE",
	9:  "MARKED",
...
var ChatMessageMessageContentMessageStyle_value = map[string]int32{
	"PARAGRAPH": 0,
	"QUOTE":     5,
	"CODE":      6,
	"MARKED":    9,
...
func (x ChatMessageMessageContentMessageStyle) String() string {
	return proto.EnumName(ChatMessageMessageContentMessageStyle_name, int32(x))
}

func (ChatMessageMessageContentMessageStyle) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{34, 0, 0}
}

type ChatMessageMessageContentMarkMarkType int32

const (
	ChatMessageMessageContentMark_STRIKETHROUGH    ChatMessageMessageContentMarkMarkType = 0
	ChatMessageMessageContentMark_KEYBOARD         ChatMessageMessageContentMarkMarkType = 1
	ChatMessageMessageContentMark_ITALIC           ChatMessageMessageContentMarkMarkType = 2
	ChatMessageMessageContentMark_BOLD             ChatMessageMessageContentMarkMarkType = 3
	ChatMessageMessageContentMark_UNDERSCORED      ChatMessageMessageContentMarkMarkType = 4
	ChatMessageMessageContentMark_LINK             ChatMessageMessageContentMarkMarkType = 5
	ChatMessageMessageContentMark_TEXT_COLOR       ChatMessageMessageContentMarkMarkType = 6
	ChatMessageMessageContentMark_BACKGROUND_COLOR ChatMessageMessageContentMarkMarkType = 7
	ChatMessageMessageContentMark_MENTION          ChatMessageMessageContentMarkMarkType = 8
	ChatMessageMessageContentMark_EMOJI            ChatMessageMessageContentMarkMarkType = 9
	ChatMessageMessageContentMark_OBJECT           ChatMessageMessageContentMarkMarkType = 10
)

var ChatMessageMessageContentMarkMarkType_name = map[int32]string{
	0:  "STRIKETHROUGH",
	1:  "KEYBOARD",
	2:  "ITALIC",
	3:  "BOLD",
...
var ChatMessageMessageContentMarkMarkType_value = map[string]int32{
	"STRIKETHROUGH":    0,
	"KEYBOARD":         1,
	"ITALIC":           2,
	"BOLD":             3,
...
func (x ChatMessageMessageContentMarkMarkType) String() string {
	return proto.EnumName(ChatMessageMessageContentMarkMarkType_name, int32(x))
}

func (ChatMessageMessageContentMarkMarkType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{34, 0, 0, 0}
}
...
type ChatMessage struct {
	...
	ReplyToMessageId string                     `protobuf:"bytes,4,opt,name=replyToMessageId,proto3" json:"replyToMessageId,omitempty"`
	Message          *ChatMessageMessageContent `protobuf:"bytes,5,opt,name=message,proto3" json:"message,omitempty"`
	Attachments      []*ChatMessageAttachment   `protobuf:"bytes,6,rep,name=attachments,proto3" json:"attachments,omitempty"`
	Reactions        *ChatMessageReactions      `protobuf:"bytes,7,opt,name=reactions,proto3" json:"reactions,omitempty"`
}
...
type ChatMessageMessageContent struct {
	Text  string                                `protobuf:"bytes,1,opt,name=text,proto3" json:"text,omitempty"`
	Style ChatMessageMessageContentMessageStyle `protobuf:"varint,2,opt,name=style,proto3,enum=anytype.model.ChatMessageMessageContentMessageStyle" json:"style,omitempty"`
	Marks []*ChatMessageMessageContentMark      `protobuf:"bytes,3,rep,name=marks,proto3" json:"marks,omitempty"`
}
...
func (m *ChatMessageMessageContent) GetStyle() ChatMessageMessageContentMessageStyle {
	if m != nil {
		return m.Style
	}
	return ChatMessageMessageContent_PARAGRAPH
}

func (m *ChatMessageMessageContent) GetMarks() []*ChatMessageMessageContentMark {
	if m != nil {
		return m.Marks
	}
	return nil
...
type ChatMessageMessageContentMark struct {
	From int32                                 `protobuf:"varint,1,opt,name=from,proto3" json:"from,omitempty"`
	To   int32                                 `protobuf:"varint,2,opt,name=to,proto3" json:"to,omitempty"`
	Type ChatMessageMessageContentMarkMarkType `protobuf:"varint,3,opt,name=type,proto3,enum=anytype.model.ChatMessageMessageContentMarkMarkType" json:"type,omitempty"`
}

func (m *ChatMessageMessageContentMark) Reset()         { *m = ChatMessageMessageContentMark{} }
func (m *ChatMessageMessageContentMark) String() string { return proto.CompactTextString(m) }
func (*ChatMessageMessageContentMark) ProtoMessage()    {}
func (*ChatMessageMessageContentMark) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{34, 0, 0}
}
func (m *ChatMessageMessageContentMark) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ChatMessageMessageContentMark) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ChatMessageMessageContentMark.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ChatMessageMessageContentMark) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChatMessageMessageContentMark.Merge(m, src)
}
func (m *ChatMessageMessageContentMark) XXX_Size() int {
	return m.Size()
}
func (m *ChatMessageMessageContentMark) XXX_DiscardUnknown() {
	xxx_messageInfo_ChatMessageMessageContentMark.DiscardUnknown(m)
}

var xxx_messageInfo_ChatMessageMessageContentMark proto.InternalMessageInfo

func (m *ChatMessageMessageContentMark) GetFrom() int32 {
	if m != nil {
		return m.From
	}
	return 0
...
func (m *ChatMessageMessageContentMark) GetTo() int32 {
	if m != nil {
		return m.To
	}
	return 0
...
func (m *ChatMessageMessageContentMark) GetType() ChatMessageMessageContentMarkMarkType {
	if m != nil {
		return m.Type
	}
	return ChatMessageMessageContentMark_STRIKETHROUGH
}
...
type ChatMessageIdentityList struct {
	Ids []string `protobuf:"bytes,1,rep,name=ids,proto3" json:"ids,omitempty"`
}

func (m *ChatMessageIdentityList) Reset()         { *m = ChatMessageIdentityList{} }
func (m *ChatMessageIdentityList) String() string { return proto.CompactTextString(m) }
func (*ChatMessageIdentityList) ProtoMessage()    {}
func (*ChatMessageIdentityList) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{34, 2}
}
func (m *ChatMessageIdentityList) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ChatMessageIdentityList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ChatMessageIdentityList.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ChatMessageIdentityList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ChatMessageIdentityList.Merge(m, src)
}
func (m *ChatMessageIdentityList) XXX_Size() int {
	return m.Size()
}
func (m *ChatMessageIdentityList) XXX_DiscardUnknown() {
	xxx_messageInfo_ChatMessageIdentityList.DiscardUnknown(m)
}

var xxx_messageInfo_ChatMessageIdentityList proto.InternalMessageInfo

func (m *ChatMessageIdentityList) GetIds() []string {
	if m != nil {
		return m.Ids
	}
	return nil
...
type ChatMessageReactions struct {
	Reactions map[string]*ChatMessageIdentityList `protobuf:"bytes,1,rep,name=reactions,proto3" json:"reactions,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (*ChatMessageReactions) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{34, 3}
}
...
func (m *ChatMessageReactions) GetReactions() map[string]*ChatMessageIdentityList {
	if m != nil {
		return m.Reactions
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("anytype.model.ChatMessageMessageContentMessageStyle", ChatMessageMessageContentMessageStyle_name, ChatMessageMessageContentMessageStyle_value)
	proto.RegisterEnum("anytype.model.ChatMessageMessageContentMarkMarkType", ChatMessageMessageContentMarkMarkType_name, ChatMessageMessageContentMarkMarkType_value)
	...
	proto.RegisterType((*ChatMessageMessageContentMark)(nil), "anytype.model.ChatMessage.MessageContent.Mark")
	proto.RegisterType((*ChatMessageAttachment)(nil), "anytype.model.ChatMessage.Attachment")
	proto.RegisterType((*ChatMessageIdentityList)(nil), "anytype.model.ChatMessage.IdentityList")
	proto.RegisterType((*ChatMessageReactions)(nil), "anytype.model.ChatMessage.Reactions")
	proto.RegisterMapType((map[string]*ChatMessageIdentityList)(nil), "anytype.model.ChatMessage.Reactions.ReactionsEntry")
}
...
var fileDescriptor_98a910b73321e591 = []byte{
	// 8772 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *ChatMessageMessageContentMark) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ChatMessageMessageContentMark) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ChatMessageMessageContentMark) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ChatMessageIdentityList) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ChatMessageIdentityList) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ChatMessageIdentityList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ChatMessageMessageContentMark) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ChatMessageIdentityList) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Style |= ChatMessageMessageContentMessageStyle(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			m.Marks = append(m.Marks, &ChatMessageMessageContentMark{})
			if err := m.Marks[len(m.Marks)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *ChatMessageMessageContentMark) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= ChatMessageMessageContentMarkMarkType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ChatMessageIdentityList) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *ChatMessageReactions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Reactions == nil {
				m.Reactions = make(map[string]*ChatMessageIdentityList)
			}
			var mapkey string
			var mapvalue *ChatMessageIdentityList
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &ChatMessageIdentityList{}
