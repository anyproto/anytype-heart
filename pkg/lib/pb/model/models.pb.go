...
type MembershipTierDataFeatureId int32

const (
	MembershipTierData_Unknown      MembershipTierDataFeatureId = 0
	MembershipTierData_StorageGBs   MembershipTierDataFeatureId = 1
	MembershipTierData_Invites      MembershipTierDataFeatureId = 2
	MembershipTierData_SpaceWriters MembershipTierDataFeatureId = 3
	MembershipTierData_SpaceReaders MembershipTierDataFeatureId = 4
	MembershipTierData_SharedSpaces MembershipTierDataFeatureId = 5
)

var MembershipTierDataFeatureId_name = map[int32]string{
	0: "Unknown",
	1: "StorageGBs",
	2: "Invites",
	3: "SpaceWriters",
...
var MembershipTierDataFeatureId_value = map[string]int32{
	"Unknown":      0,
	"StorageGBs":   1,
	"Invites":      2,
	"SpaceWriters": 3,
...
func (x MembershipTierDataFeatureId) String() string {
	return proto.EnumName(MembershipTierDataFeatureId_name, int32(x))
}

func (MembershipTierDataFeatureId) EnumDescriptor() ([]byte, []int) {
...
type MembershipTierData struct {
	...
	Features map[uint32]*MembershipTierDataFeature `protobuf:"bytes,12,rep,name=features,proto3" json:"features,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *MembershipTierData) GetIsActive() bool {
	if m != nil {
		return m.IsActive
	}
	return false
...
func (m *MembershipTierData) GetIsHiddenTier() bool {
	if m != nil {
...
func (m *MembershipTierData) GetFeatures() map[uint32]*MembershipTierDataFeature {
	if m != nil {
		return m.Features
	}
	return nil
...
type MembershipTierDataFeature struct {
	// usually feature has uint value
	// like "storage" - 120
	ValueUint uint32 `protobuf:"varint,1,opt,name=valueUint,proto3" json:"valueUint,omitempty"`
	// in case feature will have string value
	ValueStr string `protobuf:"bytes,2,opt,name=valueStr,proto3" json:"valueStr,omitempty"`
}

func (m *MembershipTierDataFeature) Reset()         { *m = MembershipTierDataFeature{} }
func (m *MembershipTierDataFeature) String() string { return proto.CompactTextString(m) }
func (*MembershipTierDataFeature) ProtoMessage()    {}
func (*MembershipTierDataFeature) Descriptor() ([]byte, []int) {
	return fileDescriptor_98a910b73321e591, []int{30, 0}
}
func (m *MembershipTierDataFeature) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MembershipTierDataFeature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MembershipTierDataFeature.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MembershipTierDataFeature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MembershipTierDataFeature.Merge(m, src)
}
func (m *MembershipTierDataFeature) XXX_Size() int {
	return m.Size()
}
func (m *MembershipTierDataFeature) XXX_DiscardUnknown() {
	xxx_messageInfo_MembershipTierDataFeature.DiscardUnknown(m)
}

var xxx_messageInfo_MembershipTierDataFeature proto.InternalMessageInfo

func (m *MembershipTierDataFeature) GetValueUint() uint32 {
	if m != nil {
		return m.ValueUint
	}
	return 0
...
func (m *MembershipTierDataFeature) GetValueStr() string {
	if m != nil {
		return m.ValueStr
	}
	return ""
...
func init() {
	...
	proto.RegisterEnum("anytype.model.MembershipTierDataFeatureId", MembershipTierDataFeatureId_name, MembershipTierDataFeatureId_value)
	...
	proto.RegisterMapType((map[uint32]*MembershipTierDataFeature)(nil), "anytype.model.MembershipTierData.FeaturesEntry")
	proto.RegisterType((*MembershipTierDataFeature)(nil), "anytype.model.MembershipTierData.Feature")
}
...
var fileDescriptor_98a910b73321e591 = []byte{
	...
	,
}
...
func (m *Membership) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RequestedAnyName) > 0 {
		...
		i = encodeVarintModels(dAtA, i, uint64(len(m.RequestedAnyName)))
		i--
		dAtA[i] = 0x3a
	}
...
func (m *MembershipTierDataFeature) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MembershipTierDataFeature) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MembershipTierDataFeature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ValueStr) > 0 {
		...
		i = encodeVarintModels(dAtA, i, uint64(len(m.ValueStr)))
		i--
		dAtA[i] = 0x12
	}
	if m.ValueUint != 0 {
		i = encodeVarintModels(dAtA, i, uint64(m.ValueUint))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *MembershipTierDataFeature) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ValueUint != 0 {
		n += 1 + sovModels(uint64(m.ValueUint))
	}
	l = len(m.ValueStr)
	if l > 0 {
		n += 1 + l + sovModels(uint64(l))
...
func (m *MembershipTierData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			...
			if m.Features == nil {
				m.Features = make(map[uint32]*MembershipTierDataFeature)
			}
			var mapkey uint32
			var mapvalue *MembershipTierDataFeature
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &MembershipTierDataFeature{}
...
func (m *MembershipTierDataFeature) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
