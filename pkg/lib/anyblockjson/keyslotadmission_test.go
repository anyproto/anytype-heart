...
func keySlotCases() []keySlotCase {
	...
	return []keySlotCase{
		...
		{"template_for",
			...
			"/template_for"},
		{"type_properties key",
			`{"version":1,"kind":"object_type","id":"o1","type":"object_type","type_properties":[{"key":"prio","format":"text"}]}`,
			`{"version":1,"kind":"object_type","id":"o1","type":"object_type","type_properties":[{"key":"","format":"text"}]}`,
			"/type_properties/0/key"},
		{"type_properties object_types",
			`{"version":1,"kind":"object_type","id":"o1","type":"object_type","type_properties":[{"key":"who","format":"objects","object_types":["page"]}]}`,
			`{"version":1,"kind":"object_type","id":"o1","type":"object_type","type_properties":[{"key":"who","format":"objects","object_types":[""]}]}`,
			"/type_properties/0/object_types/0"},
...
func TestUnmarshal_EveryKeySlotRefusesAnEmptyResolution(t *testing.T) {
	...
	for _, tc := range []struct{ slot, doc, want string }{
		...
		{"type_properties key",
			`{"version":1,"kind":"object_type","id":"o1","type":"object_type","type_properties":[{"key":"prio","format":"text"}]}`,
			"/type_properties/0/key: resolved property key is empty"},
		{"type_properties object_types",
			`{"version":1,"kind":"object_type","id":"o1","type":"object_type","type_properties":[{"key":"who","format":"objects","object_types":["prio"]}]}`,
			"/type_properties/0/object_types/0: resolved type key is empty"},
		{"relation object_types",
