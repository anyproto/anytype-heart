...
// `properties[].key`, `group_by`, `cover_property`, `end_property`,
...
func keySlotCases() []keySlotCase {
	...
	return []keySlotCase{
		...
		{"template_for",
			...
			"/template_for"},
		{"type_properties key",
			`{"version":1,"kind":"object_type","id":"o1","type":"object_type","type_settings":{"property_definitions": [{"key":"prio","format":"text"}]}}`,
			`{"version":1,"kind":"object_type","id":"o1","type":"object_type","type_settings":{"property_definitions": [{"key":"","format":"text"}]}}`,
			"/type_settings/property_definitions/0/key"},
		{"type_properties object_types",
			`{"version":1,"kind":"object_type","id":"o1","type":"object_type","type_settings":{"property_definitions": [{"key":"who","format":"objects","object_types":["page"]}]}}`,
			`{"version":1,"kind":"object_type","id":"o1","type":"object_type","type_settings":{"property_definitions": [{"key":"who","format":"objects","object_types":[""]}]}}`,
			"/type_settings/property_definitions/0/object_types/0"},
		{"relation object_types",
			`{"version":1,"kind":"relation","id":"o1","key":"who","relation_settings":{"format":"objects","object_types":["page"]}}`,
			`{"version":1,"kind":"relation","id":"o1","key":"who","relation_settings":{"format":"objects","object_types":[""]}}`,
			"/relation_settings/object_types/0"},
		...
		{"property block key",
			...
			`{"version":1,"id":"o1","blocks":[{"id":"b1","type":"property","key":""}]}`,
			"/blocks/0/key"},
		...
		{"dataview properties key",
			dv(`"properties":[{"key":"prio","format":"text"}],"views":[{"id":"v1","type":"table"}]`),
			dv(`"properties":[{"key":"","format":"text"}],"views":[{"id":"v1","type":"table"}]`),
...
func TestUnmarshal_EveryKeySlotRefusesAnEmptyResolution(t *testing.T) {
	...
	for _, tc := range []struct{ slot, doc, want string }{
		...
		{"type_properties key",
			`{"version":1,"kind":"object_type","id":"o1","type":"object_type","type_settings":{"property_definitions": [{"key":"prio","format":"text"}]}}`,
			"/type_settings/property_definitions/0/key: resolved property key is empty"},
		{"type_properties object_types",
			`{"version":1,"kind":"object_type","id":"o1","type":"object_type","type_settings":{"property_definitions": [{"key":"who","format":"objects","object_types":["prio"]}]}}`,
			"/type_settings/property_definitions/0/object_types/0: resolved type key is empty"},
		{"relation object_types",
			`{"version":1,"kind":"relation","id":"o1","key":"who","relation_settings":{"format":"objects","object_types":["prio"]}}`,
			"/relation_settings/object_types/0: resolved type key is empty"},
		{"properties member", `{"version":1,"id":"o1","properties":{"prio":"x"}}`,
			"/properties/prio: resolved property key is empty"},
		{"property block key",
			`{"version":1,"id":"o1","blocks":[{"id":"b1","type":"property","key":"prio"}]}`,
			"the property block `key` spelling \"prio\""},
		{"link block properties",
			`{"version":1,"id":"o1","blocks":[{"id":"b1","type":"link","object_id":"t1","properties":["prio"]}]}`,
			"the link block `properties` spelling \"prio\""},
		{"dataview properties key",
			`{"version":1,"id":"o1","blocks":[{"id":"b1","type":"dataview","properties":[{"key":"prio","format":"text"}],"views":[{"id":"v1","type":"table"}]}]}`,
