...
func keySlotCases() []keySlotCase {
	...
	return []keySlotCase{
		...
		{"relation object_types",
			`{"version":1,"kind":"relation","id":"o1","internal_key":"who","relation_settings":{"format":"objects","object_types":["page"]}}`,
			`{"version":1,"kind":"relation","id":"o1","internal_key":"who","relation_settings":{"format":"objects","object_types":[""]}}`,
...
func TestUnmarshal_EveryKeySlotRefusesAnEmptyResolution(t *testing.T) {
	...
	for _, tc := range []struct{ slot, doc, want string }{
		...
		{"relation object_types",
			`{"version":1,"kind":"relation","id":"o1","internal_key":"who","relation_settings":{"format":"objects","object_types":["prio"]}}`,
