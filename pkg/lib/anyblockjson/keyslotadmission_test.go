...
func keySlotCases() []keySlotCase {
	...
	return []keySlotCase{
		...
		{"relation object_types",
			`{"version":1,"kind":"relation","id":"o1","key":"who","format":"objects","object_types":["page"]}`,
			`{"version":1,"kind":"relation","id":"o1","key":"who","format":"objects","object_types":[""]}`,
			"/object_types/0"},
...
func TestUnmarshal_EveryKeySlotRefusesAnEmptyResolution(t *testing.T) {
	...
	for _, tc := range []struct{ slot, doc, want string }{
		...
		{"relation object_types",
			`{"version":1,"kind":"relation","id":"o1","key":"who","format":"objects","object_types":["prio"]}`,
			"/object_types/0: resolved type key is empty"},
		{"properties member", `{"version":1,"id":"o1","properties":{"prio":"x"}}`,
