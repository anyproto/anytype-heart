...
2026-08-06. Research and decisions: `docs/ApiKeyScopingResearch.md` (§9 —
v2-only enforcement, spaces × read/readwrite, heart-first/decoupled consent,
type-writes deferred to P2, P0 fixes first).
