...
test:
	...
	@$(CGO_LDFLAGS_DARWIN) go test github.com/anyproto/anytype-heart/...

test-no-cache:
	@echo 'Running tests...'
	@$(CGO_LDFLAGS_DARWIN) go test -count=1 github.com/anyproto/anytype-heart/...
...
test-race:
	...
	@$(CGO_LDFLAGS_DARWIN) go test -count=1 -race github.com/anyproto/anytype-heart/...
...
test-failed:
	...
	@set -o pipefail; \
	CGO_LDFLAGS=-Wl,-no_warn_duplicate_libraries go test -v github.com/anyproto/anytype-heart/... 2>&1 | \
