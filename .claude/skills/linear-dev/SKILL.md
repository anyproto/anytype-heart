...
- Keywords: linear, issue, linctl, GO-XXXX, release task, sprint, cycle
...
2. **Use issue identifiers** (GO-XXXX) not UUIDs for user-facing references
...
| Task | Command |
|------|---------|
| Get issue details | `linctl issue get GO-1234 --json` |
...
| Update issue | `linctl issue update GO-1234 --state "Done" --json` |
| Assign to self | `linctl issue assign GO-1234` |
...
| Task | Command |
|------|---------|
| List comments | `linctl comment list GO-1234 --json` |
| Add comment | `linctl comment create GO-1234 --body "Comment text"` |
...
```bash
# Instead of: mcp__linear-server__list_issues(query: "GO-1234")
...
linctl issue get GO-1234

# Correct - structured JSON
linctl issue get GO-1234 --json
```
