...
require (
	...
	github.com/anytypeio/go-anytype-library v0.10.1-0.20200731095017-d08ea42c677c
...
replace github.com/textileio/go-threads => github.com/anytypeio/go-threads v0.1.18-0.20200720141612-1b2582b69aaf
