...
require (
	...
	github.com/anyproto/anytype-agent-runtime v0.0.0-00010101000000-000000000000
...
replace github.com/anyproto/anytype-agent-runtime => /home/zarkone/anytype/anytype-agent-runtime
