...
require (
	...
	github.com/anytypeio/go-anytype-library v0.11.11-0.20200904142256-36648deaf06e
...
replace github.com/textileio/go-threads => github.com/anytypeio/go-threads v0.1.23-f-3
