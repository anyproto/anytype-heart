...
require (
	...
	github.com/libp2p/go-libp2p-routing-helpers v0.3.0 // indirect
...
replace github.com/textileio/go-threads => github.com/anytypeio/go-threads v1.1.6-0.20221109084732-bb53fd2f0f33
